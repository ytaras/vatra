...
!function (t, e, n) {
    ...
    function r(t, e) {
        return e = e || Error, function () {
            ...
            }), n = n + "\nhttp://errors.angularjs.org/1.3.15/" + (t ? t + "/" : "") + i, r = 2; r < arguments.length; r++)n = n + (2 == r ? "?" : "&") + "p" + (r - 2) + "=" + encodeURIComponent(de(arguments[r]));
            return new e(n)
        }
    }
    ...
    function o(t, e, n) {
        var r, a;
        if (t)if (C(t))for (r in t)"prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r, t); else if (di(t) || i(t)) {
    ...
    function V(t, e, n, r) {
        ...
        if (e) {
            ...
            if (di(t)) {
                e.length = 0;
                for (var s = 0; s < t.length; s++)a = V(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(a)), e.push(a)
            } else {
                var u = e.$$hashKey;
                di(e) ? e.length = 0 : o(e, function (t, n) {
                    delete e[n]
                });
                for (var c in t)t.hasOwnProperty(c) && (a = V(t[c], null, n, r), y(t[c]) && (n.push(t[c]), r.push(a)), e[c] = a);
                l(e, u)
            }
        } else if (e = t, t)if (di(t))e = V(t, [], n, r); else if (x(t))e = new Date(t.getTime()); else if (S(t))e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex; else if (y(t)) {
    ...
    function _(t, e) {
        ...
        if (a == s && "object" == a) {
            if (!di(t)) {
                ...
                if (E(t) || E(e) || k(t) || k(e) || di(e) || x(e) || S(e))return !1;
                o = {};
    ...
    function J(t, e) {
        var n, r, i = vi.length;
        for (t = ei(t), r = 0; i > r; ++r)if (n = vi[r] + e, b(n = t.attr(n)))return n;
        return null
    }
    ...
    function oe(t, e, n) {
        return n && di(t) && (t = t[t.length - 1]), ie(C(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), t
    }
    ...
    function ge(t, e) {
        ...
        if (ve(t))u.push(e.createTextNode(t)); else {
            for (n = n || s.appendChild(e.createElement("div")), r = (Fi.exec(t) || ["", ""])[1].toLowerCase(), i = Pi[r] || Pi._default, n.innerHTML = i[1] + t.replace(Vi, "<$1></$2>") + i[2], a = i[0]; a--;)n = n.lastChild;
    ...
    function ye(t, n) {
        n = n || e;
        var r;
        return (r = Ii.exec(t)) ? [n.createElement(r[1])] : (r = ge(t, n)) ? r.childNodes : []
    }
    ...
    function Se(t, e) {
        ...
        if (i) {
            ...
            i.handle && (i.events.$destroy && i.handle({}, "$destroy"), Ce(t)), delete ki[r], t.ng339 = n
        }
    }

    function ke(t, e) {
        var r = t.ng339, i = r && ki[r];
        return e && !i && (t.ng339 = r = pe(), i = ki[r] = {events: {}, data: {}, handle: n}), i
    }
    ...
    function Le(t) {
        var e = t.toString().replace(Wi, ""), n = e.match(Li);
    ...
    function He(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e)throw b(n) && n || (n = t.name || Le(t)), zi("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                    i = t.toString().replace(Wi, ""), a = i.match(Li), o(a[1].split(Hi), function (t) {
        ...
        } else di(t) ? (s = t.length - 1, oe(t[s], "fn"), r = t.slice(0, s)) : oe(t, "fn", !0);
        return r
    }
    ...
    function Be(t, e) {
        ...
        function i(t, e) {
            if (ae(t, "service"), (C(e) || di(e)) && (e = E.instantiate(e)), !e.$get)throw zi("pget", "Provider '{0}' must define $get factory method.", t);
            return k[t + w] = e
        }
        ...
        function h(t) {
            ...
            return o(t, function (t) {
                ...
                if (!S.get(t)) {
                    S.put(t, !0);
                    try {
                        b(t) ? (e = ri(t), n = n.concat(h(e.requires)).concat(e._runBlocks), r(e._invokeQueue), r(e._configBlocks)) : C(t) ? n.push(E.invoke(t)) : di(t) ? n.push(E.invoke(t)) : oe(t, "module")
                    } catch (i) {
        ...
        function $(t, n) {
            function r(e, r) {
                if (t.hasOwnProperty(e)) {
                    if (t[e] === g)throw zi("cdep", "Circular dependency found: {0}", e + " <- " + x.join(" <- "));
                    return t[e]
                }
                try {
            ...
            function i(t, n, i, o) {
                ...
                for (s = 0, a = l.length; a > s; s++) {
                    if (u = l[s], "string" != typeof u)throw zi("itkn", "Incorrect injection token! Expected service name as string, got {0}", u);
                    c.push(i && i.hasOwnProperty(u) ? i[u] : r(u, o))
                }
                return di(t) && (t = t[a]), t.apply(n, c)
            }
        ...
        e = e === !0;
        var g = {}, w = "Provider", x = [], S = new Ue([], !0), k = {
            $provide: {
                provider: r(i),
                factory: r(s),
                service: r(c),
            ...
            throw ci.isString(e) && x.push(e), zi("unpr", "Unknown provider: {0}", x.join(" <- "))
    ...
    function Ge(t, e, r, i) {
        ...
        function f() {
            T = l(), T = m(T) ? null : T, _(T, F) && (T = F), F = T
        }

        function d() {
            (j !== $.url() || O !== T) && (j = $.url(), O = T, o(I, function (t) {
                t($.url(), T)
            }))
        }
        ...
        var $ = this, v = e[0], g = t.location, y = t.history, w = t.setTimeout, x = t.clearTimeout, C = {};
        $.isMock = !1;
        var S = 0, k = [];
        ...
        var T, O, j = g.href, M = e.find("base"), N = null;
        f(), O = T, $.url = function (e, n, r) {
            if (m(r) && (r = null), g !== t.location && (g = t.location), y !== t.history && (y = t.history), e) {
                var o = O === r;
                if (j === e && (!i.history || o))return $;
                var a = j && xn(j) === xn(e);
                return j = e, O = r, !i.history || a && o ? (a || (N = e), n ? g.replace(e) : a ? g.hash = s(e) : g.href = e) : (y[n ? "replaceState" : "pushState"](r, "", e), f(), O = T), $
            }
        ...
        $.onUrlChange = function (e) {
            return D || (i.history && ei(t).on("popstate", c), ei(t).on("hashchange", c), D = !0), I.push(e), e
        }, $.$$checkUrlChange = d, $.baseHref = function () {
            var t = M.attr("href");
        ...
        $.cookies = function (t, e) {
            var i, o, a, s, u;
            if (!t) {
                if (v.cookie !== P)for (P = v.cookie, o = P.split("; "), V = {}, s = 0; s < o.length; s++)a = o[s], u = a.indexOf("="), u > 0 && (t = h(a.substring(0, u)), V[t] === n && (V[t] = h(a.substring(u + 1))));
                return V
            }
            e === n ? v.cookie = encodeURIComponent(t) + "=;path=" + R + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(e) && (i = (v.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + ";path=" + R).length + 1, i > 4096 && r.warn("Cookie '" + t + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"))
        }, $.defer = function (t, e) {
            var n;
            return S++, n = w(function () {
                delete C[n], a(t)
            }, e || 0), C[n] = !0, n
    ...
    function Xe() {
        this.$get = function () {
            function t(t, n) {
                ...
                var a = 0, s = f({}, n, {id: t}), u = {}, c = n && n.capacity || Number.MAX_VALUE, l = {}, d = null, h = null;
                return e[t] = {
                    put: function (t, e) {
    ...
    function Je(t, r) {
        ...
        var a = {}, s = "Directive", c = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, l = /(([\w\-]+)(?:\:([^;]+))?;?)/, d = I("ngSrc,ngSrcset,src,srcset"), m = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, w = /^(on[a-z]+|formaction)$/;
        ...
        this.debugInfoEnabled = function (t) {
        ...
        }, this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (t, r, i, u, v, g, S, k, A, T, O) {
            function j(t, e) {
                try {
                    t.addClass(e)
                } catch (n) {
            ...
            function M(t, e, n, r, i) {
                ...
                return function (e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? ei(Z(s, ei("<div>").append(t).html())) : n ? _i.clone.call(t) : t, o)for (var l in o)c.data("$" + l + "Controller", o[l].instance);
            ...
            function N(t) {
                var e = t && t[0];
                return e ? "foreignobject" !== D(e) && e.toString().match(/SVG/) ? "svg" : "html" : "html"
            }

            function I(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    var a, s, u, c, l, f, d, h, v;
                    if (p) {
                        var m = r.length;
                        for (v = new Array(m), l = 0; l < $.length; l += 3)d = $[l], v[d] = r[d]
                    } else v = r;
                    for (l = 0, f = $.length; f > l;)u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), M.$$addScopeInfo(ei(u), c)) : c = t, h = a.transcludeOnThisElement ? V(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? V(t, e) : null, a(s, c, u, i, h)) : s && s(t, u.childNodes, n, o)
                }

                for (var u, c, l, f, d, h, p, $ = [], v = 0; v < t.length; v++)u = new ae, c = P(t[v], [], u, 0 === v ? i : n, o), l = c.length ? L(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && M.$$addScopeClass(u.$$element), d = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : I(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || d) && ($.push(v, l, d), h = !0, p = p || l), a = null;
                return h ? s : null
            }
            ...
            function P(t, e, n, r, i) {
                ...
                switch (s) {
                    case yi:
                        B(e, Ze(D(t)), "E", r, i);
                        for (var f, d, h, p, $, v, m = t.attributes, g = 0, w = m && m.length; w > g; g++) {
                            var x = !1, C = !1;
                            f = m[g], d = f.name, $ = hi(f.value), p = Ze(d), (v = fe.test(p)) && (d = d.replace(Ki, "").substr(8).replace(/_(.)/g, function (t, e) {
                                return e.toUpperCase()
                            }));
                            var S = p.replace(/(Start|End)$/, "");
                            z(S) && p === S + "Start" && (x = d, C = d.substr(0, d.length - 5) + "end", d = d.substr(0, d.length - 6)), h = Ze(d.toLowerCase()), u[h] = d, (v || !n.hasOwnProperty(h)) && (n[h] = $, Ve(t, h) && (n[h] = !0)), te(t, e, $, h, v), B(e, h, "A", r, i, x, C)
                        }
                        if (a = t.className, y(a) && (a = a.animVal), b(a) && "" !== a)for (; o = l.exec(a);)h = Ze(o[2]), B(e, h, "C", r, i) && (n[h] = hi(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case bi:
                        J(e, t.nodeValue);
                        break;
                    case wi:
                        try {
                            o = c.exec(t.nodeValue), o && (h = Ze(o[1]), B(e, h, "M", r, i) && (n[h] = hi(o[2])))
                        } catch (k) {
                        }
                }
                return e.sort(X), e
            ...
            function L(t, a, s, u, c, l, f, d, h) {
                function p(t, e, n, r) {
                    t && (n && (t = U(t, n, r)), t.require = k.require, t.directiveName = A, (D === k || k.$$isolateScope) && (t = re(t, {isolateScope: !0})), f.push(t)), e && (n && (e = U(e, n, r)), e.require = k.require, e.directiveName = A, (D === k || k.$$isolateScope) && (e = re(e, {isolateScope: !0})), d.push(e))
                }
                ...
                function w(t, e, i, u, c) {
                    function l(t, e, r) {
                        var i;
                        return E(t) || (r = e, e = t, t = n), z && (i = w), r || (r = z ? C.parent() : C), c(t, e, i, r, O)
                    }

                    var h, p, m, y, b, w, x, C, k;
                    if (a === i ? (k = s, C = s.$$element) : (C = ei(i), k = new ae(C, s)), D && (b = e.$new(!0)), c && (x = l, x.$$boundTransclude = c), I && (S = {}, w = {}, o(I, function (t) {
                            var n, r = {
                            ...
                            y = t.controller, "@" == y && (y = k[t.name]), n = g(y, r, !0, t.controllerAs), w[t.name] = n, z || C.data("$" + t.name + "Controller", n.instance), S[t.name] = n
                        })), D) {
                        M.$$addScopeInfo(C, b, !0, !(F && (F === D || F === D.$$originalDirective))), M.$$addScopeClass(C, !0);
                        var A = S && S[D.name], T = b;
                        A && A.identifier && D.bindToController === !0 && (T = A.instance), o(b.$$isolateBindings = D.$$isolateBindings, function (t, n) {
                            ...
                            switch (l) {
                                ...
                                case"=":
                                    if (c && !k[u])return;
                                    o = v(k[u]), s = o.literal ? _ : function (t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function () {
                                        throw i = T[n] = o(e), Xi("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", k[u], D.name)
                                    }, i = T[n] = o(e);
                                    var f = function (t) {
                                    ...
                                    f.$stateful = !0;
                                    var d;
                                    d = t.collection ? e.$watchCollection(k[u], f) : e.$watch(v(k[u], f), null, o.literal), b.$on("$destroy", d);
                                    break;
                                case"&":
                    ...
                    for (S && (o(S, function (t) {
                        t()
                    }), S = null), h = 0, p = f.length; p > h; h++)m = f[h], oe(m, m.isolateScope ? b : e, C, k, m.require && $(m.directiveName, m.require, C, w), x);
                    var O = e;
                    for (D && (D.template || null === D.templateUrl) && (O = b), t && t(O, i.childNodes, n, c), h = d.length - 1; h >= 0; h--)m = d[h], oe(m, m.isolateScope ? b : e, C, k, m.require && $(m.directiveName, m.require, C, w), x)
                }

                h = h || {};
                for (var x, S, k, A, T, O, j, N = -Number.MAX_VALUE, I = h.controllerDirectives, D = h.newIsolateScopeDirective, F = h.templateDirective, V = h.nonTlbTranscludeDirective, L = !1, B = !1, z = h.hasElementTranscludeDirective, X = s.$$element = ei(a), J = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    k = t[te];
                    var ie = k.$$start, se = k.$$end;
                    if (ie && (X = R(a, ie, se)), T = n, N > k.priority)break;
                    if ((j = k.scope) && (k.templateUrl || (y(j) ? (K("new/isolated scope", D || x, k, X), D = k) : K("new/isolated scope", D, k, X)), x = x || k), A = k.name, !k.templateUrl && k.controller && (j = k.controller, I = I || {}, K("'" + A + "' controller", I[A], k, X), I[A] = k), (j = k.transclude) && (L = !0, k.$$tlb || (K("transclusion", V, k, X), V = k), "element" == j ? (z = !0, N = k.priority, T = X, X = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = X[0], ee(c, q(T), a), Q = M(T, u, N, J && J.name, {nonTlbTranscludeDirective: V})) : (T = ei(we(a)).contents(), X.empty(), Q = M(T, u))), k.template)if (B = !0, K("template", F, k, X), F = k, j = C(k.template) ? k.template(X, s) : k.template, j = le(j), k.replace) {
                        if (J = k, T = ve(j) ? [] : tn(Z(k.templateNamespace, hi(j))), a = T[0], 1 != T.length || a.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", A, "");
                        ee(c, X, a);
                        var ue = {$attr: {}}, ce = P(a, [], ue), fe = t.splice(te + 1, t.length - (te + 1));
                        D && H(ce), t = t.concat(ce).concat(fe), G(s, ue), ne = t.length
                    } else X.html(j);
                    if (k.templateUrl)B = !0, K("template", F, k, X), F = k, k.replace && (J = k), w = Y(t.splice(te, t.length - te), X, s, c, L && Q, f, d, {
                        controllerDirectives: I,
                        newIsolateScopeDirective: D,
                        templateDirective: F,
                        nonTlbTranscludeDirective: V
                    }), ne = t.length; else if (k.compile)try {
                        O = k.compile(X, s, Q), C(O) ? p(null, O, ie, se) : O && p(O.pre, O.post, ie, se)
                    } catch (de) {
                        i(de, W(X))
                    }
                    k.terminal && (w.terminal = !0, N = Math.max(N, k.priority))
                }
                return w.scope = x && x.scope === !0, w.transcludeOnThisElement = L, w.elementTranscludeOnThisElement = z, w.templateOnThisElement = B, w.transclude = Q, h.hasElementTranscludeDirective = z, w
            }
            ...
            function B(e, r, o, u, c, l, f) {
                ...
                if (a.hasOwnProperty(r))for (var p, $ = t.get(r + s), v = 0, m = $.length; m > v; v++)try {
                    p = $[v], (u === n || u > p.priority) && -1 != p.restrict.indexOf(o) && (l && (p = h(p, {
                        $$start: l,
                        $$end: f
                    })), e.push(p), d = p)
                } catch (g) {
            ...
            function Y(t, e, n, r, i, a, s, c) {
                ...
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                    var h, b, w, x;
                    if (u = le(u), $.replace) {
                        if (w = ve(u) ? [] : tn(Z(g, hi(u))), h = w[0], 1 != w.length || h.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, m);
                        b = {$attr: {}}, ee(r, e, h);
                        var C = P(h, [], b);
                        y($.scope) && H(C), t = C.concat(t), G(n, b)
                    } else h = p, e.html(u);
                    for (t.unshift(v), l = L(t, h, n, i, e, $, a, s, c), o(r, function (t, n) {
                        t == h && (r[n] = e[0])
                    }), f = I(e[0].childNodes, i); d.length;) {
                        var S = d.shift(), k = d.shift(), E = d.shift(), A = d.shift(), T = e[0];
                        if (!S.$$destroyed) {
                            if (k !== p) {
                                var O = k.className;
                                c.hasElementTranscludeDirective && $.replace || (T = we(h)), ee(E, ei(k), T), j(ei(T), O)
                            }
                            x = l.transcludeOnThisElement ? V(S, l.transclude, A) : A, l(f, S, T, r, x)
                        }
                    }
                    d = null
                }), function (t, e, n, r, i) {
                    var o = i;
                    e.$$destroyed || (d ? d.push(e, n, r, o) : (l.transcludeOnThisElement && (o = V(e, l.transclude, i)), l(f, e, n, r, o)))
                }
            }
            ...
            function te(t, e, n, i, o) {
                ...
                var s = r(n, !0, a, o);
                if (s) {
                    if ("multiple" === i && "select" === D(t))throw Xi("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", W(t));
                    e.push({
            ...
            function ee(t, n, r) {
                ...
                for (var h = 1, p = n.length; p > h; h++) {
                    var $ = n[h];
                    ei($).remove(), d.appendChild($), delete n[h]
                }
                n[0] = r, n.length = 1
            }
            ...
            ae.prototype = {
                $normalize: Ze, $addClass: function (t) {
                    ...
                    var s, u = this.$$element[0], c = Ve(u, t), l = Pe(u, t), f = t;
                    if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = ne(t, "-"))), s = D(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t)this[t] = e = O(e, "src" === t); else if ("img" === s && "srcset" === t) {
                        for (var d = "", h = hi(e), p = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, $ = /\s/.test(h) ? p : /(,)/, v = h.split($), m = Math.floor(v.length / 2), g = 0; m > g; g++) {
                            var y = 2 * g;
                            d += O(hi(v[y]), !0), d += " " + hi(v[y + 1])
                        }
                        var b = hi(v[2 * g]).split(/\s/);
                        d += O(hi(b[0]), !0), 2 === b.length && (d += " " + hi(b[1])), this[t] = e = d
                    }
        ...
        this.register = function (e, n) {
            ...
            return function (r, u, c, l) {
                ...
                if (c = c === !0, l && b(l) && ($ = l), b(r)) {
                    ...
                    p = h[1], $ = $ || h[3], r = t.hasOwnProperty(p) ? t[p] : se(u.$scope, p, !0) || (e ? se(a, p, !0) : n), oe(r, p, !0)
                }
                if (c) {
                    var v = (di(r) ? r[r.length - 1] : r).prototype;
                    return d = Object.create(v || null), $ && s(u, $, d, p || r.name), f(function () {
    ...
    function fn() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, d, h) {
            function p(e) {
                function i(t) {
                    var e = f({}, t);
                    return e.data = t.data ? cn(t.data, t.headers, t.status, u.transformResponse) : t.data, ln(t.status) ? e : d.reject(e)
                }
            ...
            function w(r, i) {
                ...
                var h, $, v = d.defer(), b = v.promise, w = r.headers, x = S(r.url, r.params);
                if (p.pendingRequests.push(r), b.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(t.cache) ? t.cache : k), h && ($ = h.get(x), g($) ? M($) ? $.then(c, c) : di($) ? s($[1], $[0], P($[2]), $[3]) : s($, 200, {}, "OK") : h.put(x, b)), m($)) {
            ...
            function S(t, e) {
                ...
                return s(e, function (t, e) {
                    null === t || m(t) || (di(t) || (t = [t]), o(t, function (t) {
                        y(t) && (t = x(t) ? t.toISOString() : H(t)), n.push(K(e) + "=" + K(t))
                    }))
    ...
    function pn(t, e, r, i, a) {
        ...
        return function (a, u, c, l, f, d, h, $) {
            ...
            if (d > 0)var S = r(v, d); else M(d) && d.then(v)
        }
    }
    ...
    function $n() {
        ...
        this.startSymbol = function (e) {
            ...
            function a(o, a, d, h) {
                ...
                h = !!h;
                for (var v, y, b, w = 0, x = [], S = [], k = o.length, E = [], A = []; k > w;) {
                    if (-1 == (v = o.indexOf(t, w)) || -1 == (y = o.indexOf(e, v + s))) {
                        w !== k && E.push(p(o.substring(w)));
                        break
                    }
                    w !== v && E.push(p(o.substring(w, v))), b = o.substring(v + s, y), x.push(b), S.push(n(b, $)), w = y + u, A.push(E.length), E.push("")
                }
                if (d && E.length > 1)throw ro("noconcat", "Error while interpolating: {0}\nStrict Contextual Escaping disallows interpolations that concatenate multiple expressions when a trusted value is required.  See http://docs.angularjs.org/api/ng.$sce", o);
                if (!a || x.length) {
                    var T = function (t) {
        ...
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (t, e, n, r) {
            function i(i, a, s, u) {
                ...
                return s = g(s) ? s : 0, p.then(null, null, i), p.$$intervalId = c(function () {
                    h.notify(f++), s > 0 && f >= s && (h.resolve(f), l(p.$$intervalId), delete o[p.$$intervalId]), d || t.$apply()
    ...
    function Mn() {
        ...
        this.hashPrefix = function (e) {
            ...
            return j(t) ? (e.enabled = t, this) : y(t) ? (j(t.enabled) && (e.enabled = t.enabled), j(t.requireBase) && (e.requireBase = t.requireBase), j(t.rewriteLinks) && (e.rewriteLinks = t.rewriteLinks), this) : e
            ...
            if (e.enabled) {
                if (!d && e.requireBase)throw ao("nobase", "$location in HTML5 mode requires a <base> tag to be present!");
                f = kn(h) + (d || "/"), l = i.history ? En : Tn
            } else f = xn(h), l = An;
            ...
            o.on("click", function (t) {
                if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                    for (var i = ei(t.target); "a" !== D(i[0]);)if (i[0] === o[0] || !(i = i.parent())[0])return;
    ...
    function Pn(t, e, n, r, i) {
        ...
        return o = In(a.shift(), i), Dn(t[o], i), t[o] = r, r
    }
    ...
    function Rn(t, e, r, i, o, a, s) {
        In(t, a), In(e, a), In(r, a), In(i, a), In(o, a);
        var u = function (t) {
            return Dn(t, a)
        }, c = s || _n(t) ? u : $, l = s || _n(e) ? u : $, f = s || _n(r) ? u : $, d = s || _n(i) ? u : $, h = s || _n(o) ? u : $;
        return function (a, s) {
            var u = s && s.hasOwnProperty(t) ? s : a;
            return null == u ? u : (u = c(u[t]), e ? null == u ? n : (u = l(u[e]), r ? null == u ? n : (u = f(u[r]), i ? null == u ? n : (u = d(u[i]), o ? null == u ? n : u = h(u[o]) : u) : u) : u) : u)
        }
    }
    ...
    function Un(t, e, r) {
        ...
        if (e.csp)s = 6 > c ? Rn(u[0], u[1], u[2], u[3], u[4], r, i) : function (t, e) {
            var o, a = 0;
            do o = Rn(u[a++], u[a++], u[a++], u[a++], u[a++], r, i)(t, e), e = n, t = o; while (c > a);
            return o
        }; else {
            var l = "";
            i && (l += "s = eso(s, fe);\nl = eso(l, fe);\n");
    ...
    function Ln(t) {
        return C(t.valueOf) ? t.valueOf() : bo.call(t)
    }
    ...
    function Hn() {
        ...
        this.$get = ["$filter", "$sniffer", function (n, r) {
            ...
            var h = {csp: r.csp, expensiveChecks: !1}, $ = {csp: r.csp, expensiveChecks: !0};
            return function (r, o, a) {
                var s, v, m;
                switch (typeof r) {
                    case"string":
                        ...
                        if (s = g[m], !s) {
                            ...
                            var y = a ? $ : h, b = new vo(y), w = new mo(b, n, y);
                            s = w.parse(r), s.constant ? s.$$watchDelegate = f : v ? (s = i(s), s.$$watchDelegate = s.literal ? l : c) : s.inputs && (s.$$watchDelegate = u), g[m] = s
                        }
                        return d(s, o);
                    case"function":
                        return d(r, o);
    ...
    function zn(t, e) {
        ...
        return g.defer = h, g.reject = p, g.when = m, g.all = f, g
    }
        ...
        this.digestTtl = function (t) {
            ...
            h.prototype = {
                constructor: h, $new: function (e, n) {
                    var r;
                    return n = n || this, e ? (r = new h, r.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = t(this)), r = new this.$$ChildScope), r.$parent = n, r.$$prevSibling = n.$$childTail, n.$$childHead ? (n.$$childTail.$$nextSibling = r, n.$$childTail = r) : n.$$childHead = n.$$childTail = r, (e || n != this) && r.$on("$destroy", d), r
                    ...
                    n.$stateful = !0;
                    var o, a, s, u = this, c = e.length > 1, f = 0, d = l(t, n), h = [], p = {}, $ = !0, v = 0;
                    return this.$watch(d, r)
                }, $digest: function () {
                    var t, r, i, o, c, l, d, h, p, m, g = e, y = this, x = [];
                    $("$digest"), f.$$checkUrlChange(), this === S && null !== s && (f.defer.cancel(s), w()), a = null;
                    do {
                        ...
                        t:do {
                            if (o = h.$$watchers)for (c = o.length; c--;)try {
                                if (t = o[c])if ((r = t.get(h)) === (i = t.last) || (t.eq ? _(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                    if (t === a) {
                                        l = !1;
                                        break t
                                    }
                                } else l = !0, a = t, t.last = t.eq ? V(r, null) : r, t.fn(r, i === b ? r : i, h), 5 > g && (p = 4 - g, x[p] || (x[p] = []), x[p].push({
                            ...
                            if (!(d = h.$$childHead || h !== y && h.$$nextSibling))for (; h !== y && !(d = h.$$nextSibling);)h = h.$parent
                        } while (h = d);
                    ...
                    S.$$phase || k.length || f.defer(function () {
                        k.length && S.$digest()
                    ...
                    for (var o, a, s, c = R([i], arguments, 1); n = r;) {
            ...
            var S = new h, k = S.$$asyncQueue = [], E = S.$$postDigestQueue = [], A = S.$$applyAsyncQueue = [];
            return S
        }]
    }
    ...
    function Zn() {
        ...
        this.resourceUrlWhitelist = function (e) {
            ...
            var f = a(), d = {};
            return d[xo.HTML] = a(f), d[xo.CSS] = a(f), d[xo.URL] = a(f), d[xo.JS] = a(f), d[xo.RESOURCE_URL] = a(d[xo.URL]), {
                trustAs: s,
                getTrusted: c,
                valueOf: u
            }
    ...
    function tr() {
        this.$get = ["$window", "$document", function (t, e) {
            var n, r, i = {}, o = d((/android (\d+)/.exec(Xr((t.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((t.navigator || {}).userAgent), s = e[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, c = s.body && s.body.style, l = !1, f = !1;
            if (c) {
    ...
    function sr(t) {
        ...
        }], e("currency", fr), e("date", Sr), e("filter", ur), e("json", kr), e("limitTo", Er), e("lowercase", Oo), e("number", dr), e("orderBy", Ar), e("uppercase", jo)
    }
    ...
    function lr(t, e, n, r, i) {
        ...
        if (di(t))return t.some(function (t) {
            return lr(t, e, n, r)
        });
        switch (o) {
            case"object":
    ...
    function hr(t, e, n, r, i) {
        ...
        if (c)i > 0 && 1 > t && (s = t.toFixed(i), t = parseFloat(s)); else {
            ...
            var d = ("" + t).split(ko), h = d[0];
            d = d[1] || "";
            var p, $ = 0, v = e.lgSize, g = e.gSize;
            if (h.length >= v + g)for ($ = h.length - v, p = 0; $ > p; p++)($ - p) % g === 0 && 0 !== p && (s += n), s += h.charAt(p);
            for (p = $; p < h.length; p++)(h.length - p) % v === 0 && 0 !== p && (s += n), s += h.charAt(p);
            for (; d.length < i;)d += "0";
    ...
    function Sr(t) {
        ...
        return function (n, r, i) {
            var a, s, u = "", c = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, b(n) && (n = To.test(n) ? d(n) : e(n)), w(n) && (n = new Date(n)), !x(n))return n;
            for (; r;)s = Ao.exec(r), s ? (c = R(c, s, 1), r = c.pop()) : (c.push(r), r = null);
    ...
    function jr(t, e, r, i, a) {
        var s = this, u = [], c = s.$$parentForm = t.parent().controller("form") || Io;
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, c.$addControl(s), s.$rollbackViewValue = function () {
            ...
            i.setClass(t, $a, va + " " + Do), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(u, function (t) {
                t.$setPristine()
            })
            ...
            i.addClass(t, Do), s.$submitted = !0, c.$setSubmitted()
        }
    }
    ...
    function _r(t, e, r, i, o, a) {
        if (Pr(t, e, r, i), Ir(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function (t) {
    ...
    function Rr(t, e, n, r, i, o) {
        Ir(t, e, n, r, i, o), Mr(r), r.$$parserName = "url", r.$validators.url = function (t, e) {
            var n = t || e;
    ...
    function qr(t, e, n, r, i, o) {
        Ir(t, e, n, r, i, o), Mr(r), r.$$parserName = "email", r.$validators.email = function (t, e) {
            var n = t || e;
    ...
    function Hr(t, e, n, r, i, o, a, s) {
        var u = Lr(s, t, "ngTrueValue", n.ngTrueValue, !0), c = Lr(s, t, "ngFalseValue", n.ngFalseValue, !1), l = function (t) {
    ...
    function Wr(t) {
        function e(t, e, u) {
            e === n ? r("$pending", t, u) : i("$pending", t, u), j(e) ? e ? (f(s.$error, t, u), l(s.$$success, t, u)) : (l(s.$error, t, u), f(s.$$success, t, u)) : (f(s.$error, t, u), f(s.$$success, t, u)), s.$pending ? (o(ya, !0), s.$valid = s.$invalid = n, a("", null)) : (o(ya, !1), s.$valid = zr(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
            var c;
            c = s.$pending && s.$pending[t] ? n : s.$error[t] ? !1 : s.$$success[t] ? !0 : null, a(t, c), d.$setValidity(t, c, s)
        }
    ...
    var fi, di = Array.isArray, hi = function (t) {
        return b(t) ? t.trim() : t
    }, pi = function (t) {
    ...
    }, vi = ["ng-", "data-ng-", "ng:", "x-ng-"], mi = /[A-Z]/g, gi = !1, yi = 1, bi = 3, wi = 8, xi = 9, Ci = 11, Si = {
        full: "1.3.15",
        major: 1,
        minor: 3,
        dot: 15,
    ...
    var Oi = /([\:\-\_]+(.))/g, ji = /^moz([A-Z])/, Mi = {
        mouseleave: "mouseout",
        mouseenter: "mouseover"
    }, Ni = r("jqLite"), Ii = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Di = /<|&#?\w+;/, Fi = /<([\w:]+)/, Vi = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Pi = {
    ...
    o({data: Ee, removeData: Se}, function (t, e) {
        be[e] = t
    }), o({
        data: Ee, inheritedData: Ne, scope: function (t) {
            ...
            return e = $e(e), g(n) ? (t.style[e] = n, void 0) : t.style[e]
        }, attr: function (t, e, r) {
            var i = Xr(e);
            if (Ri[i]) {
        ...
        be.prototype[e] = function (e, r) {
            ...
            if (t !== Ie && (2 == t.length && t !== Ae && t !== Me ? e : r) === n) {
                if (y(e)) {
        ...
        removeData: Se, on: function Ga(t, e, n, r) {
            ...
            if (me(t)) {
                ...
                for (var s = e.indexOf(" ") >= 0 ? e.split(" ") : [e], u = s.length; u--;) {
                    e = s[u];
                    var c = o[e];
                    c || (o[e] = [], "mouseenter" === e || "mouseleave" === e ? Ga(t, Mi[e], function (t) {
            ...
            }, e.type && (r = f(r, e)), i = P(l), a = n ? [r].concat(n) : [r], o(i, function (e) {
                r.isImmediatePropagationStopped() || e.apply(t, a)
            }))
        }
    }, function (t, e) {
        be.prototype[e] = function (e, n, r) {
            for (var i, o = 0, a = this.length; a > o; o++)m(i) ? (i = t(this[o], e, n, r), g(i) && (i = ei(i))) : je(i, t(this[o], e, n, r));
            return g(i) ? i : this
    ...
    var Li = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Hi = /,/, Bi = /^\s*(_?)(\S+?)\1\s*$/, Wi = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, zi = r("$injector");
    Be.$$annotate = He;
        ...
        this.$$selectors = {}, this.register = function (e, n) {
            ...
            return {
                animate: function (t, e, n) {
                    ...
                    var f = l.classes;
                    return e = di(e) ? e : e.split(" "), n = di(n) ? n : n.split(" "), a(f, e, !0), a(f, n, !1), c && (l.promise = r(function (e) {
                        var n = t.data(u);
                        if (t.removeData(u), n) {
                            var r = i(t, n.classes);
    ...
    var Ki = /^((?:x|data)[\:\-_])/i, Ji = r("$controller"), Zi = "application/json", Qi = {"Content-Type": Zi + ";charset=utf-8"}, to = /^\[|^\{(?!\{)/, eo = {
        ...
        }, protocol: On("$$protocol"), host: On("$$host"), port: On("$$port"), path: jn("$$path", function (t) {
    ...
    mo.ZERO = f(function () {
        ...
        constructor: mo, parse: function (t) {
            ...
            return f(function (o, a) {
                ...
                return i(s)
            }, {constant: !i.$stateful && o.every(Vn), inputs: !i.$stateful && o})
        }, expression: function () {
            ...
            return this.consume("]"), f(function (i, o) {
                ...
                return In(u, e), s ? a = Dn(s[u], e) : n
            }, {
                assign: function (n, i, o) {
                    var a = In(r(n, o), e), s = Dn(t(n, o), e);
            ...
            return this.consume("]"), f(function (e, n) {
                ...
                return r
            }, {literal: !0, constant: t.every(Vn), inputs: t})
        }, object: function () {
            var t = [], e = [];
            if ("}" !== this.peekToken().text)do {
                if (this.peek("}"))break;
            ...
            return this.consume("}"), f(function (n, r) {
                ...
                return i
            }, {literal: !0, constant: e.every(Vn), inputs: e})
        }
    };
    var go = ce(), yo = ce(), bo = Object.prototype.valueOf, wo = r("$sce"), xo = {
        ...
        JS: "js"
    }, Xi = r("$compile"), Co = e.createElement("a"), So = ir(t.location.href);
    ...
    var Fo = function (t) {
        return ["$timeout", function (e) {
            var r = {
                name: "form", restrict: t ? "EAC" : "E", controller: jr, compile: function (r, i) {
                    ...
                    return {
                        pre: function (t, r, i, a) {
                            ...
                            var u = a.$$parentForm;
                            o && (Pn(t, null, a.$name, a, a.$name), i.$observe(o, function (e) {
                                a.$name !== e && (Pn(t, null, a.$name, n, a.$name), u.$$renameControl(a, e), Pn(t, null, a.$name, a, a.$name))
                            })), r.on("$destroy", function () {
                                u.$removeControl(a), o && Pn(t, null, i[o], n, a.$name), f(a, Io)
                            })
                        }
                    }
                }
    ...
    }, Vo = Fo(), Po = Fo(!0), _o = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Ro = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, qo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Uo = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Lo = /^(\d{4})-(\d{2})-(\d{2})$/, Ho = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Bo = /^(\d{4})-W(\d\d)$/, Wo = /^(\d{4})-(\d\d)$/, zo = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Go = {
        text: Nr,
        date: Vr("date", Lo, Fr(Lo, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
        "datetime-local": Vr("datetimelocal", Ho, Fr(Ho, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
        time: Vr("time", zo, Fr(zo, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        week: Vr("week", Bo, Dr, "yyyy-Www"),
        month: Vr("month", Wo, Fr(Wo, ["yyyy", "MM"]), "yyyy-MM"),
        number: _r,
        url: Rr,
        email: qr,
        radio: Ur,
    ...
    }), ea = Br("", !0), na = Br("Odd", 0), ra = Br("Even", 1), ia = Tr({
    ...
    var ua = ["$animate", function (t) {
    ...
    }, ha = "ng-valid", pa = "ng-invalid", $a = "ng-pristine", va = "ng-dirty", ma = "ng-untouched", ga = "ng-touched", ya = "ng-pending", ba = new r("ngModel"), wa = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (t, e, r, i, a, s, u, c, l, f) {
        this.$viewValue = Number.NaN, this.$modelValue = Number.NaN, this.$$rawModelValue = n, this.$validators = {}, this.$asyncValidators = {}, this.$parsers = [], this.$formatters = [], this.$viewChangeListeners = [], this.$untouched = !0, this.$touched = !1, this.$pristine = !0, this.$dirty = !1, this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, this.$pending = n, this.$name = f(r.name || "", !1)(t);
        var d, h = a(r.ngModel), $ = h.assign, v = h, y = $, b = null, x = this;
        this.$$setOptions = function (t) {
            if (x.$options = t, t && t.getterSetter) {
                ...
                v = function (t) {
                    ...
                    C(h(t)) ? n(t, {$$$p: x.$modelValue}) : $(t, x.$modelValue)
                }
            } else if (!h.assign)throw ba("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, W(i))
        }, this.$render = p, this.$isEmpty = function (t) {
            return m(t) || "" === t || null === t || t !== t
        };
        var S = i.inheritedData("$formController") || Io, k = 0;
        Wr({
            ...
            function s() {
                ...
                o(x.$asyncValidators, function (o, a) {
                    var s = o(t, e);
                    if (!M(s))throw ba("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
            ...
            if (d = m(i) ? n : !0)for (var o = 0; o < x.$parsers.length; o++)if (i = x.$parsers[o](i), m(i)) {
                d = !1;
                break
            }
        ...
        return {
            ...
            priority: 1,
            compile: function (e) {
                return e.addClass($a).addClass(ma).addClass(ha), {
        ...
        return {
            restrict: "A", controller: ["$scope", "$attrs", function (t, e) {
                var r = this;
                this.$options = t.$eval(e.ngModelOptions), this.$options.updateOn !== n ? (this.$options.updateOnDefault = !1, this.$options.updateOn = hi(this.$options.updateOn.replace(Ca, function () {
        ...
        return {
            restrict: "EA", link: function (i, a, s) {
                ...
                var c, l = s.count, f = s.$attr.when && a.attr(s.$attr.when), d = s.offset || 0, h = i.$eval(f) || {}, p = {}, $ = e.startSymbol(), v = e.endSymbol(), m = $ + l + "-" + d + v, g = ci.noop;
                o(s, function (t, e) {
                    var n = r.exec(e);
                    if (n) {
                        var i = (n[1] ? "-" : "") + Xr(n[2]);
                    ...
                    r || n in h || (n = t.pluralCat(n - d)), n === c || r && isNaN(c) || (g(), g = i.$watch(p[n], u), c = n)
                })
            }
        }
            ...
            compile: function (r, d) {
                ...
                return y ? x = t(y) : (S = function (t, e) {
                    ...
                    t.$watchCollection(m, function (r) {
                        var d, m, y, x, E, A, T, O, j, M, N, I, D = e[0], F = ce();
                        if (g && (t[g] = r), i(r))j = r, O = C || S; else {
                            O = C || k, j = [];
                            for (var V in r)r.hasOwnProperty(V) && "$" != V.charAt(0) && j.push(V);
                            j.sort()
                        }
                        for (x = j.length, N = new Array(x), d = 0; x > d; d++)if (E = r === j ? d : j[d], A = r[E], T = O(E, A, d), v[T])M = v[T], delete v[T], F[T] = M, N[d] = M; else {
                            ...
                            N[d] = {id: T, scope: n, clone: n}, F[T] = !0
                        }
                        for (var P in v) {
                            if (M = v[P], I = ue(M.clone), a.leave(I), I[0].parentNode)for (d = 0, m = I.length; m > d; d++)I[d][s] = !0;
                            M.scope.$destroy()
                        }
                        for (d = 0; x > d; d++)if (E = r === j ? d : j[d], A = r[E], M = N[d], M.scope) {
                            y = D;
                            do y = y.nextSibling; while (y && y[s]);
                            l(M) != y && a.move(ue(M.clone), null, ei(D)), D = f(M), c(M.scope, d, b, A, w, E, x)
                        } else $(function (t, e) {
                            M.scope = e;
                            var n = p.cloneNode(!1);
                            t[t.length++] = n, a.enter(t, null, ei(D)), D = n, M.clone = t, F[M.id] = M, c(M.scope, d, b, A, w, E, x)
                        });
                        v = F
                    })
                }
    ...
    }], Ta = "ng-hide", Oa = "ng-hide-animate", ja = ["$animate", function (t) {
        return {
    ...
    }], _a = r("ngOptions"), Ra = v({restrict: "A", terminal: !0}), qa = ["$compile", "$parse", function (t, r) {
            ...
            link: function (s, u, c, l) {
                ...
                function h(e, s, u) {
                    ...
                    function l() {
                        e.$apply(function () {
                            ...
                            if (y)t = [], o(s.val(), function (e) {
                                e = F ? V[e] : e, t.push(f(e, n[e]))
                            }); else {
                                var r = F ? V[s.val()] : s.val();
                                t = f(r, n[r])
                            }
                            u.$setViewValue(t), m()
                        })
                    ...
                    function h(t) {
                        ...
                        } else e = new Ue(t); else F && (t = c(F, null, t));
                        return function (n, r) {
                            var i;
                    ...
                    function m() {
                        x = !1;
                        var t, n, r, i, l, f, d, p, m, b, k, A, T, O, N, D, R, q = {"": []}, U = [""], L = u.$viewValue, H = I(e) || [], B = j ? a(H) : H, W = {}, z = h(L), G = !1;
                        for (V = {}, A = 0; b = B.length, b > A; A++)d = A, j && (d = B[A], "$" === d.charAt(0)) || (p = H[d], t = c(M, d, p) || "", (n = q[t]) || (n = q[t] = [], U.push(t)), T = z(d, p), G = G || T, D = c(E, d, p), D = g(D) ? D : "", R = F ? F(e, _) : j ? B[A] : A, F && (V[R] = d), n.push({
                            id: R,
                            label: D,
                            selected: T
                        }));
                        for (y || (w || null === L ? q[""].unshift({
                            id: "",
                            label: "",
                            selected: !G
                        }) : G || q[""].unshift({id: "?", label: "", selected: !0})), k = 0, m = U.length; m > k; k++) {
                            for (t = U[k], n = q[t], P.length <= k ? (i = {
                                element: S.clone().attr("label", t),
                                label: n.label
                            }, l = [i], P.push(l), s.append(i.element)) : (l = P[k], i = l[0], i.label != t && i.element.attr("label", i.label = t)), O = null, A = 0, b = n.length; b > A; A++)r = n[A], (f = l[A + 1]) ? (O = f.element, f.label !== r.label && (v(W, f.label, !1), v(W, r.label, !0), O.text(f.label = r.label), O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), ti && O.prop("selected", f.selected))) : ("" === r.id && w ? N = w : (N = C.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {
                                element: N,
                                label: r.label,
                                id: r.id,
                                selected: r.selected
                            }), v(W, r.label, !0), O ? O.after(N) : i.element.append(N), O = N);
                            for (A++; l.length > A;)r = l.pop(), v(W, r.label, !1), r.element.remove()
                        }
                        for (; P.length > k;) {
                            for (n = P.pop(), A = 1; A < n.length; ++A)v(W, n[A].label, !1);
                            n[0].element.remove()
                        }
                        o(W, function (t, e) {
                    ...
                    var k;
                    if (!(k = b.match(i)))throw _a("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, W(s));
                    var E = r(k[2] || k[1]), A = k[4] || k[6], T = / as /.test(k[0]) && k[1], O = T ? r(T) : null, j = k[5], M = r(k[3] || ""), N = r(k[2] ? k[1] : A), I = r(k[7]), D = k[8], F = D ? r(k[8]) : null, V = {}, P = [[{
                        element: s,
                        label: ""
                    }]], _ = {};
                    w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), s.empty(), s.on("change", l), u.$render = m, e.$watchCollection(I, p), e.$watchCollection(d, p), y && e.$watchCollection(function () {
                        return u.$modelValue
                    }, p)
                }

                if (l[1]) {
                    for (var p, $ = l[0], v = l[1], y = c.multiple, b = c.ngOptions, w = !1, x = !1, C = ei(e.createElement("option")), S = ei(e.createElement("optgroup")), k = C.clone(), E = 0, A = u.children(), T = A.length; T > E; E++)if ("" === A[E].value) {
                        p = w = A.eq(E);
                        break
                    }
                    $.init(v, w, k), y && (v.$isEmpty = function (t) {
                        return !t || 0 === t.length
                    }), b ? h(s, u, v) : y ? d(s, u, v) : f(s, u, v, $)
                }
            }
        }
    ...
    }], La = v({restrict: "E", terminal: !1}), Ha = function () {
        return {
            restrict: "A", require: "?ngModel", link: function (t, e, n, r) {
    ...
    function n() {
        ...
        this.when = function (t, i) {
            ...
            function d(t) {
                var r = y.current;
                v = p(), m = v && r && v.$$route === r.$$route && e.equals(v.pathParams, r.pathParams) && !v.reloadOnSearch && !g, m || !r && !v || n.$broadcast("$routeChangeStart", v, r).defaultPrevented && t && t.preventDefault()
            }

            function h() {
                var t = y.current, r = v;
                m ? (t.params = r.params, e.copy(t.params, o), n.$broadcast("$routeUpdate", t)) : (r || t) && (g = !1, y.current = r, r && r.redirectTo && (e.isString(r.redirectTo) ? i.path($(r.redirectTo, r.params)).search(r.params).replace() : i.url(r.redirectTo(r.pathParams, i.path(), i.search())).replace()), a.when(r).then(function () {
                    if (r) {
            ...
            var v, m, g = !1, y = {
                routes: r, reload: function () {
                    ...
                    t = e.extend({}, this.current.params, t), i.path($(this.current.$$route.originalPath, t)), i.search(t)
                }
            };
        ...
        return {
            restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function (i, o, a, s, u) {
                ...
                function l() {
                    ...
                    if (e.isDefined(s)) {
                        var l = i.$new(), h = t.current, v = u(l, function (t) {
                            r.enter(t, null, d || o).then(function () {
                                !e.isDefined(p) || p && !i.$eval(p) || n()
                            }), c()
                        });
                        d = v, f = h.scope = l, f.$emit("$viewContentLoaded"), f.$eval($)
                    } else c()
                }

                var f, d, h, p = a.autoscroll, $ = a.onload || "";
...
FastClick.prototype.needsClick = function (t) {
    ...
    angular.module("mobile-angular-ui.core.activeLinks", []).run(["$rootScope", "$window", "$document", "$location", function (t, e, n, r) {
        var i = function () {
            ...
            for (var c = n[0].links, l = 0; l < c.length; l++) {
                var f = c[l], d = angular.element(f);
                f.href === t ? d.addClass("active") : f.href && f.href.length && d.removeClass("active")
            }
        };
        ...
        return {
            ...
            link: function (o, a, s, u, c) {
                ...
                o.$watch(h, function (e) {
                    ...
                    }); else if (d && (d.remove(), d = null), f && (f.$destroy(), f = null), l) {
                        d = r(l.clone);
                        var n = function () {
                            d = null
                        }, i = t.leave(d, n);
        ...
        e.set = function () {
            if (s(), !l && !o && a) {
                ...
                var c, f, d, h, p = [], $ = [], v = function () {
                    ...
                    if (e.intercept && e.intercept(), v(), m(), c = e.closest(t.target), c && c !== i && !(t.touches.length > 1)) {
                        g("none");
                        var n = t, r = c.scrollTop, o = c.scrollLeft, a = c.offsetHeight, s = c.offsetWidth, u = t.touches[0].pageY, l = t.touches[0].pageX, h = c.scrollHeight, b = c.scrollWidth, w = function (t) {
                            var e = r + u - t.touches[0].pageY, i = o + l - t.touches[0].pageX, g = e >= (p.length ? p[0] : 0), w = i >= ($.length ? $[0] : 0);
                            e > 0 && h - a > e || i > 0 && b - s > i ? t.preventDefault() : y(n), f && g !== f && v(), d && w !== d && m(), f = g, d = w, c.scrollTop = e, c.scrollLeft = i, p.unshift(e), $.unshift(i), p.length > 3 && p.pop(), $.length > 3 && $.pop()
                        }, x = function () {
        ...
        t.directive(n, ["$rootElement", "SharedState", "bindOuterClick", "$location", function (t, n, i, o) {
            return {
                restrict: "C", link: function (a, s, u) {
                    ...
                    var p = void 0 !== u.active && "false" !== u.active;
                    n.initialize(a, r, {defaultValue: p}), a.$on("mobile-angular-ui.state.changed." + r, function (e, n) {
                    ...
                    }), "false" !== u.closeOnOuterClicks && i(a, s, d, h)
                }
            }
        }])
    ...
    function t(t) {
        ...
        return function (n, r, i, o) {
            r = g(r, o, 4);
            var a = !C(n) && m.keys(n), s = (a || n).length, u = t > 0 ? 0 : s - 1;
    ...
    function e(t) {
        return function (e, n, r) {
            n = y(n, r);
            for (var i = null != e && e.length, o = t > 0 ? 0 : i - 1; o >= 0 && i > o; o += t)if (n(e[o], o, e))return o;
            return -1
        }
    }

    function n(t, e) {
        var n = T.length, r = t.constructor, i = m.isFunction(r) && r.prototype || a, o = "constructor";
        for (m.has(t, o) && !m.contains(e, o) && e.push(o); n--;)o = T[n], o in t && t[o] !== i[o] && !m.contains(e, o) && e.push(o)
    }

    var r = this, i = r._, o = Array.prototype, a = Object.prototype, s = Function.prototype, u = o.push, c = o.slice, l = a.toString, f = a.hasOwnProperty, d = Array.isArray, h = Object.keys, p = s.bind, $ = Object.create, v = function () {
    }, m = function (t) {
        return t instanceof m ? t : this instanceof m ? (this._wrapped = t, void 0) : new m(t)
    };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = m), exports._ = m) : r._ = m, m.VERSION = "1.8.2";
    var g = function (t, e, n) {
        ...
        return null == t ? m.identity : m.isFunction(t) ? g(t, e, n) : m.isObject(t) ? m.matcher(t) : m.property(t)
    };
    ...
    }, x = Math.pow(2, 53) - 1, C = function (t) {
        var e = t && t.length;
    ...
    m.each = m.forEach = function (t, e, n) {
        e = g(e, n);
        var r, i;
        if (C(t))for (r = 0, i = t.length; i > r; r++)e(t[r], r, t); else {
            var o = m.keys(t);
        ...
        e = y(e, n);
        for (var r = !C(t) && m.keys(t), i = (r || t).length, o = Array(i), a = 0; i > a; a++) {
            var s = r ? r[a] : a;
            o[a] = e(t[s], s, t)
        }
        return o
        ...
        var r;
        return r = C(t) ? m.findIndex(t, e, n) : m.findKey(t, e, n), void 0 !== r && -1 !== r ? t[r] : void 0
    }, m.filter = m.select = function (t, e, n) {
        var r = [];
        return e = y(e, n), m.each(t, function (t, n, i) {
            e(t, n, i) && r.push(t)
        }), r
    }, m.reject = function (t, e, n) {
        return m.filter(t, m.negate(y(e)), n)
    }, m.every = m.all = function (t, e, n) {
        e = y(e, n);
        for (var r = !C(t) && m.keys(t), i = (r || t).length, o = 0; i > o; o++) {
            var a = r ? r[o] : o;
        ...
        return !1
    }, m.contains = m.includes = m.include = function (t, e, n) {
        return C(t) || (t = m.values(t)), m.indexOf(t, e, "number" == typeof n && n) >= 0
    }, m.invoke = function (t, e) {
        var n = c.call(arguments, 2), r = m.isFunction(e);
        ...
        } else e = y(e, n), m.each(t, function (t, n, r) {
        ...
        for (var e, n = C(t) ? t : m.values(t), r = n.length, i = Array(r), o = 0; r > o; o++)e = m.random(0, o), e !== o && (i[o] = i[e]), i[e] = n[o];
        return i
    }, m.sample = function (t, e, n) {
        return null == e || n ? (C(t) || (t = m.values(t)), t[m.random(t.length - 1)]) : m.shuffle(t).slice(0, Math.max(0, e))
    }, m.sortBy = function (t, e, n) {
        return e = y(e, n), m.pluck(m.map(t, function (t, n, r) {
    ...
    var S = function (t) {
        return function (e, n, r) {
            var i = {};
            return n = y(n, r), m.each(e, function (r, o) {
                var a = n(r, o, e);
                t(i, r, a)
            }), i
        }
    ...
    m.groupBy = S(function (t, e, n) {
        ...
        return t ? m.isArray(t) ? c.call(t) : C(t) ? m.map(t, m.identity) : m.values(t) : []
    }, m.size = function (t) {
    ...
    var k = function (t, e, n, r) {
        for (var i = [], o = 0, a = r || 0, s = t && t.length; s > a; a++) {
            var u = t[a];
    ...
    m.flatten = function (t, e) {
        ...
        if (null == t)return [];
        m.isBoolean(e) || (r = n, n = e, e = !1), null != n && (n = y(n, r));
        for (var i = [], o = [], a = 0, s = t.length; s > a; a++) {
            var u = t[a], c = n ? n(u, a, t) : u;
            e ? (a && o === c || i.push(u), o = c) : n ? m.contains(o, c) || (o.push(c), i.push(u)) : m.contains(i, u) || i.push(u)
        }
        return i
    }, m.union = function () {
        ...
        for (var e = t && m.max(t, "length").length || 0, n = Array(e), r = 0; e > r; r++)n[r] = m.pluck(t, r);
        return n
    }, m.object = function (t, e) {
        for (var n = {}, r = 0, i = t && t.length; i > r; r++)e ? n[t[r]] = e[r] : n[t[r][0]] = t[r][1];
        return n
    }, m.indexOf = function (t, e, n) {
        var r = 0, i = t && t.length;
        if ("number" == typeof n)r = 0 > n ? Math.max(0, i + n) : n; else if (n && i)return r = m.sortedIndex(t, e), t[r] === e ? r : -1;
        if (e !== e)return m.findIndex(c.call(t, r), m.isNaN);
        for (; i > r; r++)if (t[r] === e)return r;
        return -1
    }, m.lastIndexOf = function (t, e, n) {
        var r = t ? t.length : 0;
        if ("number" == typeof n && (r = 0 > n ? r + n + 1 : Math.min(r, n + 1)), e !== e)return m.findLastIndex(c.call(t, 0, r), m.isNaN);
        for (; --r >= 0;)if (t[r] === e)return r;
        return -1
    ...
    var E = function (t, e, n, r, i) {
        ...
        var o = w(t.prototype), a = t.apply(o, i);
    ...
    m.bind = function (t, e) {
        ...
        var e = c.call(arguments, 1), n = function () {
            for (var r = 0, i = e.length, o = Array(i), a = 0; i > a; a++)o[a] = e[a] === m ? arguments[r++] : e[a];
        ...
        n || (n = {});
        var u = function () {
            s = n.leading === !1 ? 0 : m.now(), a = null, o = t.apply(r, i), a || (r = i = null)
        };
        return function () {
            var c = m.now();
            s || n.leading !== !1 || (s = c);
    ...
    var A = !{toString: null}.propertyIsEnumerable("toString"), T = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
    m.keys = function (t) {
        if (!m.isObject(t))return [];
        if (h)return h(t);
        var e = [];
        for (var r in t)m.has(t, r) && e.push(r);
        return A && n(t, e), e
        ...
        e = y(e, n);
        for (var r, i = m.keys(t), o = i.length, a = {}, s = 0; o > s; s++)r = i[s], a[r] = e(t[r], r, t);
        return a
    }, m.pairs = function (t) {
        ...
        e = y(e, n);
        for (var r, i = m.keys(t), o = 0, a = i.length; a > o; o++)if (r = i[o], e(t[r], r, t))return r
    }, m.pick = function (t, e, n) {
        var r, i, o = {}, a = t;
        if (null == a)return o;
        m.isFunction(e) ? (i = m.allKeys(a), r = g(e, n)) : (i = k(arguments, !1, !1, 1), r = function (t, e, n) {
            return e in n
        }, a = Object(a));
        ...
        if (m.isFunction(e))e = m.negate(e); else {
        ...
        return m.pick(t, e, n)
    }, m.defaults = b(m.allKeys, !0), m.clone = function (t) {
    ...
    var O = function (t, e, n, r) {
        ...
        if (!o) {
            ...
            if (a !== s && !(m.isFunction(a) && a instanceof a && m.isFunction(s) && s instanceof s) && "constructor"in t && "constructor"in e)return !1
        }
        n = n || [], r = r || [];
        ...
        if (n.push(t), r.push(e), o) {
            ...
            for (; u--;)if (c = f[u], !m.has(e, c) || !O(t[c], e[c], n, r))return !1
        }
    ...
    m.isEqual = function (t, e) {
        ...
        return null == t ? !0 : C(t) && (m.isArray(t) || m.isString(t) || m.isArguments(t)) ? 0 === t.length : 0 === m.keys(t).length
    }, m.isElement = function (t) {
        return !(!t || 1 !== t.nodeType)
    }, m.isArray = d || function (t) {
    ...
    m.escape = N(j), m.unescape = N(M), m.result = function (t, e, n) {
    ...
    m.template = function (t, e, n) {
        ...
        var r = RegExp([(e.escape || D).source, (e.interpolate || D).source, (e.evaluate || D).source].join("|") + "|$", "g"), i = 0, o = "__p+='";
        t.replace(r, function (e, n, r, a, s) {
            return o += t.slice(i, s).replace(V, P), i = s + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : a && (o += "';\n" + a + "\n__p+='"), e
    ...
    m.mixin = function (t) {
        m.each(m.functions(t), function (e) {
            ...
            m.prototype[e] = function () {
                var t = [this._wrapped];
                return u.apply(t, arguments), _(this, n.apply(m, t))
            }
        })
        ...
        m.prototype[t] = function () {
            var n = this._wrapped;
            return e.apply(n, arguments), "shift" !== t && "splice" !== t || 0 !== n.length || delete n[0], _(this, n)
        }
    }), m.each(["concat", "join", "slice"], function (t) {
        var e = o[t];
        m.prototype[t] = function () {
            return _(this, e.apply(this._wrapped, arguments))
        }
...
}.call(this), angular.module("Vatra.services.HardcodedTables", []).factory("singleTargetGrenadeConsumption", function () {
    return {
    ...
    return function (t) {
        t.adjustedSights = t.originalSights + t.forwardWindAdjustment + t.temperatureOfAirAdjustment + t.temperatureOfShellAdjustment + t.pressureAdjustment + t.angleAdjustment, t.sideAdjustment = .01 * (t.sideWindAdjustment + t.derivationAdjustment)
    }
    ...
    }, t.singleTarget = function () {
        return "single" == t.data.type
    }, t.calculated = function () {
        return !_.isEmpty(t.result)
    }, t.data = {
        devicesNumber: 1,
        type: "single",
        trajectory: "flat",
