...
!function (t, e, n) {
    ...
    function Je(t, r) {
        ...
        this.debugInfoEnabled = function (t) {
                ...
                switch (s) {
                    case yi:
                        ...
                        for (var f, d, h, p, $, v, m = t.attributes, g = 0, w = m && m.length; w > g; g++) {
                            ...
                            G(S) && p === S + "Start" && (x = d, C = d.substr(0, d.length - 5) + "end", d = d.substr(0, d.length - 6)), h = Ze(d.toLowerCase()), u[h] = d, (v || !n.hasOwnProperty(h)) && (n[h] = $, Ve(t, h) && (n[h] = !0)), te(t, e, $, h, v), B(e, h, "A", r, i, x, C)
                        }
            ...
            function L(t, a, s, u, c, l, f, d, h) {
                ...
                h = h || {};
                for (var x, S, k, A, T, O, j, N = -Number.MAX_VALUE, I = h.controllerDirectives, D = h.newIsolateScopeDirective, F = h.templateDirective, V = h.nonTlbTranscludeDirective, L = !1, B = !1, G = h.hasElementTranscludeDirective, X = s.$$element = ei(a), J = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    k = t[te];
                    var ie = k.$$start, se = k.$$end;
                    if (ie && (X = R(a, ie, se)), T = n, N > k.priority)break;
                    if ((j = k.scope) && (k.templateUrl || (y(j) ? (K("new/isolated scope", D || x, k, X), D = k) : K("new/isolated scope", D, k, X)), x = x || k), A = k.name, !k.templateUrl && k.controller && (j = k.controller, I = I || {}, K("'" + A + "' controller", I[A], k, X), I[A] = k), (j = k.transclude) && (L = !0, k.$$tlb || (K("transclusion", V, k, X), V = k), "element" == j ? (G = !0, N = k.priority, T = X, X = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = X[0], ee(c, q(T), a), Q = M(T, u, N, J && J.name, {nonTlbTranscludeDirective: V})) : (T = ei(we(a)).contents(), X.empty(), Q = M(T, u))), k.template)if (B = !0, K("template", F, k, X), F = k, j = C(k.template) ? k.template(X, s) : k.template, j = le(j), k.replace) {
                        ...
                        D && H(ce), t = t.concat(ce).concat(fe), z(s, ue), ne = t.length
                    } else X.html(j);
    ...
    var Fo = function (t) {
    ...
    }, Vo = Fo(), Po = Fo(!0), _o = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Ro = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, qo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Uo = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Lo = /^(\d{4})-(\d{2})-(\d{2})$/, Ho = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Bo = /^(\d{4})-W(\d\d)$/, Wo = /^(\d{4})-(\d\d)$/, Go = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, zo = {
        text: Nr,
        ...
        time: Vr("time", Go, Fr(Go, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        ...
        return {
            ...
            link: function (s, u, c, l) {
                ...
                function h(e, s, u) {
                    ...
                    function m() {
                        x = !1;
                        var t, n, r, i, l, f, d, p, m, b, k, A, T, O, N, D, R, q = {"": []}, U = [""], L = u.$viewValue, H = I(e) || [], B = j ? a(H) : H, W = {}, G = h(L), z = !1;
                        for (V = {}, A = 0; b = B.length, b > A; A++)d = A, j && (d = B[A], "$" === d.charAt(0)) || (p = H[d], t = c(M, d, p) || "", (n = q[t]) || (n = q[t] = [], U.push(t)), T = G(d, p), z = z || T, D = c(E, d, p), D = g(D) ? D : "", R = F ? F(e, _) : j ? B[A] : A, F && (V[R] = d), n.push({
                            id: R,
                            label: D,
                            selected: T
                        }));
