...
!function (t, e, n) {
    ...
    function i(t) {
        ...
        var e = t.length;
        return t.nodeType === yi && e ? !0 : b(t) || pi(t) || 0 === e || "number" == typeof e && e > 0 && e - 1 in t
    }

    function o(t, e, n) {
        var r, a;
        if (t)if (S(t))for (r in t)"prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r, t); else if (pi(t) || i(t)) {
    ...
    function _(t, e, n, r) {
        if (k(t) || E(t))throw ui("cpws", "Can't copy! Making copies of Window or Scope instances is not supported.");
        if (e) {
            ...
            if (pi(t)) {
                e.length = 0;
                for (var s = 0; s < t.length; s++)a = _(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(a)), e.push(a)
            } else {
                var u = e.$$hashKey;
                pi(e) ? e.length = 0 : o(e, function (t, n) {
                    delete e[n]
                });
                for (var c in t)t.hasOwnProperty(c) && (a = _(t[c], null, n, r), y(t[c]) && (n.push(t[c]), r.push(a)), e[c] = a);
                l(e, u)
            }
        } else if (e = t, t)if (pi(t))e = _(t, [], n, r); else if (x(t))e = new Date(t.getTime()); else if (C(t))e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex; else if (y(t)) {
    ...
    function V(t, e) {
        ...
        if (a == s && "object" == a) {
            if (!pi(t)) {
                ...
                if (E(t) || E(e) || k(t) || k(e) || pi(e) || x(e) || C(e))return !1;
                o = {};
    ...
    function L(t, e) {
        ...
        return !S(e) || e instanceof RegExp ? e : n.length ? function () {
            return arguments.length ? e.apply(t, P(n, arguments, 0)) : e.apply(t, n)
        } : function () {
    ...
    function U(t, r) {
        var i = r;
        return "string" == typeof t && "$" === t.charAt(0) && "$" === t.charAt(1) ? i = n : k(r) ? i = "$WINDOW" : r && e === r ? i = "$DOCUMENT" : E(r) && (i = "$SCOPE"), i
    }
    ...
    function G(t) {
        ...
        return o((t || "").split("&"), function (t) {
            if (t && (e = t.replace(/\+/g, "%20").split("="), n = W(e[0]), g(n))) {
                var i = g(e[1]) ? W(e[1]) : !0;
                Kr.call(r, n) ? pi(r[n]) ? r[n].push(i) : r[n] = [r[n], i] : r[n] = i
            }
        }), r
    }
    ...
    function J(t, e) {
        var n, r, i = $i.length;
        for (t = ei(t), r = 0; i > r; ++r)if (n = $i[r] + e, b(n = t.attr(n)))return n;
        return null
    }
    ...
    function Q(n, r, i) {
        ...
        }, S(ci.resumeDeferredBootstrap) && ci.resumeDeferredBootstrap(), void 0)
    }
    ...
    function oe(t, e, n) {
        return n && pi(t) && (t = t[t.length - 1]), ie(S(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), t
    }
    ...
    function he(e) {
        ...
        ri("ng", ["ngLocale"], ["$provide", function (t) {
            t.provider({$$sanitizeUri: Xn}), t.provider("$compile", Je).directive({
                a: jo,
                input: Yo,
                textarea: Yo,
                form: _o,
                ...
                ngValue: Ko,
                ngModelOptions: Ca
            }).directive({ngInclude: la}).directive(No).directive(aa), t.provider({
                $anchorScroll: ze,
                $animate: Yi,
                $browser: Ye,
                $cacheFactory: Xe,
    ...
    function ge(t, e) {
        ...
        if ($e(t))u.push(e.createTextNode(t)); else {
            for (n = n || s.appendChild(e.createElement("div")), r = (Fi.exec(t) || ["", ""])[1].toLowerCase(), i = Ri[r] || Ri._default, n.innerHTML = i[1] + t.replace(_i, "<$1></$2>") + i[2], a = i[0]; a--;)n = n.lastChild;
            u = P(u, n.childNodes), n = s.firstChild, n.textContent = ""
        }
    ...
    function ye(t, n) {
        n = n || e;
        var r;
        return (r = Di.exec(t)) ? [n.createElement(r[1])] : (r = ge(t, n)) ? r.childNodes : []
    }

    function be(t) {
        if (t instanceof be)return t;
        var e;
        if (b(t) && (t = hi(t), e = !0), !(this instanceof be)) {
    ...
    function Se(t, e, n, r) {
        if (g(r))throw Ni("offargs", "jqLite#off() does not support the `selector` argument");
        var i = ke(t), a = i && i.events, s = i && i.handle;
    ...
    function Ce(t, e) {
        var r = t.ng339, i = r && ki[r];
        if (i) {
            if (e)return delete i.data[e], void 0;
            i.handle && (i.events.$destroy && i.handle({}, "$destroy"), Se(t)), delete ki[r], t.ng339 = n
        }
    }

    function ke(t, e) {
        var r = t.ng339, i = r && ki[r];
        return e && !i && (t.ng339 = r = de(), i = ki[r] = {events: {}, data: {}, handle: n}), i
    }

    function Ee(t, e, n) {
        if (me(t)) {
            var r = g(n), i = !r && e && !y(e), o = !e, a = ke(t, !i), s = a && a.data;
            if (r)s[e] = n; else {
                if (o)return s;
                if (i)return s && s[e];
                f(s, e)
    ...
    function Te(t, e) {
        e && t.setAttribute && o(e.split(" "), function (e) {
            t.setAttribute("class", hi((" " + (t.getAttribute("class") || "") + " ").replace(/[\n\t]/g, " ").replace(" " + hi(e) + " ", " ")))
        })
    }
    ...
    function Oe(t, e) {
        if (e && t.setAttribute) {
            ...
            o(e.split(" "), function (t) {
                t = hi(t), -1 === n.indexOf(" " + t + " ") && (n += t + " ")
            }), t.setAttribute("class", hi(n))
        }
    }
    ...
    function Ue(t) {
        var e = t.toString().replace(zi, ""), n = e.match(Ui);
    ...
    function Be(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e)throw b(n) && n || (n = t.name || Ue(t)), Wi("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                    i = t.toString().replace(zi, ""), a = i.match(Ui), o(a[1].split(Bi), function (t) {
    ...
    function He(t, e) {
        ...
        function i(t, e) {
            if (ae(t, "service"), (S(e) || pi(e)) && (e = E.instantiate(e)), !e.$get)throw Wi("pget", "Provider '{0}' must define $get factory method.", t);
            return k[t + w] = e
        }
        ...
        function a(t, e) {
            return function () {
                ...
                if (m(n))throw Wi("undef", "Provider '{0}' must return a value from $get factory method.", t);
                return n
            }
        }
        ...
        function h(t) {
            ...
            return o(t, function (t) {
                ...
                if (!C.get(t)) {
                    C.put(t, !0);
                    try {
                        b(t) ? (e = ri(t), n = n.concat(h(e.requires)).concat(e._runBlocks), r(e._invokeQueue), r(e._configBlocks)) : S(t) ? n.push(E.invoke(t)) : pi(t) ? n.push(E.invoke(t)) : oe(t, "module")
                    } catch (i) {
        ...
        function v(t, n) {
            function r(e, r) {
                if (t.hasOwnProperty(e)) {
                    if (t[e] === g)throw Wi("cdep", "Circular dependency found: {0}", e + " <- " + x.join(" <- "));
                    return t[e]
                }
                try {
            ...
            function i(t, n, i, o) {
                ...
                var a, s, u, c = [], l = He.$$annotate(t, e, o);
            ...
            function o(t, e, n) {
                var r = Object.create((pi(t) ? t[t.length - 1] : t).prototype || null), o = i(t, r, e, n);
                return y(o) || S(o) ? o : r
            }

            return {
                invoke: i, instantiate: o, get: r, annotate: He.$$annotate, has: function (e) {
                    return k.hasOwnProperty(e + w) || t.hasOwnProperty(e)
                }
            }
        }

        e = e === !0;
        var g = {}, w = "Provider", x = [], C = new Le([], !0), k = {
            $provide: {
                provider: r(i),
                factory: r(s),
                service: r(c),
        ...
        }, E = k.$injector = v(k, function (t, e) {
            throw ci.isString(e) && x.push(e), Wi("unpr", "Unknown provider: {0}", x.join(" <- "))
        }), A = {}, T = A.$injector = v(A, function (t, e) {
            var r = E.get(t + w, e);
    ...
    function Ge(t, e, r, i) {
        ...
        function f() {
            T = l(), T = m(T) ? null : T, V(T, F) && (T = F), F = T
        }

        function p() {
            (M !== v.url() || O !== T) && (M = v.url(), O = T, o(D, function (t) {
                t(v.url(), T)
            }))
        }
        ...
        var v = this, $ = e[0], g = t.location, y = t.history, w = t.setTimeout, x = t.clearTimeout, S = {};
        v.isMock = !1;
        var C = 0, k = [];
        v.$$completeOutstandingRequest = a, v.$$incOutstandingRequestCount = function () {
            C++
        }, v.notifyWhenNoOutstandingRequests = function (t) {
            o(A, function (t) {
                t()
            }), 0 === C ? t() : k.push(t)
        };
        var E, A = [];
        v.addPollFn = function (t) {
            return m(E) && u(100, w), A.push(t), t
        };
        var T, O, M = g.href, j = e.find("base"), N = null;
        f(), O = T, v.url = function (e, n, r) {
            if (m(r) && (r = null), g !== t.location && (g = t.location), y !== t.history && (y = t.history), e) {
                var o = O === r;
                if (M === e && (!i.history || o))return v;
                var a = M && xn(M) === xn(e);
                return M = e, O = r, !i.history || a && o ? (a || (N = e), n ? g.replace(e) : a ? g.hash = s(e) : g.href = e) : (y[n ? "replaceState" : "pushState"](r, "", e), f(), O = T), v
            }
        ...
        var D = [], I = !1, F = null;
        v.onUrlChange = function (e) {
            return I || (i.history && ei(t).on("popstate", c), ei(t).on("hashchange", c), I = !0), D.push(e), e
        }, v.$$checkUrlChange = p, v.baseHref = function () {
            var t = j.attr("href");
            return t ? t.replace(/^(https?\:)?\/\/[^\/]*/, "") : ""
        };
        var _ = {}, R = "", P = v.baseHref();
        v.cookies = function (t, e) {
            var i, o, a, s, u;
            if (!t) {
                if ($.cookie !== R)for (R = $.cookie, o = R.split("; "), _ = {}, s = 0; s < o.length; s++)a = o[s], u = a.indexOf("="), u > 0 && (t = h(a.substring(0, u)), _[t] === n && (_[t] = h(a.substring(u + 1))));
                return _
            }
            e === n ? $.cookie = encodeURIComponent(t) + "=;path=" + P + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(e) && (i = ($.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + ";path=" + P).length + 1, i > 4096 && r.warn("Cookie '" + t + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"))
        }, v.defer = function (t, e) {
            var n;
            return C++, n = w(function () {
                delete S[n], a(t)
            }, e || 0), S[n] = !0, n
        }, v.defer.cancel = function (t) {
            return S[t] ? (delete S[t], x(t), a(d), !0) : !1
        }
    }
    ...
    function Xe() {
        this.$get = function () {
            function t(t, n) {
                ...
                var a = 0, s = f({}, n, {id: t}), u = {}, c = n && n.capacity || Number.MAX_VALUE, l = {}, p = null, h = null;
                return e[t] = {
                    put: function (t, e) {
                        ...
                        if (!m(e))return t in u || a++, u[t] = e, a > c && this.remove(h.key), e
                    }, get: function (t) {
                        if (c < Number.MAX_VALUE) {
                            var e = l[t];
                            if (!e)return;
    ...
    function Je(t, r) {
        ...
        var a = {}, s = "Directive", c = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, l = /(([\w\-]+)(?:\:([^;]+))?;?)/, p = D("ngSrc,ngSrcset,src,srcset"), m = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, w = /^(on[a-z]+|formaction)$/;
        this.directive = function C(e, n) {
            return ae(e, "directive"), b(e) ? (ie(n, "directiveFactory"), a.hasOwnProperty(e) || (a[e] = [], t.factory(e + s, ["$injector", "$exceptionHandler", function (t, n) {
                ...
                return o(a[e], function (o, a) {
                    try {
                        var s = t.invoke(o);
                        S(s) ? s = {compile: $(s)} : !s.compile && s.link && (s.compile = $(s.link)), s.priority = s.priority || 0, s.index = a, s.name = s.name || e, s.require = s.require || s.controller && s.name, s.restrict = s.restrict || "EA", y(s.scope) && (s.$$isolateBindings = i(s.scope, s.name)), r.push(s)
                    } catch (u) {
                        n(u)
                    }
                }), r
        ...
        this.debugInfoEnabled = function (t) {
        ...
        }, this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (t, r, i, u, $, g, C, k, A, T, O) {
            function M(t, e) {
                try {
                    t.addClass(e)
                } catch (n) {
            ...
            function j(t, e, n, r, i) {
                ...
                return function (e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? ei(Z(s, ei("<div>").append(t).html())) : n ? Vi.clone.call(t) : t, o)for (var l in o)c.data("$" + l + "Controller", o[l].instance);
            ...
            function N(t) {
                var e = t && t[0];
                return e ? "foreignobject" !== I(e) && e.toString().match(/SVG/) ? "svg" : "html" : "html"
            }
            ...
            function D(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    ...
                    if (d) {
                        var m = r.length;
                        for ($ = new Array(m), l = 0; l < v.length; l += 3)p = v[l], $[p] = r[p]
                    } else $ = r;
                    for (l = 0, f = v.length; f > l;)u = $[v[l++]], a = v[l++], s = v[l++], a ? (a.scope ? (c = t.$new(), j.$$addScopeInfo(ei(u), c)) : c = t, h = a.transcludeOnThisElement ? _(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? _(t, e) : null, a(s, c, u, i, h)) : s && s(t, u.childNodes, n, o)
                }

                for (var u, c, l, f, p, h, d, v = [], $ = 0; $ < t.length; $++)u = new ae, c = R(t[$], [], u, 0 === $ ? i : n, o), l = c.length ? U(c, t[$], u, e, r, null, [], [], a) : null, l && l.scope && j.$$addScopeClass(u.$$element), p = l && l.terminal || !(f = t[$].childNodes) || !f.length ? null : D(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || p) && (v.push($, l, p), h = !0, d = d || l), a = null;
                return h ? s : null
            }
            ...
            function R(t, e, n, r, i) {
                ...
                switch (s) {
                    case yi:
                        H(e, Ze(I(t)), "E", r, i);
                        for (var f, p, h, d, v, $, m = t.attributes, g = 0, w = m && m.length; w > g; g++) {
                            var x = !1, S = !1;
                            f = m[g], p = f.name, v = hi(f.value), d = Ze(p), ($ = fe.test(d)) && (p = p.replace(Ki, "").substr(8).replace(/_(.)/g, function (t, e) {
                                return e.toUpperCase()
                            }));
                            var C = d.replace(/(Start|End)$/, "");
                            W(C) && d === C + "Start" && (x = p, S = p.substr(0, p.length - 5) + "end", p = p.substr(0, p.length - 6)), h = Ze(p.toLowerCase()), u[h] = p, ($ || !n.hasOwnProperty(h)) && (n[h] = v, _e(t, h) && (n[h] = !0)), te(t, e, v, h, $), H(e, h, "A", r, i, x, S)
                        }
                        if (a = t.className, y(a) && (a = a.animVal), b(a) && "" !== a)for (; o = l.exec(a);)h = Ze(o[2]), H(e, h, "C", r, i) && (n[h] = hi(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case bi:
                        J(e, t.nodeValue);
                        break;
                    case wi:
                        try {
                            o = c.exec(t.nodeValue), o && (h = Ze(o[1]), H(e, h, "M", r, i) && (n[h] = hi(o[2])))
                        } catch (k) {
                        }
                }
                return e.sort(X), e
            ...
            function L(t, e, n) {
                return function (r, i, o, a, s) {
                    return i = P(i[0], e, n), t(r, i, o, a, s)
                }
            }

            function U(t, a, s, u, c, l, f, p, h) {
                function d(t, e, n, r) {
                    t && (n && (t = L(t, n, r)), t.require = k.require, t.directiveName = A, (I === k || k.$$isolateScope) && (t = re(t, {isolateScope: !0})), f.push(t)), e && (n && (e = L(e, n, r)), e.require = k.require, e.directiveName = A, (I === k || k.$$isolateScope) && (e = re(e, {isolateScope: !0})), p.push(e))
                }

                function v(t, e, n, r) {
                    var i, a, s = "data", u = !1, c = n;
                    if (b(e)) {
                        if (a = e.match(m), e = e.substring(a[0].length), a[3] && (a[1] ? a[3] = null : a[1] = a[3]), "^" === a[1] ? s = "inheritedData" : "^^" === a[1] && (s = "inheritedData", c = n.parent()), "?" === a[2] && (u = !0), i = null, r && "data" === s && (i = r[e]) && (i = i.instance), i = i || c[s]("$" + e + "Controller"), !i && !u)throw Xi("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", e, t);
                        return i || null
                    }
                ...
                function w(t, e, i, u, c) {
                    function l(t, e, r) {
                        var i;
                        return E(t) || (r = e, e = t, t = n), W && (i = w), r || (r = W ? S.parent() : S), c(t, e, i, r, O)
                    }

                    var h, d, m, y, b, w, x, S, k;
                    if (a === i ? (k = s, S = s.$$element) : (S = ei(i), k = new ae(S, s)), I && (b = e.$new(!0)), c && (x = l, x.$$boundTransclude = c), D && (C = {}, w = {}, o(D, function (t) {
                            var n, r = {
                                $scope: t === I || t.$$isolateScope ? b : e,
                                $element: S,
                                $attrs: k,
                                $transclude: x
                            };
                            y = t.controller, "@" == y && (y = k[t.name]), n = g(y, r, !0, t.controllerAs), w[t.name] = n, W || S.data("$" + t.name + "Controller", n.instance), C[t.name] = n
                        })), I) {
                        j.$$addScopeInfo(S, b, !0, !(F && (F === I || F === I.$$originalDirective))), j.$$addScopeClass(S, !0);
                        var A = C && C[I.name], T = b;
                        A && A.identifier && I.bindToController === !0 && (T = A.instance), o(b.$$isolateBindings = I.$$isolateBindings, function (t, n) {
                            ...
                            switch (l) {
                                ...
                                case"=":
                                    if (c && !k[u])return;
                                    o = $(k[u]), s = o.literal ? V : function (t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function () {
                                        throw i = T[n] = o(e), Xi("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", k[u], I.name)
                                    }, i = T[n] = o(e);
                                    var f = function (t) {
                                    ...
                                    f.$stateful = !0;
                                    var p;
                                    p = t.collection ? e.$watchCollection(k[u], f) : e.$watch($(k[u], f), null, o.literal), b.$on("$destroy", p);
                                    break;
                                case"&":
                                    o = $(k[u]), T[n] = function (t) {
                                        return o(e, t)
                                    }
                            }
                        })
                    ...
                    for (C && (o(C, function (t) {
                        t()
                    }), C = null), h = 0, d = f.length; d > h; h++)m = f[h], oe(m, m.isolateScope ? b : e, S, k, m.require && v(m.directiveName, m.require, S, w), x);
                    var O = e;
                    for (I && (I.template || null === I.templateUrl) && (O = b), t && t(O, i.childNodes, n, c), h = p.length - 1; h >= 0; h--)m = p[h], oe(m, m.isolateScope ? b : e, S, k, m.require && v(m.directiveName, m.require, S, w), x)
                }

                h = h || {};
                for (var x, C, k, A, T, O, M, N = -Number.MAX_VALUE, D = h.controllerDirectives, I = h.newIsolateScopeDirective, F = h.templateDirective, _ = h.nonTlbTranscludeDirective, U = !1, H = !1, W = h.hasElementTranscludeDirective, X = s.$$element = ei(a), J = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    k = t[te];
                    var ie = k.$$start, se = k.$$end;
                    if (ie && (X = P(a, ie, se)), T = n, N > k.priority)break;
                    if ((M = k.scope) && (k.templateUrl || (y(M) ? (K("new/isolated scope", I || x, k, X), I = k) : K("new/isolated scope", I, k, X)), x = x || k), A = k.name, !k.templateUrl && k.controller && (M = k.controller, D = D || {}, K("'" + A + "' controller", D[A], k, X), D[A] = k), (M = k.transclude) && (U = !0, k.$$tlb || (K("transclusion", _, k, X), _ = k), "element" == M ? (W = !0, N = k.priority, T = X, X = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = X[0], ee(c, q(T), a), Q = j(T, u, N, J && J.name, {nonTlbTranscludeDirective: _})) : (T = ei(we(a)).contents(), X.empty(), Q = j(T, u))), k.template)if (H = !0, K("template", F, k, X), F = k, M = S(k.template) ? k.template(X, s) : k.template, M = le(M), k.replace) {
                        if (J = k, T = $e(M) ? [] : tn(Z(k.templateNamespace, hi(M))), a = T[0], 1 != T.length || a.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", A, "");
                        ee(c, X, a);
                        var ue = {$attr: {}}, ce = R(a, [], ue), fe = t.splice(te + 1, t.length - (te + 1));
                        I && B(ce), t = t.concat(ce).concat(fe), G(s, ue), ne = t.length
                    } else X.html(M);
                    if (k.templateUrl)H = !0, K("template", F, k, X), F = k, k.replace && (J = k), w = Y(t.splice(te, t.length - te), X, s, c, U && Q, f, p, {
                        controllerDirectives: D,
                        newIsolateScopeDirective: I,
                        templateDirective: F,
                        nonTlbTranscludeDirective: _
                    }), ne = t.length; else if (k.compile)try {
                        O = k.compile(X, s, Q), S(O) ? d(null, O, ie, se) : O && d(O.pre, O.post, ie, se)
                    } catch (pe) {
                        i(pe, z(X))
                    }
                    k.terminal && (w.terminal = !0, N = Math.max(N, k.priority))
                }
                return w.scope = x && x.scope === !0, w.transcludeOnThisElement = U, w.elementTranscludeOnThisElement = W, w.templateOnThisElement = H, w.transclude = Q, h.hasElementTranscludeDirective = W, w
            }
            ...
            function H(e, r, o, u, c, l, f) {
                if (r === c)return null;
                var p = null;
                if (a.hasOwnProperty(r))for (var d, v = t.get(r + s), $ = 0, m = v.length; m > $; $++)try {
                    d = v[$], (u === n || u > d.priority) && -1 != d.restrict.indexOf(o) && (l && (d = h(d, {
                        $$start: l,
                        $$end: f
                    })), e.push(d), p = d)
                } catch (g) {
            ...
            function Y(t, e, n, r, i, a, s, c) {
                var l, f, p = [], d = e[0], v = t.shift(), $ = h(v, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: v
                }), m = S(v.templateUrl) ? v.templateUrl(e, n) : v.templateUrl, g = v.templateNamespace;
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                    var h, b, w, x;
                    if (u = le(u), v.replace) {
                        if (w = $e(u) ? [] : tn(Z(g, hi(u))), h = w[0], 1 != w.length || h.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", v.name, m);
                        b = {$attr: {}}, ee(r, e, h);
                        var S = R(h, [], b);
                        y(v.scope) && B(S), t = S.concat(t), G(n, b)
                    } else h = d, e.html(u);
                    for (t.unshift($), l = U(t, h, n, i, e, v, a, s, c), o(r, function (t, n) {
                        t == h && (r[n] = e[0])
                    }), f = D(e[0].childNodes, i); p.length;) {
                        var C = p.shift(), k = p.shift(), E = p.shift(), A = p.shift(), T = e[0];
                        if (!C.$$destroyed) {
                            if (k !== d) {
                                var O = k.className;
                                c.hasElementTranscludeDirective && v.replace || (T = we(h)), ee(E, ei(k), T), M(ei(T), O)
                            }
                            x = l.transcludeOnThisElement ? _(C, l.transclude, A) : A, l(f, C, T, r, x)
                        }
                    }
                    p = null
                }), function (t, e, n, r, i) {
                    var o = i;
                    e.$$destroyed || (p ? p.push(e, n, r, o) : (l.transcludeOnThisElement && (o = _(e, l.transclude, i)), l(f, e, n, r, o)))
                }
            }
            ...
            function K(t, e, n, r) {
                if (e)throw Xi("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, z(r))
            }
            ...
            function te(t, e, n, i, o) {
                ...
                var s = r(n, !0, a, o);
                if (s) {
                    if ("multiple" === i && "select" === I(t))throw Xi("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", z(t));
                    e.push({
            ...
            function ee(t, n, r) {
                ...
                for (var h = 1, d = n.length; d > h; h++) {
                    var v = n[h];
                    ei(v).remove(), p.appendChild(v), delete n[h]
                }
                n[0] = r, n.length = 1
            }
            ...
            ae.prototype = {
                $normalize: Ze, $addClass: function (t) {
                    ...
                    var s, u = this.$$element[0], c = _e(u, t), l = Re(u, t), f = t;
                    if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = ne(t, "-"))), s = I(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t)this[t] = e = O(e, "src" === t); else if ("img" === s && "srcset" === t) {
                        for (var p = "", h = hi(e), d = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, v = /\s/.test(h) ? d : /(,)/, $ = h.split(v), m = Math.floor($.length / 2), g = 0; m > g; g++) {
                            var y = 2 * g;
                            p += O(hi($[y]), !0), p += " " + hi($[y + 1])
                        }
                        var b = hi($[2 * g]).split(/\s/);
                        p += O(hi(b[0]), !0), 2 === b.length && (p += " " + hi(b[1])), this[t] = e = p
                    }
            ...
            var se = r.startSymbol(), ue = r.endSymbol(), le = "{{" == se || "}}" == ue ? v : function (t) {
    ...
    function en() {
        ...
        this.register = function (e, n) {
            ...
            return function (r, u, c, l) {
                var p, h, d, v;
                if (c = c === !0, l && b(l) && (v = l), b(r)) {
                    if (h = r.match(i), !h)throw Ji("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
                    d = h[1], v = v || h[3], r = t.hasOwnProperty(d) ? t[d] : se(u.$scope, d, !0) || (e ? se(a, d, !0) : n), oe(r, d, !0)
                }
                if (c) {
                    var $ = (pi(r) ? r[r.length - 1] : r).prototype;
                    return p = Object.create($ || null), v && s(u, v, p, d || r.name), f(function () {
                        return o.invoke(r, p, u, d), p
                    }, {instance: p, identifier: v})
                }
                return p = o.instantiate(r, u, d), v && s(u, v, p, d || r.name), p
            }
        }]
    }
    ...
    function sn(t) {
        var e, n, r, i = ce();
        return t ? (o(t.split("\n"), function (t) {
            r = t.indexOf(":"), e = Xr(hi(t.substr(0, r))), n = hi(t.substr(r + 1)), e && (i[e] = i[e] ? i[e] + ", " + n : n)
        }), i) : i
    }
    ...
    function fn() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, p, h) {
            function d(e) {
                function i(t) {
                    var e = f({}, t);
            ...
            function w(r, i) {
                function o(t, n, r, i) {
                    ...
                    h && (ln(t) ? h.put(x, [t, n, sn(r), i]) : h.remove(x)), e ? l.$applyAsync(o) : (o(), l.$$phase || l.$apply())
                }

                function s(t, e, n, i) {
                    e = Math.max(e, 0), (ln(e) ? $.resolve : $.reject)({
                        data: t,
                        status: e,
                        headers: un(n),
                        config: r,
                ...
                var h, v, $ = p.defer(), b = $.promise, w = r.headers, x = C(r.url, r.params);
                if (d.pendingRequests.push(r), b.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(t.cache) ? t.cache : k), h && (v = h.get(x), g(v) ? j(v) ? v.then(c, c) : pi(v) ? s(v[1], v[0], R(v[2]), v[3]) : s(v, 200, {}, "OK") : h.put(x, b)), m(v)) {
            ...
            function C(t, e) {
                ...
                return s(e, function (t, e) {
                    null === t || m(t) || (pi(t) || (t = [t]), o(t, function (t) {
            ...
            }), d.pendingRequests = [], v("get", "delete", "head", "jsonp"), $("post", "put", "patch"), d.defaults = t, d
        }]
    }
    ...
    function hn() {
        this.$get = ["$browser", "$window", "$document", function (t, e, n) {
            return dn(t, pn, t.defer, e.angular.callbacks, n[0])
        }]
    }
    ...
    function dn(t, e, r, i, a) {
        ...
        return function (a, u, c, l, f, p, h, v) {
            function $() {
                b && b(), w && w.abort()
            }

            function m(e, i, o, a, s) {
                C !== n && r.cancel(C), b = w = null, e(i, o, a, s), t.$$completeOutstandingRequest(d)
            }
            ...
            if (t.$$incOutstandingRequestCount(), u = u || t.url(), "jsonp" == Xr(a)) {
                ...
                w.open(a, u, !0), o(f, function (t, e) {
                    ...
                    0 === n && (n = e ? 200 : "file" == ir(u).protocol ? 404 : 0), m(l, n, e, w.getAllResponseHeaders(), t)
                };
                var x = function () {
                    m(l, -1, null, null, "")
                };
                if (w.onerror = x, w.onabort = x, h && (w.withCredentials = !0), v)try {
                    w.responseType = v
                } catch (S) {
                    if ("json" !== v)throw S
                }
            ...
            if (p > 0)var C = r($, p); else j(p) && p.then($)
        }
    }
    ...
    function vn() {
        ...
        this.startSymbol = function (e) {
            ...
            function a(o, a, p, h) {
                ...
                h = !!h;
                for (var $, y, b, w = 0, x = [], C = [], k = o.length, E = [], A = []; k > w;) {
                    if (-1 == ($ = o.indexOf(t, w)) || -1 == (y = o.indexOf(e, $ + s))) {
                        w !== k && E.push(d(o.substring(w)));
                        break
                    }
                    w !== $ && E.push(d(o.substring(w, $))), b = o.substring($ + s, y), x.push(b), C.push(n(b, v)), w = y + u, A.push(E.length), E.push("")
                }
                if (p && E.length > 1)throw ro("noconcat", "Error while interpolating: {0}\nStrict Contextual Escaping disallows interpolations that concatenate multiple expressions when a trusted value is required.  See http://docs.angularjs.org/api/ng.$sce", o);
                if (!a || x.length) {
                    var T = function (t) {
    ...
    function $n() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (t, e, n, r) {
            function i(i, a, s, u) {
                var c = e.setInterval, l = e.clearInterval, f = 0, p = g(u) && !u, h = (p ? r : n).defer(), d = h.promise;
                return s = g(s) ? s : 0, d.then(null, null, i), d.$$intervalId = c(function () {
                    h.notify(f++), s > 0 && f >= s && (h.resolve(f), l(d.$$intervalId), delete o[d.$$intervalId]), p || t.$apply()
                }, a), o[d.$$intervalId] = h, d
            }
    ...
    function En(t, e) {
        ...
        yn(t, this), this.$$parse = function (t) {
            var e = wn(r, t);
            if (!b(e))throw ao("ipthprfx", 'Invalid url "{0}", missing path prefix "{1}".', t, r);
            bn(e, this), this.$$path || (this.$$path = "/"), this.$$compose()
        }, this.$$compose = function () {
            var t = Y(this.$$search), e = this.$$hash ? "#" + X(this.$$hash) : "";
    ...
    function An(t, e) {
        ...
        yn(t, this), this.$$parse = function (r) {
            ...
            "#" === a.charAt(0) ? (o = wn(e, a), m(o) && (o = a)) : o = this.$$html5 ? a : "", bn(o, this), this.$$path = i(this.$$path, o, t), this.$$compose()
        }, this.$$compose = function () {
        ...
        this.hashPrefix = function (e) {
            ...
            o.on("click", function (t) {
                if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                    for (var i = ei(t.target); "a" !== I(i[0]);)if (i[0] === o[0] || !(i = i.parent())[0])return;
                    var s = i.prop("href"), u = i.attr("href") || i.attr("xlink:href");
                    y(s) && "[object SVGAnimatedString]" === s.toString() && (s = ir(s.animVal).href), d.test(s) || !s || i.attr("target") || t.isDefaultPrevented() || c.$$parseLinkUrl(s, u) && (t.preventDefault(), c.absUrl() != r.url() && (n.$apply(), a.angular["ff-684208-preventDefault"] = !0))
                }
            }), Sn(c.absUrl()) != Sn(h) && r.url(c.absUrl(), !0);
            var v = !0;
    ...
    function Rn(t, e, n, r, i) {
        ...
        return o = Dn(a.shift(), i), In(t[o], i), t[o] = r, r
    }
    ...
    function Pn(t, e, r, i, o, a, s) {
        Dn(t, a), Dn(e, a), Dn(r, a), Dn(i, a), Dn(o, a);
        var u = function (t) {
            return In(t, a)
        }, c = s || Vn(t) ? u : v, l = s || Vn(e) ? u : v, f = s || Vn(r) ? u : v, p = s || Vn(i) ? u : v, h = s || Vn(o) ? u : v;
        return function (a, s) {
            var u = s && s.hasOwnProperty(t) ? s : a;
            return null == u ? u : (u = c(u[t]), e ? null == u ? n : (u = l(u[e]), r ? null == u ? n : (u = f(u[r]), i ? null == u ? n : (u = p(u[i]), o ? null == u ? n : u = h(u[o]) : u) : u) : u) : u)
        }
    }
    ...
    function Ln(t, e, r) {
        ...
        if (e.csp)s = 6 > c ? Pn(u[0], u[1], u[2], u[3], u[4], r, i) : function (t, e) {
            var o, a = 0;
            do o = Pn(u[a++], u[a++], u[a++], u[a++], u[a++], r, i)(t, e), e = n, t = o; while (c > a);
            return o
        }; else {
            var l = "";
            i && (l += "s = eso(s, fe);\nl = eso(l, fe);\n");
            ...
            o(u, function (t, e) {
                ...
                (i || Vn(t)) && (n = "eso(" + n + ", fe)", f = !0), l += "if(s == null) return undefined;\ns=" + n + ";\n"
            }), l += "return s;";
            var p = new Function("s", "l", "eso", "fe", l);
            p.toString = $(l), f && (p = qn(p, r)), s = p
        }
    ...
    function Un(t) {
        return S(t.valueOf) ? t.valueOf() : bo.call(t)
    }
    ...
    function Bn() {
        ...
        this.$get = ["$filter", "$sniffer", function (n, r) {
            ...
            var h = {csp: r.csp, expensiveChecks: !1}, v = {csp: r.csp, expensiveChecks: !0};
            return function (r, o, a) {
                var s, $, m;
                switch (typeof r) {
                    case"string":
                        ...
                        if (s = g[m], !s) {
                            ...
                            var y = a ? v : h, b = new $o(y), w = new mo(b, n, y);
                            s = w.parse(r), s.constant ? s.$$watchDelegate = f : $ ? (s = i(s), s.$$watchDelegate = s.literal ? l : c) : s.inputs && (s.$$watchDelegate = u), g[m] = s
                        }
                        return p(s, o);
                    case"function":
                        return p(r, o);
    ...
    function Wn(t, e) {
        ...
        return g.defer = h, g.reject = d, g.when = m, g.all = f, g
    }
        ...
        this.digestTtl = function (t) {
            ...
            h.prototype = {
                constructor: h, $new: function (e, n) {
                    var r;
                    return n = n || this, e ? (r = new h, r.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = t(this)), r = new this.$$ChildScope), r.$parent = n, r.$$prevSibling = n.$$childTail, n.$$childHead ? (n.$$childTail.$$nextSibling = r, n.$$childTail = r) : n.$$childHead = n.$$childTail = r, (e || n != this) && r.$on("$destroy", p), r
                }, $watch: function (t, e, n) {
                    var r = l(t);
                    if (r.$$watchDelegate)return r.$$watchDelegate(this, e, n, r);
                    var i = this, o = i.$$watchers, s = {fn: e, last: b, get: r, exp: t, eq: !!n};
                    return a = null, S(e) || (s.fn = d), o || (o = i.$$watchers = []), o.unshift(s), function () {
                        F(o, s), a = null
                    }
                    ...
                    function n(t) {
                        ...
                        if (!m(o)) {
                            if (y(o))if (i(o)) {
                                ...
                                a !== d && (a = d = {}, $ = 0, f++), e = 0;
                                for (n in o)o.hasOwnProperty(n) && (e++, s = o[n], u = a[n], n in a ? (r = u !== u && s !== s, r || u === s || (f++, a[n] = s)) : ($++, a[n] = s, f++));
                                if ($ > e) {
                                    f++;
                    ...
                    function r() {
                        if (v ? (v = !1, e(o, o, u)) : e(o, s, u), c)if (y(o))if (i(o)) {
                    ...
                    n.$stateful = !0;
                    var o, a, s, u = this, c = e.length > 1, f = 0, p = l(t, n), h = [], d = {}, v = !0, $ = 0;
                    return this.$watch(p, r)
                }, $digest: function () {
                    var t, r, i, o, c, l, p, h, d, m, g = e, y = this, x = [];
                    v("$digest"), f.$$checkUrlChange(), this === C && null !== s && (f.defer.cancel(s), w()), a = null;
                    do {
                        for (l = !1, h = y; k.length;) {
                            try {
                        ...
                        t:do {
                            if (o = h.$$watchers)for (c = o.length; c--;)try {
                                if (t = o[c])if ((r = t.get(h)) === (i = t.last) || (t.eq ? V(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                    if (t === a) {
                                        l = !1;
                                        break t
                                    }
                                } else l = !0, a = t, t.last = t.eq ? _(r, null) : r, t.fn(r, i === b ? r : i, h), 5 > g && (d = 4 - g, x[d] || (x[d] = []), x[d].push({
                            ...
                            if (!(p = h.$$childHead || h !== y && h.$$nextSibling))for (; h !== y && !(p = h.$$nextSibling);)h = h.$parent
                        } while (h = p);
                        if ((l || k.length) && !g--)throw $(), n("infdig", "{0} $digest() iterations reached. Aborting!\nWatchers fired in the last 5 iterations: {1}", e, x)
                    } while (l || k.length);
                    for ($(); E.length;)try {
                        E.shift()()
                    } catch (A) {
                    ...
                    for (var o, a, s, c = P([i], arguments, 1); n = r;) {
            ...
            var C = new h, k = C.$$asyncQueue = [], E = C.$$postDigestQueue = [], A = C.$$applyAsyncQueue = [];
            return C
        }]
    }
    ...
    function Kn(t) {
        if ("self" === t)return t;
        if (b(t)) {
            if (t.indexOf("***") > -1)throw wo("iwcard", "Illegal sequence *** in string matcher.  String: {0}", t);
    ...
    function Zn() {
        ...
        this.resourceUrlWhitelist = function (e) {
            ...
            function s(t, e) {
                ...
                if (!r)throw wo("icontext", "Attempted to trust a value in invalid context. Context: {0}; Value: {1}", t, e);
                if (null === e || e === n || "" === e)return e;
                if ("string" != typeof e)throw wo("itype", "Attempted to trust a non-string value in a content requiring a string: Context: {0}", t);
                return new r(e)
            }
    ...
    function Qn() {
        ...
        this.enabled = function (e) {
            ...
            if (t && 8 > ti)throw wo("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
            var r = R(xo);
    ...
    function tr() {
        this.$get = ["$window", "$document", function (t, e) {
            var n, r, i = {}, o = p((/android (\d+)/.exec(Xr((t.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((t.navigator || {}).userAgent), s = e[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, c = s.body && s.body.style, l = !1, f = !1;
            if (c) {
                for (var h in c)if (r = u.exec(h)) {
                    n = r[0], n = n.substr(0, 1).toUpperCase() + n.substr(1);
                    break
                }
                n || (n = "WebkitOpacity"in c && "webkit"), l = !!("transition"in c || n + "Transition"in c), f = !!("animation"in c || n + "Animation"in c), !o || l && f || (l = b(s.body.style.webkitTransition), f = b(s.body.style.webkitAnimation))
            }
            return {
                history: !(!t.history || !t.history.pushState || 4 > o || a), hasEvent: function (t) {
                    ...
                    return i[t]
                }, csp: vi(), vendorPrefix: n, transitions: l, animations: f, android: o
            }
        }]
    }
    ...
    function rr() {
        this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function (t, e, n, r, i) {
            function o(o, s, u) {
                var c, l = g(u) && !u, f = (l ? r : n).defer(), p = f.promise;
    ...
    function ir(t) {
        var e = t;
        return ti && (So.setAttribute("href", e), e = So.href), So.setAttribute("href", e), {
            href: So.href,
    ...
    function sr(t) {
        ...
        }], e("currency", fr), e("date", Cr), e("filter", ur), e("json", kr), e("limitTo", Er), e("lowercase", Oo), e("number", pr), e("orderBy", Ar), e("uppercase", Mo)
    }
    ...
    function cr(t, e, n) {
        var r, i = y(t) && "$"in t;
        return e === !0 ? e = V : S(e) || (e = function (t, e) {
    ...
    function fr(t) {
        ...
        return function (t, n, r) {
            return m(n) && (n = e.CURRENCY_SYM), m(r) && (r = e.PATTERNS[1].maxFrac), null == t ? t : hr(t, e.PATTERNS[1], e.GROUP_SEP, e.DECIMAL_SEP, r).replace(/\u00A4/g, n)
        }
    }
    ...
    function hr(t, e, n, r, i) {
        ...
        if (c)i > 0 && 1 > t && (s = t.toFixed(i), t = parseFloat(s)); else {
            var f = (a.split(ko)[1] || "").length;
            m(i) && (i = Math.min(Math.max(e.minFrac, f), e.maxFrac)), t = +(Math.round(+(t.toString() + "e" + i)).toString() + "e" + -i);
            var p = ("" + t).split(ko), h = p[0];
            p = p[1] || "";
            var d, v = 0, $ = e.lgSize, g = e.gSize;
            if (h.length >= $ + g)for (v = h.length - $, d = 0; v > d; d++)(v - d) % g === 0 && 0 !== d && (s += n), s += h.charAt(d);
            for (d = v; d < h.length; d++)(h.length - d) % $ === 0 && 0 !== d && (s += n), s += h.charAt(d);
            for (; p.length < i;)p += "0";
    ...
    function vr(t, e, n, r) {
        return n = n || 0, function (i) {
            var o = i["get" + t]();
            return (n > 0 || o > -n) && (o += n), 0 === o && -12 == n && (o = 12), dr(o, e, r)
        }
    }
    ...
    function mr(t) {
        ...
        return n += dr(Math[e > 0 ? "floor" : "ceil"](e / 60), 2) + dr(Math.abs(e % 60), 2)
    }
    ...
    function Cr(t) {
        ...
        return function (n, r, i) {
            var a, s, u = "", c = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, b(n) && (n = To.test(n) ? p(n) : e(n)), w(n) && (n = new Date(n)), !x(n))return n;
            for (; r;)s = Ao.exec(r), s ? (c = P(c, s, 1), r = c.pop()) : (c.push(r), r = null);
            return i && "UTC" === i && (n = new Date(n.getTime()), n.setMinutes(n.getMinutes() + n.getTimezoneOffset())), o(c, function (e) {
                a = Eo[e], u += a ? a(n, t.DATETIME_FORMATS) : e.replace(/(^'|'$)/g, "").replace(/''/g, "'")
            }), u
        }
    }
    ...
    function Er() {
        return function (t, e) {
            return w(t) && (t = t.toString()), pi(t) || b(t) ? (e = 1 / 0 === Math.abs(Number(e)) ? Number(e) : p(e), e ? e > 0 ? t.slice(0, e) : t.slice(e) : b(t) ? "" : []) : t
        }
    }
    ...
    function Tr(t) {
        return S(t) && (t = {link: t}), t.restrict = t.restrict || "AC", $(t)
    }
    ...
    function Mr(t, e, r, i, a) {
        var s = this, u = [], c = s.$$parentForm = t.parent().controller("form") || Do;
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, c.$addControl(s), s.$rollbackViewValue = function () {
            ...
            i.removeClass(t, va), i.addClass(t, $a), s.$dirty = !0, s.$pristine = !1, c.$setDirty()
        }, s.$setPristine = function () {
            i.setClass(t, va, $a + " " + Io), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(u, function (t) {
                t.$setPristine()
            })
            ...
            i.addClass(t, Io), s.$submitted = !0, c.$setSubmitted()
        }
    }
    ...
    function Dr(t, e, n, r, i, o) {
        ...
        var u = function (t) {
            if (c && (o.defer.cancel(c), c = null), !s) {
                ...
                "password" === a || n.ngTrim && "false" === n.ngTrim || (i = hi(i)), (r.$viewValue !== i || "" === i && r.$$hasNativeValidators) && r.$setViewValue(i, u)
            }
        };
    ...
    function _r(t, e, r, i) {
        return function (o, a, s, u, c, l, f) {
            ...
            Rr(o, a, s, u), Dr(o, a, s, u, c, l);
            var d, v = u && u.$options && u.$options.timezone;
            if (u.$$parserName = t, u.$parsers.push(function (t) {
                    if (u.$isEmpty(t))return null;
                    if (e.test(t)) {
                        var i = r(t, d);
                        return "UTC" === v && i.setMinutes(i.getMinutes() - i.getTimezoneOffset()), i
                    }
                    return n
                }), u.$formatters.push(function (t) {
                    if (t && !x(t))throw ba("datefmt", "Expected `{0}` to be a date", t);
                    if (p(t)) {
                        if (d = t, d && "UTC" === v) {
    ...
    function Vr(t, e, r, i, o, a) {
        if (Rr(t, e, r, i), Dr(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function (t) {
                return i.$isEmpty(t) ? null : Lo.test(t) ? parseFloat(t) : n
            }), i.$formatters.push(function (t) {
                if (!i.$isEmpty(t)) {
                    if (!w(t))throw ba("numfmt", "Expected `{0}` to be a number", t);
                    t = t.toString()
                }
                return t
            }), g(r.min) || r.ngMin) {
    ...
    function Pr(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), jr(r), r.$$parserName = "url", r.$validators.url = function (t, e) {
            var n = t || e;
    ...
    function qr(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), jr(r), r.$$parserName = "email", r.$validators.email = function (t, e) {
            var n = t || e;
    ...
    function zr(t) {
        function e(t, e, u) {
            e === n ? r("$pending", t, u) : i("$pending", t, u), M(e) ? e ? (f(s.$error, t, u), l(s.$$success, t, u)) : (l(s.$error, t, u), f(s.$$success, t, u)) : (f(s.$error, t, u), f(s.$$success, t, u)), s.$pending ? (o(ya, !0), s.$valid = s.$invalid = n, a("", null)) : (o(ya, !1), s.$valid = Wr(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
            var c;
    ...
    var Gr = /^\/(.+)\/([a-z]*)$/, Yr = "validity", Xr = function (t) {
        return b(t) ? t.toLowerCase() : t
    }, Kr = Object.prototype.hasOwnProperty, Jr = function (t) {
    ...
    "i" !== "I".toLowerCase() && (Xr = Zr, Jr = Qr);
    var ti, ei, ni, ri, ii = [].slice, oi = [].splice, ai = [].push, si = Object.prototype.toString, ui = r("ng"), ci = t.angular || (t.angular = {}), li = 0;
    ti = e.documentMode, d.$inject = [], v.$inject = [];
    var fi, pi = Array.isArray, hi = function (t) {
        return b(t) ? t.trim() : t
    }, di = function (t) {
        return t.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08")
    }, vi = function () {
        if (g(vi.isActive_))return vi.isActive_;
        ...
        return vi.isActive_ = t
    }, $i = ["ng-", "data-ng-", "ng:", "x-ng-"], mi = /[A-Z]/g, gi = !1, yi = 1, bi = 3, wi = 8, xi = 9, Si = 11, Ci = {
        full: "1.3.15",
        major: 1,
        minor: 3,
        dot: 15,
    ...
    be.expando = "ng339";
    var ki = be.cache = {}, Ei = 1, Ai = function (t, e, n) {
    ...
    var Oi = /([\:\-\_]+(.))/g, Mi = /^moz([A-Z])/, ji = {
        mouseleave: "mouseout",
        mouseenter: "mouseover"
    }, Ni = r("jqLite"), Di = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Ii = /<|&#?\w+;/, Fi = /<([\w:]+)/, _i = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ri = {
    ...
    o({data: Ee, removeData: Ce}, function (t, e) {
        be[e] = t
    }), o({
        data: Ee, inheritedData: Ne, scope: function (t) {
            return ei.data(t, "$scope") || Ne(t.parentNode || t, ["$isolateScope", "$scope"])
        }, isolateScope: function (t) {
            return ei.data(t, "$isolateScope") || ei.data(t, "$isolateScopeNoTemplate")
        }, controller: je, injector: function (t) {
            return Ne(t, "$injector")
        }, removeAttr: function (t, e) {
            t.removeAttribute(e)
        }, hasClass: Ae, css: function (t, e, n) {
            return e = ve(e), g(n) ? (t.style[e] = n, void 0) : t.style[e]
        }, attr: function (t, e, r) {
            var i = Xr(e);
            if (Pi[i]) {
            ...
            return m(e) ? t.innerHTML : (xe(t, !0), t.innerHTML = e, void 0)
        }, empty: De
    }, function (t, e) {
        be.prototype[e] = function (e, r) {
            var i, o, a = this.length;
            if (t !== De && (2 == t.length && t !== Ae && t !== je ? e : r) === n) {
                if (y(e)) {
        ...
        removeData: Ce, on: function Ga(t, e, n, r) {
            ...
            var r, i, a, s = e.type || e, u = ke(t), c = u && u.events, l = c && c[s];
            l && (r = {
                preventDefault: function () {
                ...
                }, stopPropagation: d, type: s, target: t
        ...
        be.prototype[e] = function (e, n, r) {
            for (var i, o = 0, a = this.length; a > o; o++)m(i) ? (i = t(this[o], e, n, r), g(i) && (i = ei(i))) : Me(i, t(this[o], e, n, r));
            return g(i) ? i : this
        }, be.prototype.bind = be.prototype.on, be.prototype.unbind = be.prototype.off
    }), Le.prototype = {
        put: function (t, e) {
            this[qe(t, this.nextUid)] = e
        }, get: function (t) {
            return this[qe(t, this.nextUid)]
        }, remove: function (t) {
            var e = this[t = qe(t, this.nextUid)];
            return delete this[t], e
        }
    };
    var Ui = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Bi = /,/, Hi = /^\s*(_?)(\S+?)\1\s*$/, zi = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Wi = r("$injector");
    He.$$annotate = Be;
    var Gi = r("$animate"), Yi = ["$provide", function (t) {
        this.$$selectors = {}, this.register = function (e, n) {
            var r = e + "-animation";
            if (e && "." != e.charAt(0))throw Gi("notcsel", "Expecting class selector starting with '.' got '{0}'.", e);
            ...
            return {
                animate: function (t, e, n) {
                    ...
                    return t = ei(t), e = b(e) ? e : pi(e) ? e.join(" ") : "", o(t, function (t) {
                        Oe(t, e)
                    }), u(t, n), s()
    ...
    var Ki = /^((?:x|data)[\:\-_])/i, Ji = r("$controller"), Zi = "application/json", Qi = {"Content-Type": Zi + ";charset=utf-8"}, to = /^\[|^\{(?!\{)/, eo = {
        "[": /]$/,
        "{": /}$/
        ...
        }, protocol: On("$$protocol"), host: On("$$host"), port: On("$$port"), path: Mn("$$path", function (t) {
    ...
    o([Tn, An, En], function (t) {
        t.prototype = Object.create(so), t.prototype.state = function (e) {
            if (!arguments.length)return this.$$state;
            if (t !== En || !this.$$html5)throw ao("nostate", "History API state support is available only in HTML5 mode and only in browsers supporting HTML5 History API");
            return this.$$state = m(e) ? null : e, this
        }
    });
    var uo = r("$parse"), co = Function.prototype.call, lo = Function.prototype.apply, fo = Function.prototype.bind, po = ce();
    o({
        "null": function () {
            return null
        }, "true": function () {
    ...
    mo.ZERO = f(function () {
        ...
        constructor: mo, parse: function (t) {
            ...
            return f(function (o, a) {
                ...
                return i(s)
            }, {constant: !i.$stateful && o.every(_n), inputs: !i.$stateful && o})
        }, expression: function () {
            ...
            return this.consume("]"), f(function (i, o) {
                ...
                return Dn(u, e), s ? a = In(s[u], e) : n
            }, {
                assign: function (n, i, o) {
                    var a = Dn(r(n, o), e), s = In(t(n, o), e);
            ...
            return function (a, s) {
                ...
                if (o)for (var l = r.length; l--;)o[l] = In(r[l](a, s), i);
                In(u, i), Fn(c, i);
                var f = c.apply ? c.apply(u, o) : c(o[0], o[1], o[2], o[3], o[4]);
                return o && (o.length = 0), In(f, i)
            }
            ...
            return this.consume("]"), f(function (e, n) {
                ...
                return r
            }, {literal: !0, constant: t.every(_n), inputs: t})
        }, object: function () {
            var t = [], e = [];
            if ("}" !== this.peekToken().text)do {
                if (this.peek("}"))break;
            ...
            return this.consume("}"), f(function (n, r) {
                ...
                return i
            }, {literal: !0, constant: e.every(_n), inputs: e})
        }
    };
    var go = ce(), yo = ce(), bo = Object.prototype.valueOf, wo = r("$sce"), xo = {
        HTML: "html",
        CSS: "css",
        URL: "url",
        RESOURCE_URL: "resourceUrl",
        JS: "js"
    }, Xi = r("$compile"), So = e.createElement("a"), Co = ir(t.location.href);
    sr.$inject = ["$provide"], fr.$inject = ["$locale"], pr.$inject = ["$locale"];
    var ko = ".", Eo = {
        yyyy: vr("FullYear", 4),
        yy: vr("FullYear", 2, 0, !0),
        y: vr("FullYear", 1),
        MMMM: $r("Month"),
        MMM: $r("Month", !0),
        MM: vr("Month", 2, 1),
    ...
    var Fo = function (t) {
        return ["$timeout", function (e) {
            var r = {
                name: "form", restrict: t ? "EAC" : "E", controller: Mr, compile: function (r, i) {
                    ...
                    return {
                        pre: function (t, r, i, a) {
                            ...
                            o && (Rn(t, null, a.$name, a, a.$name), i.$observe(o, function (e) {
                                ...
                                u.$removeControl(a), o && Rn(t, null, i[o], n, a.$name), f(a, Do)
                            })
                        }
                    }
                }
    ...
    }, _o = Fo(), Ro = Fo(!0), Vo = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Po = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, qo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Lo = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Uo = /^(\d{4})-(\d{2})-(\d{2})$/, Bo = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Ho = /^(\d{4})-W(\d\d)$/, zo = /^(\d{4})-(\d\d)$/, Wo = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Go = {
        text: Nr,
        date: _r("date", Uo, Fr(Uo, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
        "datetime-local": _r("datetimelocal", Bo, Fr(Bo, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
        time: _r("time", Wo, Fr(Wo, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        week: _r("week", Ho, Ir, "yyyy-Www"),
        month: _r("month", zo, Fr(zo, ["yyyy", "MM"]), "yyyy-MM"),
        number: Vr,
        url: Pr,
        email: qr,
        radio: Lr,
        ...
        return {
            restrict: "E", require: ["?ngModel"], link: {
                pre: function (i, o, a, s) {
                    s[0] && (Go[Xr(a.type)] || Go.text)(i, o, a, s[0], e, t, n, r)
                }
            }
        }
    }], Xo = /^(true|false|\d+)$/, Ko = function () {
        return {
    ...
    }), ea = Hr("", !0), na = Hr("Odd", 0), ra = Hr("Even", 1), ia = Tr({
    ...
    var ua = ["$animate", function (t) {
        ...
        return {
            restrict: "ECA", priority: -400, require: "ngInclude", link: function (n, r, i, o) {
                return /SVG/.test(r[0].toString()) ? (r.empty(), t(ge(o.template, e).childNodes)(n, function (t) {
                    r.append(t)
                }, {futureParentElement: r}), void 0) : (r.html(o.template), t(r.contents())(n), void 0)
            }
        }
    }], fa = Tr({
        ...
        return {
            restrict: "A", priority: 100, require: "ngModel", link: function (t, e, r, i) {
                var a = e.attr(r.$attr.ngList) || ", ", s = "false" !== r.ngTrim, u = s ? hi(a) : a, c = function (t) {
                    if (!m(t)) {
                        var e = [];
    ...
    }, ha = "ng-valid", da = "ng-invalid", va = "ng-pristine", $a = "ng-dirty", ma = "ng-untouched", ga = "ng-touched", ya = "ng-pending", ba = new r("ngModel"), wa = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (t, e, r, i, a, s, u, c, l, f) {
        this.$viewValue = Number.NaN, this.$modelValue = Number.NaN, this.$$rawModelValue = n, this.$validators = {}, this.$asyncValidators = {}, this.$parsers = [], this.$formatters = [], this.$viewChangeListeners = [], this.$untouched = !0, this.$touched = !1, this.$pristine = !0, this.$dirty = !1, this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, this.$pending = n, this.$name = f(r.name || "", !1)(t);
        var p, h = a(r.ngModel), v = h.assign, $ = h, y = v, b = null, x = this;
        this.$$setOptions = function (t) {
            if (x.$options = t, t && t.getterSetter) {
                ...
                $ = function (t) {
                    ...
                    S(h(t)) ? n(t, {$$$p: x.$modelValue}) : v(t, x.$modelValue)
                }
            } else if (!h.assign)throw ba("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, z(i))
        }, this.$render = d, this.$isEmpty = function (t) {
            return m(t) || "" === t || null === t || t !== t
        };
        var C = i.inheritedData("$formController") || Do, k = 0;
        zr({
            ...
            x.$dirty = !1, x.$pristine = !0, s.removeClass(i, $a), s.addClass(i, va)
        }, this.$setDirty = function () {
            x.$dirty = !0, x.$pristine = !1, s.removeClass(i, va), s.addClass(i, $a), C.$setDirty()
            ...
            function s() {
                ...
                o(x.$asyncValidators, function (o, a) {
                    var s = o(t, e);
                    if (!j(s))throw ba("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
            ...
            if (p = m(i) ? n : !0)for (var o = 0; o < x.$parsers.length; o++)if (i = x.$parsers[o](i), m(i)) {
                p = !1;
                break
            }
            w(x.$modelValue) && isNaN(x.$modelValue) && (x.$modelValue = $(t));
            ...
            i && g(i.debounce) && (n = i.debounce, w(n) ? r = n : w(n[e]) ? r = n[e] : w(n["default"]) && (r = n["default"])), u.cancel(b), r ? b = u(function () {
                x.$commitViewValue()
            ...
            if (e !== x.$modelValue) {
                ...
                x.$viewValue !== o && (x.$viewValue = x.$$lastCommittedViewValue = o, x.$render(), x.$$runValidators(e, o, d))
            }
            return e
        })
        ...
        return {
            ...
            priority: 1,
            compile: function (e) {
                return e.addClass(va).addClass(ma).addClass(ha), {
    ...
    }], Sa = /(\s+|^)default(\s+|$)/, Ca = function () {
        return {
            restrict: "A", controller: ["$scope", "$attrs", function (t, e) {
                var r = this;
                this.$options = t.$eval(e.ngModelOptions), this.$options.updateOn !== n ? (this.$options.updateOnDefault = !1, this.$options.updateOn = hi(this.$options.updateOn.replace(Sa, function () {
                    return r.$options.updateOnDefault = !0, " "
                }))) : this.$options.updateOnDefault = !0
            }]
        }
    }, ka = Tr({terminal: !0, priority: 1e3}), Ea = ["$locale", "$interpolate", function (t, e) {
        ...
        return {
            restrict: "EA", link: function (i, a, s) {
                ...
                var c, l = s.count, f = s.$attr.when && a.attr(s.$attr.when), p = s.offset || 0, h = i.$eval(f) || {}, d = {}, v = e.startSymbol(), $ = e.endSymbol(), m = v + l + "-" + p + $, g = ci.noop;
                o(s, function (t, e) {
                    var n = r.exec(e);
                    if (n) {
                        var i = (n[1] ? "-" : "") + Xr(n[2]);
                    ...
                    r || n in h || (n = t.pluralCat(n - p)), n === c || r && isNaN(c) || (g(), g = i.$watch(d[n], u), c = n)
                })
            }
        }
        ...
        return {
            ...
            compile: function (r, p) {
                var h = p.ngRepeat, d = e.createComment(" end ngRepeat: " + h + " "), v = h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
                if (!v)throw u("iexp", "Expected expression in form of '_item_ in _collection_[ track by _id_]' but got '{0}'.", h);
                var $ = v[1], m = v[2], g = v[3], y = v[4];
                if (v = $.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/), !v)throw u("iidexp", "'_item_' in '_item_ in _collection_' should be an identifier or '(_key_, _value_)' expression, but got '{0}'.", $);
                var b = v[3] || v[1], w = v[2];
                ...
                return y ? x = t(y) : (C = function (t, e) {
                    ...
                    t.$watchCollection(m, function (r) {
                        var p, m, y, x, E, A, T, O, M, j, N, D, I = e[0], F = ce();
                        if (g && (t[g] = r), i(r))M = r, O = S || C; else {
                            O = S || k, M = [];
                            for (var _ in r)r.hasOwnProperty(_) && "$" != _.charAt(0) && M.push(_);
                            M.sort()
                        }
                        for (x = M.length, N = new Array(x), p = 0; x > p; p++)if (E = r === M ? p : M[p], A = r[E], T = O(E, A, p), $[T])j = $[T], delete $[T], F[T] = j, N[p] = j; else {
                            if (F[T])throw o(N, function (t) {
                                t && t.scope && ($[t.id] = t)
                            }), u("dupes", "Duplicates in a repeater are not allowed. Use 'track by' expression to specify unique keys. Repeater: {0}, Duplicate key: {1}, Duplicate value: {2}", h, T, A);
                            N[p] = {id: T, scope: n, clone: n}, F[T] = !0
                        }
                        for (var R in $) {
                            if (j = $[R], D = ue(j.clone), a.leave(D), D[0].parentNode)for (p = 0, m = D.length; m > p; p++)D[p][s] = !0;
                            j.scope.$destroy()
                        }
                        for (p = 0; x > p; p++)if (E = r === M ? p : M[p], A = r[E], j = N[p], j.scope) {
                            y = I;
                            do y = y.nextSibling; while (y && y[s]);
                            l(j) != y && a.move(ue(j.clone), null, ei(I)), I = f(j), c(j.scope, p, b, A, w, E, x)
                        } else v(function (t, e) {
                            j.scope = e;
                            var n = d.cloneNode(!1);
                            t[t.length++] = n, a.enter(t, null, ei(I)), I = n, j.clone = t, F[j.id] = j, c(j.scope, p, b, A, w, E, x)
                        });
                        $ = F
                    })
                }
    ...
    }], Ta = "ng-hide", Oa = "ng-hide-animate", Ma = ["$animate", function (t) {
        return {
    ...
    }], Va = r("ngOptions"), Pa = $({restrict: "A", terminal: !0}), qa = ["$compile", "$parse", function (t, r) {
            ...
            link: function (s, u, c, l) {
                ...
                function p(t, e, n) {
                    ...
                    n.$render = function () {
                        ...
                        V(r, n.$viewValue) || (r = R(n.$viewValue), n.$render())
                    }), e.on("change", function () {
                        t.$apply(function () {
                            var t = [];
                            o(e.find("option"), function (e) {
                ...
                function h(e, s, u) {
                    ...
                    function l() {
                        e.$apply(function () {
                            ...
                            if (y)t = [], o(s.val(), function (e) {
                                e = F ? _[e] : e, t.push(f(e, n[e]))
                            }); else {
                                var r = F ? _[s.val()] : s.val();
                                t = f(r, n[r])
                            }
                            u.$setViewValue(t), m()
                        })
                    ...
                    function p() {
                        ...
                        if (n && pi(n)) {
                            ...
                            for (var r = 0, i = n.length; i > r; r++)t[r] = c(E, r, n[r]);
                            return t
                        }
                        if (n) {
                            t = {};
                    ...
                    function h(t) {
                        ...
                        if (y)if (F && pi(t)) {
                            e = new Le([]);
                            for (var n = 0; n < t.length; n++)e.put(c(F, null, t[n]), !0)
                        } else e = new Le(t); else F && (t = c(F, null, t));
                        return function (n, r) {
                            var i;
                            return i = F ? F : O ? O : N, y ? g(e.remove(c(i, n, r))) : t === c(i, n, r)
                        }
                    }
                    ...
                    function m() {
                        x = !1;
                        var t, n, r, i, l, f, p, d, m, b, k, A, T, O, N, I, P, q = {"": []}, L = [""], U = u.$viewValue, B = D(e) || [], H = M ? a(B) : B, z = {}, W = h(U), G = !1;
                        for (_ = {}, A = 0; b = H.length, b > A; A++)p = A, M && (p = H[A], "$" === p.charAt(0)) || (d = B[p], t = c(j, p, d) || "", (n = q[t]) || (n = q[t] = [], L.push(t)), T = W(p, d), G = G || T, I = c(E, p, d), I = g(I) ? I : "", P = F ? F(e, V) : M ? H[A] : A, F && (_[P] = p), n.push({
                            id: P,
                            label: I,
                            selected: T
                        }));
                        for (y || (w || null === U ? q[""].unshift({
                            id: "",
                            label: "",
                            selected: !G
                        }) : G || q[""].unshift({id: "?", label: "", selected: !0})), k = 0, m = L.length; m > k; k++) {
                            for (t = L[k], n = q[t], R.length <= k ? (i = {
                                element: C.clone().attr("label", t),
                                label: n.label
                            }, l = [i], R.push(l), s.append(i.element)) : (l = R[k], i = l[0], i.label != t && i.element.attr("label", i.label = t)), O = null, A = 0, b = n.length; b > A; A++)r = n[A], (f = l[A + 1]) ? (O = f.element, f.label !== r.label && ($(z, f.label, !1), $(z, r.label, !0), O.text(f.label = r.label), O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), ti && O.prop("selected", f.selected))) : ("" === r.id && w ? N = w : (N = S.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {
                                element: N,
                                label: r.label,
                                id: r.id,
                                selected: r.selected
                            }), $(z, r.label, !0), O ? O.after(N) : i.element.append(N), O = N);
                            for (A++; l.length > A;)r = l.pop(), $(z, r.label, !1), r.element.remove()
                        }
                        for (; R.length > k;) {
                            for (n = R.pop(), A = 1; A < n.length; ++A)$(z, n[A].label, !1);
                            n[0].element.remove()
                        }
                        o(z, function (t, e) {
                            t > 0 ? v.addOption(e) : 0 > t && v.removeOption(e)
                        })
                    }

                    var k;
                    if (!(k = b.match(i)))throw Va("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, z(s));
                    var E = r(k[2] || k[1]), A = k[4] || k[6], T = / as /.test(k[0]) && k[1], O = T ? r(T) : null, M = k[5], j = r(k[3] || ""), N = r(k[2] ? k[1] : A), D = r(k[7]), I = k[8], F = I ? r(k[8]) : null, _ = {}, R = [[{
                        element: s,
                        label: ""
                    }]], V = {};
                    w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), s.empty(), s.on("change", l), u.$render = m, e.$watchCollection(D, d), e.$watchCollection(p, d), y && e.$watchCollection(function () {
                        return u.$modelValue
                    }, d)
                }

                if (l[1]) {
                    for (var d, v = l[0], $ = l[1], y = c.multiple, b = c.ngOptions, w = !1, x = !1, S = ei(e.createElement("option")), C = ei(e.createElement("optgroup")), k = S.clone(), E = 0, A = u.children(), T = A.length; T > E; E++)if ("" === A[E].value) {
                        d = w = A.eq(E);
                        break
                    }
                    v.init($, w, k), y && ($.$isEmpty = function (t) {
                        return !t || 0 === t.length
                    }), b ? h(s, u, $) : y ? p(s, u, $) : f(s, u, $, v)
                }
            }
        }
    ...
    }], Ua = $({restrict: "E", terminal: !1}), Ba = function () {
        return {
            restrict: "A", require: "?ngModel", link: function (t, e, n, r) {
    ...
    return t.angular.bootstrap ? (console.log("WARNING: Tried to load angular more than once."), void 0) : (re(), he(ci), ei(e).ready(function () {
        Z(e, Q)
    }), void 0)
    ...
    function n() {
        ...
        this.when = function (t, i) {
        ...
        }, this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function (n, i, o, a, u, c, l) {
            function f(t, e) {
                var n = e.keys, r = {};
            ...
            function p(t) {
                var r = y.current;
                $ = d(), m = $ && r && $.$$route === r.$$route && e.equals($.pathParams, r.pathParams) && !$.reloadOnSearch && !g, m || !r && !$ || n.$broadcast("$routeChangeStart", $, r).defaultPrevented && t && t.preventDefault()
            }

            function h() {
                var t = y.current, r = $;
                m ? (t.params = r.params, e.copy(t.params, o), n.$broadcast("$routeUpdate", t)) : (r || t) && (g = !1, y.current = r, r && r.redirectTo && (e.isString(r.redirectTo) ? i.path(v(r.redirectTo, r.params)).search(r.params).replace() : i.url(r.redirectTo(r.pathParams, i.path(), i.search())).replace()), a.when(r).then(function () {
                    if (r) {
                        var t, n, i = e.extend({}, r.resolve);
                        return e.forEach(i, function (t, n) {
                            i[n] = e.isString(t) ? u.get(t) : u.invoke(t, null, null, n)
                        }), e.isDefined(t = r.template) ? e.isFunction(t) && (t = t(r.params)) : e.isDefined(n = r.templateUrl) && (e.isFunction(n) && (n = n(r.params)), n = l.getTrustedResourceUrl(n), e.isDefined(n) && (r.loadedTemplateUrl = n, t = c(n))), e.isDefined(t) && (i.$template = t), a.all(i)
                    }
                }).then(function (i) {
            ...
            var $, m, g = !1, y = {
                routes: r, reload: function () {
                    ...
                    t = e.extend({}, this.current.params, t), i.path(v(this.current.$$route.originalPath, t)), i.search(t)
                }
            };
        ...
        return {
            restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function (i, o, a, s, u) {
                ...
                function l() {
                    ...
                    if (e.isDefined(s)) {
                        var l = i.$new(), h = t.current, $ = u(l, function (t) {
                            r.enter(t, null, p || o).then(function () {
                                !e.isDefined(d) || d && !i.$eval(d) || n()
                            }), c()
                        });
                        p = $, f = h.scope = l, f.$emit("$viewContentLoaded"), f.$eval(v)
                    } else c()
                }
...
FastClick.prototype.needsClick = function (t) {
    ...
    if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, n = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (o = t.changedTouches[0], a = document.elementFromPoint(o.pageX - window.pageXOffset, o.pageY - window.pageYOffset) || a, a.fastClickScrollParent = this.targetElement.fastClickScrollParent), r = a.tagName.toLowerCase(), "label" === r) {
        if (e = this.findControl(a)) {
            if (this.focus(a), deviceIsAndroid)return !1;
            a = e
        }
    } else if (this.needsFocus(a))return t.timeStamp - n > 100 || deviceIsIOS && window.top !== window && "input" === r ? (this.targetElement = null, !1) : (this.focus(a), this.sendClick(a, t), deviceIsIOS && "select" === r || (this.targetElement = null, t.preventDefault()), !1);
    return deviceIsIOS && !deviceIsIOS4 && (i = a.fastClickScrollParent, i && i.fastClickLastScrollTop !== i.scrollTop) ? !0 : (this.needsClick(a) || (t.preventDefault(), this.sendClick(a, t)), !1)
    ...
    if (deviceIsBlackBerry10 && (r = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), r[1] >= 10 && r[2] >= 3 && (e = document.querySelector("meta[name=viewport]")))) {
        if (-1 !== e.content.indexOf("user-scalable=no"))return !0;
    ...
    "use strict";
    angular.module("mobile-angular-ui.core.activeLinks", []).run(["$rootScope", "$window", "$document", "$location", function (t, e, n, r) {
        var i = function () {
            var t, i = r.url(), o = i.indexOf("#"), a = i.indexOf("?"), s = e.location.href, u = s.indexOf(i);
            -1 === o && -1 === a ? t = s : -1 != o && o > a ? t = s.slice(0, u + o) : -1 != a && a > o && (t = s.slice(0, u + a));
            for (var c = n[0].links, l = 0; l < c.length; l++) {
                var f = c[l], p = angular.element(f);
                f.href === t ? p.addClass("active") : f.href && f.href.length && p.removeClass("active")
            }
        };
        t.$on("$locationChangeSuccess", i), t.$on("$includeContentLoaded", i)
    }])
}(), function () {
    "use strict";
    angular.module("mobile-angular-ui.core.capture", []).run(["Capture", "$rootScope", function (t, e) {
        ...
        return {
            resetAll: function () {
                for (var t in e)this.resetYielder(t)
            }, resetYielder: function (t) {
                var n = e[t];
                this.setContentFor(t, n.defaultContent, n.defaultScope)
            }, putYielder: function (t, n, r, i) {
                var o = {};
                o.name = t, o.element = n, o.defaultContent = i || "", o.defaultScope = r, e[t] = o
            }, getYielder: function (t) {
                return e[t]
            }, removeYielder: function (t) {
                delete e[t]
            }, setContentFor: function (n, r, i) {
                var o = e[n];
                o && (o.element.html(r), t(o.element.contents())(i))
            }
        }
        ...
        return {
            compile: function (e, n) {
                var r = e.html();
                return (null === n.uiDuplicate || void 0 === n.uiDuplicate) && (e.html(""), e.remove()), function (e, n, i) {
                    t.setContentFor(i.uiContentFor, r, e)
                }
            }
        }
        ...
        return {
            link: function (t, n, r) {
                e.putYielder(r.uiYieldTo, n, t, n.html()), n.on("$destroy", function () {
                    e.removeYielder(r.uiYieldTo)
                }), t.$on("$destroy", function () {
                    e.removeYielder(r.uiYieldTo)
                })
            }
    ...
    t.run(["$window", "$document", function (t, e) {
        t.addEventListener("load", function () {
            FastClick.attach(e[0].body)
        }, !1)
    ...
    angular.module("mobile-angular-ui.core.outerClick", []).factory("bindOuterClick", ["$document", "$timeout", function (e, n) {
        return function (r, i, o, a) {
            var s = function (e) {
                t(angular.element(e.target), i) || r.$apply(function () {
                    o(r, {$event: e})
                })
            }, u = angular.noop, c = null;
            a ? u = r.$watch(a, function (t) {
                n.cancel(c), t ? c = n(function () {
                    e.on("click tap", s)
                }, 0) : e.unbind("click tap", s)
            }) : (n.cancel(c), e.on("click tap", s)), r.$on("$destroy", function () {
                u(), e.unbind("click tap", s)
            })
        }
    }]).directive("uiOuterClick", ["bindOuterClick", "$parse", function (t, e) {
        return {
            restrict: "A", compile: function (n, r) {
                var i = e(r.uiOuterClick), o = r.uiOuterClickIf;
                return function (e, n) {
                    t(e, n, i, o)
                }
            }
    ...
    t.factory("SharedState", ["$rootScope", "$parse", function (t) {
        var e = {}, n = {}, r = {}, i = {};
        return {
            initialize: function (o, a, s) {
                s = s || {};
                var u = void 0 === r[o], c = s.defaultValue, l = s.exclusionGroup;
                r[o.$id] = r[o.$id] || [], r[o.$id].push(a), n[a] ? u && n[a].references++ : (n[a] = angular.extend({}, s, {references: 1}), t.$broadcast("mobile-angular-ui.state.initialized." + a, c), void 0 !== c && this.setOne(a, c), l && (i[l] = i[l] || {}, i[l][a] = !0)), o.$on("$destroy", function () {
                    for (var s = r[o.$id] || [], u = 0; u < s.length; u++) {
                        var c = n[s[u]];
                        c.exclusionGroup && (delete i[c.exclusionGroup][s[u]], 0 === Object.keys(i[c.exclusionGroup]).length && delete i[c.exclusionGroup]), c.references--, c.references <= 0 && (delete n[s[u]], delete e[s[u]], t.$broadcast("mobile-angular-ui.state.destroyed." + a))
                    }
                    delete r[o.$id]
                })
            }, setOne: function (r, i) {
                if (void 0 !== n[r]) {
                    var o = e[r];
                    return e[r] = i, o != i && t.$broadcast("mobile-angular-ui.state.changed." + r, i, o), i
                }
                console && console.warn("Warning: Attempt to set uninitialized shared state:", r)
            }, setMany: function (t) {
                ...
                if (e)for (var r = Object.keys(i[e]), o = 0; o < r.length; o++) {
                    var a = r[o];
                    a != t && this.turnOff(a)
                }
                ...
                var e = n[t];
                return void 0 === e ? void 0 : e.references
            }, equals: function (t, e) {
                return this.get(t) === e
            }, eq: function (t, e) {
    ...
    t.directive("uiState", ["SharedState", "$parse", function (t) {
        return {
            restrict: "EA", priority: 601, link: function (e, n, r) {
                var i = r.uiState || r.id, o = r.uiDefault || r["default"], a = o ? e.$eval(o) : void 0;
                t.initialize(e, i, {defaultValue: a, exclusionGroup: r.uiExclusionGroup})
            }
        }
    }]), angular.forEach(["toggle", "turnOn", "turnOff", "set"], function (n) {
        var r = "ui" + n[0].toUpperCase() + n.slice(1);
        t.directive(r, ["$parse", "SharedState", function (t, i) {
            var o = i[n];
            return {
                restrict: "A", priority: 1, compile: function (a, s) {
                    var u = "set" === n ? t(s[r]) : function () {
                        return s[r]
                    };
                    return function (t, n, r) {
                        var a = function () {
    ...
    var n = function (t) {
        if (!t || "" === t)return [];
        for (var e = t ? t.trim().split(/ *, */) : [], n = [], r = 0; r < e.length; r++) {
            var i = e[r].split(/ *as */);
            if (i.length > 2 || i.length < 1)throw new Error('Error parsing uiScopeContext="' + t + '"');
            n.push(i)
        }
        return n
    }, r = function (t, e, n) {
        for (var r = 0; r < e.length; r++) {
            var i = e[r][0], o = e[r][1] || i;
            t[o] = n[i]
        }
    }, i = function (t, e, i, o, a) {
        var s = a(e[t]), u = n(e.uiScopeContext);
        return function () {
            var t;
            return u.length ? (t = angular.extend({}, o.values()), r(t, u, i)) : t = o.values(), s(t)
        }
    };
    t.directive("uiIf", ["$animate", "SharedState", "$parse", function (t, e, n) {
        function r(t) {
            var e = t[0], n = t[t.length - 1], r = [e];
            do {
                if (e = e.nextSibling, !e)break;
        ...
        return {
            ...
            link: function (o, a, s, u, c) {
                var l, f, p, h = i("uiIf", s, o, e, n);
                o.$watch(h, function (e) {
                    if (e)f || c(function (e, n) {
                        f = n, e[e.length++] = document.createComment(" end uiIf: " + s.uiIf + " "), l = {clone: e}, t.enter(e, a.parent(), a)
                    }); else if (p && (p.remove(), p = null), f && (f.$destroy(), f = null), l) {
                        p = r(l.clone);
                        var n = function () {
                            p = null
                        }, i = t.leave(p, n);
    ...
    }]), t.directive("uiHide", ["$animate", "SharedState", "$parse", function (t, e, n) {
        var r = "ng-hide", o = "ng-hide-animate";
        return {
            restrict: "A", multiElement: !0, link: function (a, s, u) {
                var c = (n(u.uiHide), i("uiHide", u, a, e, n));
                a.$watch(c, function (e) {
                    t[e ? "addClass" : "removeClass"](s, r, {tempClasses: o})
                })
            }
        }
    }]), t.directive("uiShow", ["$animate", "SharedState", "$parse", function (t, e, n) {
        var r = "ng-hide", o = "ng-hide-animate";
        return {
            restrict: "A", multiElement: !0, link: function (a, s, u) {
                var c = (n(u.uiShow), i("uiShow", u, a, e, n));
                a.$watch(c, function (e) {
                    t[e ? "removeClass" : "addClass"](s, r, {tempClasses: o})
                })
            }
        }
    }]), t.directive("uiClass", ["SharedState", "$parse", function (t, e) {
        return {
            restrict: "A", link: function (n, r, o) {
                var a = (e(o.uiClass), i("uiClass", o, n, t, e));
                n.$watch(a, function (t) {
                    var e = "", n = "";
                    angular.forEach(t, function (t, i) {
                        t ? e += " " + i : n += " " + i, e.length && r.addClass(e), n.length && r.removeClass(n)
                    })
                }, !0)
            }
        }
    ...
    var e = t.document, n = e.documentElement, r = "overthrow-enabled", i = "ontouchmove"in e, o = "WebkitOverflowScrolling"in n.style || "msOverflowStyle"in n.style || !i && t.screen.width > 800 || function () {
            var e = t.navigator.userAgent, n = e.match(/AppleWebKit\/([0-9]+)/), r = n && n[1], i = n && r >= 534;
            return e.match(/Android ([0-9]+)/) && RegExp.$1 >= 3 && i || e.match(/ Version\/([0-9]+)/) && RegExp.$1 >= 0 && t.blackberry && i || e.indexOf("PlayBook") > -1 && i && -1 === !e.indexOf("Android 2") || e.match(/Firefox\/([0-9]+)/) && RegExp.$1 >= 4 || e.match(/wOSBrowser\/([0-9]+)/) && RegExp.$1 >= 233 && i || e.match(/NokiaBrowser\/([0-9\.]+)/) && 7.3 === parseFloat(RegExp.$1) && n && r >= 533
        }();
    t.overthrow = {}, t.overthrow.enabledClassName = r, t.overthrow.addClass = function () {
    ...
    }, t.overthrow.canBeFilledWithPoly = i, t.overthrow.forget = function () {
    ...
    if (e !== n) {
        ...
        var r = t.document, i = r.documentElement, o = "native" === e.support, a = e.canBeFilledWithPoly, s = (e.configure, e.set), u = e.forget, c = e.scrollIndicatorClassName;
        ...
        e.set = function () {
            if (s(), !l && !o && a) {
                t.overthrow.addClass(), l = !0, e.support = "polyfilled", e.forget = function () {
                    u(), l = !1, r.removeEventListener && r.removeEventListener("touchstart", b, !1)
                };
                var c, f, p, h, d = [], v = [], $ = function () {
                    d = [], f = null
                }, m = function () {
                    v = [], p = null
                }, g = function (t) {
                    h = c.querySelectorAll("textarea, input");
                    for (var e = 0, n = h.length; n > e; e++)h[e].style.pointerEvents = t
                }, y = function (t, e) {
                    if (r.createEvent) {
                        var i, o = (!e || e === n) && c.parentNode || c.touchchild || c;
                        o !== c && (i = r.createEvent("HTMLEvents"), i.initEvent("touchend", !0, !0), c.dispatchEvent(i), o.touchchild = c, c = o, o.dispatchEvent(t))
                    }
                }, b = function (t) {
                    if (e.intercept && e.intercept(), $(), m(), c = e.closest(t.target), c && c !== i && !(t.touches.length > 1)) {
                        g("none");
                        var n = t, r = c.scrollTop, o = c.scrollLeft, a = c.offsetHeight, s = c.offsetWidth, u = t.touches[0].pageY, l = t.touches[0].pageX, h = c.scrollHeight, b = c.scrollWidth, w = function (t) {
                            var e = r + u - t.touches[0].pageY, i = o + l - t.touches[0].pageX, g = e >= (d.length ? d[0] : 0), w = i >= (v.length ? v[0] : 0);
                            e > 0 && h - a > e || i > 0 && b - s > i ? t.preventDefault() : y(n), f && g !== f && $(), p && w !== p && m(), f = g, p = w, c.scrollTop = e, c.scrollLeft = i, d.unshift(e), v.unshift(i), d.length > 3 && d.pop(), v.length > 3 && v.pop()
                        }, x = function () {
                            g("auto"), setTimeout(function () {
                                g("none")
                            }, 450), c.removeEventListener("touchmove", w, !1), c.removeEventListener("touchend", x, !1)
                        };
                        c.addEventListener("touchmove", w, !1), c.addEventListener("touchend", x, !1)
                    }
                };
                r.addEventListener("touchstart", b, !1)
            }
        }
    }
    ...
    }]).directive("modalOverlay", ["$rootElement", function (t) {
        return {
            restrict: "C", link: function (e, n) {
                t.addClass("has-modal-overlay"), n.on("$destroy", function () {
    ...
    "use strict";
    var t = angular.module("mobile-angular-ui.components.scrollable", []);
    t.directive("scrollableContent", function () {
        return {
            restrict: "C", controller: ["$element", function (t) {
                var e = t[0], n = t.parent()[0];
                this.scrollableContent = e, this.scrollTo = function (t, r) {
                    if (r = r || 0, angular.isNumber(t))e.scrollTop = t - r; else {
                        var i = angular.element(t)[0];
                        i.offsetParent && i.offsetParent != n ? this.scrollTo(i.offsetParent, r - i.offsetTop) : e.scrollTop = i.offsetTop - r
                    }
                }
            }], link: function (t, e) {
        ...
        t.directive(e, ["$rootScope", "$timeout", function (t, e) {
            return {
                require: "?^^scrollableContent", link: function (t, n, r, i) {
                    n.on("focus", function () {
                        if (i && i.scrollableContent) {
                            var t = i.scrollableContent.offsetHeight;
                            e(function () {
                                var e = i.scrollableContent.offsetHeight;
                                t > e && i.scrollTo(n, 10)
                            }, 500)
                        }
                    })
        ...
        t.directive(n, [function () {
            return {
                restrict: "A", link: function (t, r, i) {
                    r.on("scroll", function () {
                        e(r[0]) && t.$apply(function () {
                            t.$eval(i[n])
                        })
                    })
                }
        ...
        t.directive(e, ["$window", function (t) {
            return {
                restrict: "C", link: function (e, r) {
                    var i = r[0], o = r.parent()[0].style, a = function () {
                        var e = t.getComputedStyle(i), r = parseInt(e.marginTop) + parseInt(e.marginBottom);
                        o["padding" + n] = i.offsetHeight + r + "px"
                    }, s = setInterval(a, 30);
                    r.on("$destroy", function () {
                        o["padding" + n] = null, clearInterval(s), s = a = r = null
                    })
                }
            }
        }])
    ...
    angular.forEach(["left", "right"], function (e) {
        var n = "sidebar" + e.charAt(0).toUpperCase() + e.slice(1), r = "ui" + n.charAt(0).toUpperCase() + n.slice(1);
        t.directive(n, ["$rootElement", "SharedState", "bindOuterClick", "$location", function (t, n, i, o) {
            return {
                restrict: "C", link: function (a, s, u) {
                    var c = "has-sidebar-" + e, l = "sidebar-" + e + "-visible", f = "sidebar-" + e + "-in";
                    u.id && (r = u.id);
                    var p = function () {
                        n.turnOff(r)
                    }, h = function () {
                    ...
                    t.addClass(c), a.$on("$destroy", function () {
                        t.removeClass(c), t.removeClass(l), t.removeClass(f)
                    });
                    var d = void 0 !== u.active && "false" !== u.active;
                    n.initialize(a, r, {defaultValue: d}), a.$on("mobile-angular-ui.state.changed." + r, function (e, n) {
                        ("" === u.uiTrackAsSearchParam || u.uiTrackAsSearchParam) && o.search(r, n || null), n ? (t.addClass(l), t.addClass(f)) : t.removeClass(f)
                    }), a.$on("$routeChangeSuccess", function () {
                        n.turnOff(r)
                    }), a.$on("$routeUpdate", function () {
                        u.uiTrackAsSearchParam && (o.search()[r] ? n.turnOn(r) : n.turnOff(r))
                    }), a.$on("mobile-angular-ui.app.transitionend", function () {
                        n.isActive(r) || t.removeClass(l)
                    }), "false" !== u.closeOnOuterClicks && i(a, s, p, h)
                }
            }
        }])
    }), t.directive("app", ["$rootScope", "SharedState", function (t) {
        return {
            restrict: "C", link: function (e, n) {
        ...
        return {
            ...
            link: function (t, e, n) {
                e.on("click tap", function () {
                    (null === n.disabled || void 0 === n.disabled) && (t.model = !t.model, t.$apply(), null !== t.changeExpr && void 0 !== t.changeExpr && t.$parent.$eval(t.changeExpr))
                }), e.addClass("switch-transition-enabled")
            }
        }
    })
}(), function () {
    ...
    function t(t) {
        ...
        return function (n, r, i, o) {
            r = y(r, o, 4);
            var a = !E(n) && g.keys(n), s = (a || n).length, u = t > 0 ? 0 : s - 1;
    ...
    function e(t) {
        return function (e, n, r) {
            n = b(n, r);
            for (var i = k(e), o = t > 0 ? 0 : i - 1; o >= 0 && i > o; o += t)if (n(e[o], o, e))return o;
            return -1
        }
    }
    ...
    function n(t, e, n) {
        return function (r, i, o) {
            var a = 0, s = k(r);
            if ("number" == typeof o)t > 0 ? a = o >= 0 ? o : Math.max(o + s, a) : s = o >= 0 ? Math.min(o + 1, s) : o + s + 1; else if (n && o && s)return o = n(r, i), r[o] === i ? o : -1;
            if (i !== i)return o = e(l.call(r, a, s), g.isNaN), o >= 0 ? o + a : -1;
            for (o = t > 0 ? a : s - 1; o >= 0 && s > o; o += t)if (r[o] === i)return o;
            return -1
        }
    }

    function r(t, e) {
        var n = j.length, r = t.constructor, i = g.isFunction(r) && r.prototype || s, o = "constructor";
        for (g.has(t, o) && !g.contains(e, o) && e.push(o); n--;)o = j[n], o in t && t[o] !== i[o] && !g.contains(e, o) && e.push(o)
    }

    var i = this, o = i._, a = Array.prototype, s = Object.prototype, u = Function.prototype, c = a.push, l = a.slice, f = s.toString, p = s.hasOwnProperty, h = Array.isArray, d = Object.keys, v = u.bind, $ = Object.create, m = function () {
    }, g = function (t) {
        return t instanceof g ? t : this instanceof g ? (this._wrapped = t, void 0) : new g(t)
    };
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = g), exports._ = g) : i._ = g, g.VERSION = "1.8.3";
    ...
    var w = function (t, e) {
        return function (n) {
            ...
            for (var i = 1; r > i; i++)for (var o = arguments[i], a = t(o), s = a.length, u = 0; s > u; u++) {
                var c = a[u];
    ...
    }, C = Math.pow(2, 53) - 1, k = S("length"), E = function (t) {
        var e = k(t);
    ...
    g.each = g.forEach = function (t, e, n) {
        ...
        e = b(e, n);
        for (var r = !E(t) && g.keys(t), i = (r || t).length, o = Array(i), a = 0; i > a; a++) {
            var s = r ? r[a] : a;
            o[a] = e(t[s], s, t)
        }
        return o
        ...
        var r;
        return r = E(t) ? g.findIndex(t, e, n) : g.findKey(t, e, n), void 0 !== r && -1 !== r ? t[r] : void 0
    }, g.filter = g.select = function (t, e, n) {
        var r = [];
        return e = b(e, n), g.each(t, function (t, n, i) {
            e(t, n, i) && r.push(t)
        }), r
        ...
        e = b(e, n);
        for (var r = !E(t) && g.keys(t), i = (r || t).length, o = 0; i > o; o++) {
            var a = r ? r[o] : o;
        ...
        return E(t) || (t = g.values(t)), ("number" != typeof n || r) && (n = 0), g.indexOf(t, e, n) >= 0
        ...
        for (var e, n = E(t) ? t : g.values(t), r = n.length, i = Array(r), o = 0; r > o; o++)e = g.random(0, o), e !== o && (i[o] = i[e]), i[e] = n[o];
        return i
        ...
        return e = b(e, n), g.pluck(g.map(t, function (t, n, r) {
    ...
    var A = function (t) {
        return function (e, n, r) {
            var i = {};
            return n = b(n, r), g.each(e, function (r, o) {
                var a = n(r, o, e);
                t(i, r, a)
            }), i
        }
    ...
    var T = function (t, e, n, r) {
        for (var i = [], o = 0, a = r || 0, s = k(t); s > a; a++) {
            var u = t[a];
    ...
    g.flatten = function (t, e) {
        ...
        for (var i = [], o = [], a = 0, s = k(t); s > a; a++) {
            var u = t[a], c = n ? n(u, a, t) : u;
            e ? (a && o === c || i.push(u), o = c) : n ? g.contains(o, c) || (o.push(c), i.push(u)) : g.contains(i, u) || i.push(u)
        }
        return i
    }, g.union = function () {
        ...
        for (var e = t && g.max(t, k).length || 0, n = Array(e), r = 0; e > r; r++)n[r] = g.pluck(t, r);
        return n
    ...
    var O = function (t, e, n, r, i) {
        ...
        var o = x(t.prototype), a = t.apply(o, i);
    ...
    g.bind = function (t, e) {
        ...
        var n = l.call(arguments, 2), r = function () {
            return O(t, r, e, this, n.concat(l.call(arguments)))
        };
        return r
    }, g.partial = function (t) {
        var e = l.call(arguments, 1), n = function () {
            for (var r = 0, i = e.length, o = Array(i), a = 0; i > a; a++)o[a] = e[a] === g ? arguments[r++] : e[a];
            for (; r < arguments.length;)o.push(arguments[r++]);
            return O(t, n, this, this, o)
        };
        return n
    ...
    var M = !{toString: null}.propertyIsEnumerable("toString"), j = ["valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString"];
    g.keys = function (t) {
        if (!g.isObject(t))return [];
        if (d)return d(t);
        var e = [];
        ...
        e = b(e, n);
        for (var r, i = g.keys(t), o = i.length, a = {}, s = 0; o > s; s++)r = i[s], a[r] = e(t[r], r, t);
        return a
    }, g.pairs = function (t) {
        ...
        e = b(e, n);
        for (var r, i = g.keys(t), o = 0, a = i.length; a > o; o++)if (r = i[o], e(t[r], r, t))return r
    }, g.pick = function (t, e, n) {
        var r, i, o = {}, a = t;
        if (null == a)return o;
        g.isFunction(e) ? (i = g.allKeys(a), r = y(e, n)) : (i = T(arguments, !1, !1, 1), r = function (t, e, n) {
            return e in n
        }, a = Object(a));
    ...
    var N = function (t, e, n, r) {
        ...
        if (!o) {
            ...
            if (a !== s && !(g.isFunction(a) && a instanceof a && g.isFunction(s) && s instanceof s) && "constructor"in t && "constructor"in e)return !1
        }
        n = n || [], r = r || [];
        for (var u = n.length; u--;)if (n[u] === t)return r[u] === e;
        if (n.push(t), r.push(e), o) {
            if (u = t.length, u !== e.length)return !1;
            for (; u--;)if (!N(t[u], e[u], n, r))return !1
        } else {
            var c, l = g.keys(t);
            if (u = l.length, g.keys(e).length !== u)return !1;
            for (; u--;)if (c = l[u], !g.has(e, c) || !N(t[c], e[c], n, r))return !1
        }
    ...
    }, g.property = S, g.propertyOf = function (t) {
    ...
    var D = {
        ...
        "'": "&#x27;",
        "`": "&#x60;"
    }, I = g.invert(D), F = function (t) {
        var e = function (e) {
            return t[e]
        }, n = "(?:" + g.keys(t).join("|") + ")", r = RegExp(n), i = RegExp(n, "g");
        return function (t) {
            return t = null == t ? "" : "" + t, r.test(t) ? t.replace(i, e) : t
        }
    };
    g.escape = F(D), g.unescape = F(I), g.result = function (t, e, n) {
    ...
    g.template = function (t, e, n) {
        ...
        var r = RegExp([(e.escape || R).source, (e.interpolate || R).source, (e.evaluate || R).source].join("|") + "|$", "g"), i = 0, o = "__p+='";
        t.replace(r, function (e, n, r, a, s) {
            return o += t.slice(i, s).replace(P, q), i = s + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : a && (o += "';\n" + a + "\n__p+='"), e
    ...
    g.mixin = function (t) {
        g.each(g.functions(t), function (e) {
            ...
            g.prototype[e] = function () {
                var t = [this._wrapped];
                return c.apply(t, arguments), L(this, n.apply(g, t))
            }
        })
    ...
    if ("object" == typeof exports)module.exports = t(); else if ("function" == typeof define && define.amd)define(t); else {
        var e;
        "undefined" != typeof window ? e = window : "undefined" != typeof global ? e = global : "undefined" != typeof self && (e = self), e.s = t()
    }
}(function () {
    return function t(e, n, r) {
        ...
        1: [function (t, e) {
            var n = t("./trim"), r = t("./decapitalize");
            e.exports = function (t, e) {
                return t = n(t).replace(/[-_\s]+(.)?/g, function (t, e) {
                    return e ? e.toUpperCase() : ""
                }), e === !0 ? r(t) : t
            }
        }, {"./decapitalize": 9, "./trim": 60}],
        2: [function (t, e) {
            var n = t("./helper/makeString");
        ...
        5: [function (t, e) {
            var n = t("./capitalize"), r = t("./camelize"), i = t("./helper/makeString");
            e.exports = function (t) {
                return t = i(t), n(r(t.replace(/[\W_]/g, " ")).replace(/\s/g, ""))
            }
        }, {"./camelize": 1, "./capitalize": 2, "./helper/makeString": 19}],
        6: [function (t, e) {
            var n = t("./trim");
            e.exports = function (t) {
        ...
        10: [function (t, e) {
            ...
            var r = t("./helper/makeString");
            e.exports = function (t, e) {
                t = r(t);
                var i, o = n(t);
                return 0 === o ? t : (i = "string" == typeof e ? new RegExp("^" + e, "gm") : new RegExp("^[ \\t]{" + o + "}", "gm"), t.replace(i, ""))
            }
        }, {"./helper/makeString": 19}],
        11: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/toPositive");
            e.exports = function (t, e, i) {
                return t = n(t), e = "" + e, i = "undefined" == typeof i ? t.length - e.length : Math.min(r(i), t.length) - e.length, i >= 0 && t.indexOf(e, i) === i
            }
        }, {"./helper/makeString": 19, "./helper/toPositive": 21}],
        12: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/escapeChars"), i = {};
            for (var o in r)i[r[o]] = o;
            i["'"] = "#39", e.exports = function (t) {
                return n(t).replace(/[&<>"']/g, function (t) {
                    return "&" + i[t] + ";"
                })
            }
        }, {"./helper/escapeChars": 17, "./helper/makeString": 19}],
        13: [function (t, e) {
            e.exports = function () {
                var t = {};
        ...
        16: [function (t, e) {
            var n = t("./escapeRegExp");
            e.exports = function (t) {
                return null == t ? "\\s" : t.source ? t.source : "[" + n(t) + "]"
            }
        }, {"./escapeRegExp": 18}],
        17: [function (t, e) {
            var n = {lt: "<", gt: ">", quot: '"', amp: "&", apos: "'"};
            e.exports = n
        }, {}],
        18: [function (t, e) {
            var n = t("./makeString");
        ...
        22: [function (t, e) {
            var n = t("./capitalize"), r = t("./underscored"), i = t("./trim");
            e.exports = function (t) {
                return n(i(r(t).replace(/_id$/, "").replace(/_/g, " ")))
            }
        }, {"./capitalize": 2, "./trim": 60, "./underscored": 62}],
        23: [function (t, e) {
            var n = t("./helper/makeString");
            e.exports = function (t, e) {
        ...
        26: [function (t, e) {
            var n = t("./helper/makeString"), r = [].slice;
            e.exports = function () {
                var t = r.call(arguments), e = t.shift();
                return t.join(n(e))
            }
        }, {"./helper/makeString": 19}],
        27: [function (t, e) {
            ...
            e.exports = function (t, e) {
                t = n(t), e = n(e);
                for (var r, i, o = [], a = 0; a <= e.length; a++)for (var s = 0; s <= t.length; s++)i = a && s ? t.charAt(s - 1) === e.charAt(a - 1) ? r : Math.min(o[s], o[s - 1], r) + 1 : a + s, r = o[s], o[s] = i;
                return o.pop()
            }
        }, {"./helper/makeString": 19}],
        28: [function (t, e) {
        ...
        31: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/defaultToWhiteSpace"), i = String.prototype.trimLeft;
            e.exports = function (t, e) {
                return t = n(t), !e && i ? i.call(t) : (e = r(e), t.replace(new RegExp("^" + e + "+"), ""))
            }
        }, {"./helper/defaultToWhiteSpace": 16, "./helper/makeString": 19}],
        32: [function (t, e) {
            e.exports = function (t, e) {
                if (t == e)return 0;
                if (!t)return -1;
                if (!e)return 1;
                for (var n = /(\.\d+)|(\d+)|(\D+)/g, r = String(t).match(n), i = String(e).match(n), o = Math.min(r.length, i.length), a = 0; o > a; a++) {
                    var s = r[a], u = i[a];
                    if (s !== u) {
                        var c = +s, l = +u;
        ...
        34: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/strRepeat");
            e.exports = function (t, e, i, o) {
                t = n(t), e = ~~e;
                var a = 0;
                switch (i ? i.length > 1 && (i = i.charAt(0)) : i = " ", o) {
                    case"right":
                        return a = e - t.length, t + r(i, a);
                    case"both":
                        return a = e - t.length, r(i, Math.ceil(a / 2)) + t + r(i, Math.floor(a / 2));
                    default:
                        return a = e - t.length, r(i, a) + t
                }
            }
        }, {"./helper/makeString": 19, "./helper/strRepeat": 20}],
        35: [function (t, e) {
            var n = t("./helper/adjacent");
            e.exports = function (t) {
                return n(t, -1)
            }
        }, {"./helper/adjacent": 15}],
        36: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./rtrim");
            e.exports = function (t, e, i) {
                if (t = n(t), e = ~~e, i = null != i ? String(i) : "...", t.length <= e)return t;
                var o = function (t) {
                    return t.toUpperCase() !== t.toLowerCase() ? "A" : " "
                }, a = t.slice(0, e + 1).replace(/.(?=\W*\w*$)/g, o);
                return a = a.slice(a.length - 2).match(/\w\w/) ? a.replace(/\s*\S+$/, "") : r(a.slice(0, a.length - 1)), (a + i).length > t.length ? t : t.slice(0, a.length) + i
            }
        }, {"./helper/makeString": 19, "./rtrim": 42}],
        37: [function (t, e) {
            var n = t("./surround");
            e.exports = function (t, e) {
                return n(t, e || '"')
        ...
        38: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/strRepeat");
            e.exports = function i(t, e, o) {
                if (t = n(t), e = ~~e, null == o)return r(t, e);
                for (var i = []; e > 0; i[--e] = t);
                return i.join(o)
            }
        }, {"./helper/makeString": 19, "./helper/strRepeat": 20}],
        39: [function (t, e) {
            ...
            e.exports = function (t, e, r, i) {
                var o = i === !0 ? "gi" : "g", a = new RegExp(e, o);
        ...
        42: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/defaultToWhiteSpace"), i = String.prototype.trimRight;
            e.exports = function (t, e) {
                return t = n(t), !e && i ? i.call(t) : (e = r(e), t.replace(new RegExp(e + "+$"), ""))
            }
        }, {"./helper/defaultToWhiteSpace": 16, "./helper/makeString": 19}],
        43: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/defaultToWhiteSpace"), i = t("./trim"), o = t("./dasherize");
            e.exports = function (t) {
                var e = "ąàáäâãåæăćčĉęèéëêĝĥìíïîĵłľńňòóöőôõðøśșšŝťțŭùúüűûñÿýçżźž", a = "aaaaaaaaaccceeeeeghiiiijllnnoooooooossssttuuuuuunyyczzz", s = new RegExp(r(e), "g");
                return t = n(t).toLowerCase().replace(s, function (t) {
                    var n = e.indexOf(t);
                    return a.charAt(n) || "-"
                }), i(o(t.replace(/[^\w\s-]/g, "-")), "-")
            }
        }, {"./dasherize": 8, "./helper/defaultToWhiteSpace": 16, "./helper/makeString": 19, "./trim": 60}],
        44: [function (t, e) {
            var n = t("./chars");
            e.exports = function (t, e, r, i) {
                var o = n(t);
                return o.splice(~~e, ~~r, i), o.join("")
            }
        }, {"./chars": 3}],
        45: [function (t, e) {
            var n = t("./helper/strRepeat"), r = Object.prototype.toString, i = function () {
                function t(t) {
                    return r.call(t).slice(8, -1).toLowerCase()
                }
                ...
                return o.format = function (n, r) {
                    var o, a, s, u, c, l, f, p = 1, h = n.length, d = "", v = [];
                    for (a = 0; h > a; a++)if (d = t(n[a]), "string" === d)v.push(n[a]); else if ("array" === d) {
                        if (u = n[a], u[2])for (o = r[p], s = 0; s < u[2].length; s++) {
                            if (!o.hasOwnProperty(u[2][s]))throw new Error(i('[_.sprintf] property "%s" does not exist', u[2][s]));
                            o = o[u[2][s]]
                        } else o = u[1] ? r[u[1]] : r[p++];
                        if (/[^s]/.test(u[8]) && "number" != t(o))throw new Error(i("[_.sprintf] expecting number but found %s", t(o)));
                        switch (u[8]) {
                            case"b":
                                o = o.toString(2);
                                break;
                        ...
                        o = /[def]/.test(u[8]) && u[3] && o >= 0 ? "+" + o : o, l = u[4] ? "0" == u[4] ? "0" : u[4].charAt(1) : " ", f = u[6] - String(o).length, c = u[6] ? e(l, f) : "", v.push(u[5] ? o + c : c + o)
                    }
                    return v.join("")
                }, o.cache = {}, o.parse = function (t) {
                    for (var e = t, n = [], r = [], i = 0; e;) {
                        if (null !== (n = /^[^\x25]+/.exec(e)))r.push(n[0]); else if (null !== (n = /^\x25{2}/.exec(e)))r.push("%"); else {
                            ...
                            if (n[2]) {
                                ...
                                for (o.push(s[1]); "" !== (a = a.substring(s[0].length));)if (null !== (s = /^\.([a-z_][a-z_\d]*)/i.exec(a)))o.push(s[1]); else {
        ...
        46: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/toPositive");
            e.exports = function (t, e, i) {
                return t = n(t), e = "" + e, i = null == i ? 0 : Math.min(r(i), t.length), t.lastIndexOf(e, i) === i
            }
        }, {"./helper/makeString": 19, "./helper/toPositive": 21}],
        47: [function (t, e) {
            var n = t("./helper/makeString");
        ...
        56: [function (t, e) {
            function n(t, e) {
                ...
                for (e = [].concat(e), n = 0; n < e.length; n += 1)if (r = e[n]) {
            ...
            var r = t("./trim");
            e.exports = function (t, e, i) {
                return "number" == typeof t && (t = "" + t), "string" != typeof t ? !!t : (t = r(t), n(t, e || ["true", "1"]) ? !0 : n(t, i || ["false", "0"]) ? !1 : void 0)
            }
        }, {"./trim": 60}],
        57: [function (t, e) {
            t("./trim");
        ...
        58: [function (t, e) {
            ...
            e.exports = function (t, e, r, i) {
                e = e || ", ", r = r || " and ";
                var o = t.slice(), a = o.pop();
                return t.length > 2 && i && (r = n(e) + r), o.length ? o.join(e) + r + a : a
            }
        }, {"./rtrim": 42}],
        59: [function (t, e) {
            var n = t("./toSentence");
        ...
        60: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/defaultToWhiteSpace"), i = String.prototype.trim;
            e.exports = function (t, e) {
                return t = n(t), !e && i ? i.call(t) : (e = r(e), t.replace(new RegExp("^" + e + "+|" + e + "+$", "g"), ""))
            }
        }, {"./helper/defaultToWhiteSpace": 16, "./helper/makeString": 19}],
        61: [function (t, e) {
            var n = t("./helper/makeString");
        ...
        63: [function (t, e) {
            var n = t("./helper/makeString"), r = t("./helper/escapeChars");
            e.exports = function (t) {
                return n(t).replace(/\&([^;]+);/g, function (t, e) {
                    var n;
                    return e in r ? r[e] : (n = e.match(/^#x([\da-fA-F]+)$/)) ? String.fromCharCode(parseInt(n[1], 16)) : (n = e.match(/^#(\d+)$/)) ? String.fromCharCode(~~n[1]) : t
                })
            }
        }, {"./helper/escapeChars": 17, "./helper/makeString": 19}],
        64: [function (t, e) {
        ...
        66: [function (t, e) {
            var n = t("./isBlank"), r = t("./trim");
            e.exports = function (t, e) {
                return n(t) ? [] : r(t, e).split(e || /\s+/)
            }
        }, {"./isBlank": 25, "./trim": 60}]
    }, {}, [14])(14)
}), angular.module("underscore.string", []).filter("s", function () {
    return function (t, e, n) {
        return t = t || "", n = n || [], n.unshift(t), e ? s[e].apply(this, n) : t
    }
}), function () {
    var t;
    t = angular.module("ui.bootstrap.showErrors", []), t.directive("showErrors", ["$timeout", "showErrorsConfig", "$interpolate", function (t, e, n) {
        var r, i, o;
        return i = function (t) {
            var n;
            return n = e.trigger, t && null != t.trigger && (n = t.trigger), n
        }, r = function (t) {
            var n;
            return n = e.showSuccess, t && null != t.showSuccess && (n = t.showSuccess), n
        }, o = function (e, o, a, s) {
            var u, c, l, f, p, h, d, v;
            if (u = !1, p = e.$eval(a.showErrors), h = r(p), v = i(p), c = o[0].querySelector(".form-control[name]"), f = angular.element(c), l = n(f.attr("name") || "")(e), !l)throw"show-errors element has no child input elements with a 'name' attribute and a 'form-control' class";
            return f.bind(v, function () {
                return u = !0, d(s[l].$invalid)
            }), e.$watch(function () {
                return s[l] && s[l].$invalid
            }, function (t) {
                return u ? d(t) : void 0
            }), e.$on("show-errors-check-validity", function () {
                return d(s[l].$invalid)
            }), e.$on("show-errors-reset", function () {
                return t(function () {
                    return o.removeClass("has-error"), o.removeClass("has-success"), u = !1
                }, 0, !1)
            }), d = function (t) {
                return o.toggleClass("has-error", t), h ? o.toggleClass("has-success", !t) : void 0
            }
        }, {
            restrict: "A", require: "^form", compile: function (t, e) {
                if (-1 === e.showErrors.indexOf("skipFormGroupCheck") && !t.hasClass("form-group") && !t.hasClass("input-group"))throw"show-errors element does not have the 'form-group' or 'input-group' class";
                return o
            }
        }
    }]), t.provider("showErrorsConfig", function () {
        var t, e;
        t = !1, e = "blur", this.showSuccess = function (e) {
            return t = e
        }, this.trigger = function (t) {
            return e = t
        }, this.$get = function () {
            return {showSuccess: t, trigger: e}
        }
    })
}.call(this), angular.module("Vatra").run(["$templateCache", function (t) {
