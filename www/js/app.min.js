...
!function (t, e, n) {
    ...
    function F(t, e, n, r) {
        ...
        if (e) {
            ...
            if (di(t)) {
                e.length = 0;
                for (var s = 0; s < t.length; s++)a = F(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(a)), e.push(a)
            } else {
                var u = e.$$hashKey;
                di(e) ? e.length = 0 : o(e, function (t, n) {
                    delete e[n]
                });
                for (var c in t)t.hasOwnProperty(c) && (a = F(t[c], null, n, r), y(t[c]) && (n.push(t[c]), r.push(a)), e[c] = a);
                l(e, u)
            }
        } else if (e = t, t)if (di(t))e = F(t, [], n, r); else if (x(t))e = new Date(t.getTime()); else if (S(t))e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex; else if (y(t)) {
    ...
    function P(t, e) {
        ...
        if (a == s && "object" == a) {
            ...
            if ((r = t.length) == e.length) {
                for (i = 0; r > i; i++)if (!P(t[i], e[i]))return !1;
                return !0
            }
        }
        return !1
    ...
    function ge(t, e) {
        ...
        if (ve(t))u.push(e.createTextNode(t)); else {
            for (n = n || s.appendChild(e.createElement("div")), r = (_i.exec(t) || ["", ""])[1].toLowerCase(), i = Vi[r] || Vi._default, n.innerHTML = i[1] + t.replace(Fi, "<$1></$2>") + i[2], a = i[0]; a--;)n = n.lastChild;
    ...
    function He(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e)throw b(n) && n || (n = t.name || Le(t)), Gi("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
    ...
    function Be(t, e) {
        ...
        function i(t, e) {
            if (ae(t, "service"), (C(e) || di(e)) && (e = E.instantiate(e)), !e.$get)throw Gi("pget", "Provider '{0}' must define $get factory method.", t);
            return k[t + w] = e
        }
    ...
    function ze(t, e, r, i) {
        ...
        function f() {
            T = l(), T = m(T) ? null : T, P(T, _) && (T = _), _ = T
        }

        function d() {
            (j !== $.url() || O !== T) && (j = $.url(), O = T, o(D, function (t) {
                t($.url(), T)
            }))
        }
        ...
        $.cookies = function (t, e) {
            var i, o, a, s, u;
            if (!t) {
                if (v.cookie !== V)for (V = v.cookie, o = V.split("; "), F = {}, s = 0; s < o.length; s++)a = o[s], u = a.indexOf("="), u > 0 && (t = h(a.substring(0, u)), F[t] === n && (F[t] = h(a.substring(u + 1))));
                return F
            }
    ...
    function Je(t, r) {
        ...
        var a = {}, s = "Directive", c = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, l = /(([\w\-]+)(?:\:([^;]+))?;?)/, d = D("ngSrc,ngSrcset,src,srcset"), m = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, w = /^(on[a-z]+|formaction)$/;
        ...
        this.debugInfoEnabled = function (t) {
            ...
            function M(t, e, n, r, i) {
                ...
                return function (e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? ei(Z(s, ei("<div>").append(t).html())) : n ? Pi.clone.call(t) : t, o)for (var l in o)c.data("$" + l + "Controller", o[l].instance);
            ...
            function D(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    ...
                    for (l = 0, f = $.length; f > l;)u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), M.$$addScopeInfo(ei(u), c)) : c = t, h = a.transcludeOnThisElement ? F(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? F(t, e) : null, a(s, c, u, i, h)) : s && s(t, u.childNodes, n, o)
                }

                for (var u, c, l, f, d, h, p, $ = [], v = 0; v < t.length; v++)u = new ae, c = V(t[v], [], u, 0 === v ? i : n, o), l = c.length ? L(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && M.$$addScopeClass(u.$$element), d = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : D(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || d) && ($.push(v, l, d), h = !0, p = p || l), a = null;
                return h ? s : null
            }
                ...
                switch (s) {
                    case yi:
                        ...
                        for (var f, d, h, p, $, v, m = t.attributes, g = 0, w = m && m.length; w > g; g++) {
                            ...
                            G(S) && p === S + "Start" && (x = d, C = d.substr(0, d.length - 5) + "end", d = d.substr(0, d.length - 6)), h = Ze(d.toLowerCase()), u[h] = d, (v || !n.hasOwnProperty(h)) && (n[h] = $, Fe(t, h) && (n[h] = !0)), te(t, e, $, h, v), B(e, h, "A", r, i, x, C)
                        }
            ...
            function L(t, a, s, u, c, l, f, d, h) {
                function p(t, e, n, r) {
                    t && (n && (t = U(t, n, r)), t.require = k.require, t.directiveName = A, (I === k || k.$$isolateScope) && (t = re(t, {isolateScope: !0})), f.push(t)), e && (n && (e = U(e, n, r)), e.require = k.require, e.directiveName = A, (I === k || k.$$isolateScope) && (e = re(e, {isolateScope: !0})), d.push(e))
                }
                ...
                function w(t, e, i, u, c) {
                    function l(t, e, r) {
                        var i;
                        return E(t) || (r = e, e = t, t = n), G && (i = w), r || (r = G ? C.parent() : C), c(t, e, i, r, O)
                    }

                    var h, p, m, y, b, w, x, C, k;
                    if (a === i ? (k = s, C = s.$$element) : (C = ei(i), k = new ae(C, s)), I && (b = e.$new(!0)), c && (x = l, x.$$boundTransclude = c), D && (S = {}, w = {}, o(D, function (t) {
                            var n, r = {
                            ...
                            y = t.controller, "@" == y && (y = k[t.name]), n = g(y, r, !0, t.controllerAs), w[t.name] = n, G || C.data("$" + t.name + "Controller", n.instance), S[t.name] = n
                        })), I) {
                        M.$$addScopeInfo(C, b, !0, !(_ && (_ === I || _ === I.$$originalDirective))), M.$$addScopeClass(C, !0);
                        var A = S && S[I.name], T = b;
                        A && A.identifier && I.bindToController === !0 && (T = A.instance), o(b.$$isolateBindings = I.$$isolateBindings, function (t, n) {
                            ...
                            switch (l) {
                                ...
                                case"=":
                                    if (c && !k[u])return;
                                    o = v(k[u]), s = o.literal ? P : function (t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function () {
                    ...
                    var O = e;
                    for (I && (I.template || null === I.templateUrl) && (O = b), t && t(O, i.childNodes, n, c), h = d.length - 1; h >= 0; h--)m = d[h], oe(m, m.isolateScope ? b : e, C, k, m.require && $(m.directiveName, m.require, C, w), x)
                }

                h = h || {};
                for (var x, S, k, A, T, O, j, N = -Number.MAX_VALUE, D = h.controllerDirectives, I = h.newIsolateScopeDirective, _ = h.templateDirective, F = h.nonTlbTranscludeDirective, L = !1, B = !1, G = h.hasElementTranscludeDirective, X = s.$$element = ei(a), J = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    k = t[te];
                    var ie = k.$$start, se = k.$$end;
                    if (ie && (X = R(a, ie, se)), T = n, N > k.priority)break;
                    if ((j = k.scope) && (k.templateUrl || (y(j) ? (K("new/isolated scope", I || x, k, X), I = k) : K("new/isolated scope", I, k, X)), x = x || k), A = k.name, !k.templateUrl && k.controller && (j = k.controller, D = D || {}, K("'" + A + "' controller", D[A], k, X), D[A] = k), (j = k.transclude) && (L = !0, k.$$tlb || (K("transclusion", F, k, X), F = k), "element" == j ? (G = !0, N = k.priority, T = X, X = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = X[0], ee(c, q(T), a), Q = M(T, u, N, J && J.name, {nonTlbTranscludeDirective: F})) : (T = ei(we(a)).contents(), X.empty(), Q = M(T, u))), k.template)if (B = !0, K("template", _, k, X), _ = k, j = C(k.template) ? k.template(X, s) : k.template, j = le(j), k.replace) {
                        ...
                        ee(c, X, a);
                        var ue = {$attr: {}}, ce = V(a, [], ue), fe = t.splice(te + 1, t.length - (te + 1));
                        I && H(ce), t = t.concat(ce).concat(fe), z(s, ue), ne = t.length
                    } else X.html(j);
                    if (k.templateUrl)B = !0, K("template", _, k, X), _ = k, k.replace && (J = k), w = Y(t.splice(te, t.length - te), X, s, c, L && Q, f, d, {
                ...
                return w.scope = x && x.scope === !0, w.transcludeOnThisElement = L, w.elementTranscludeOnThisElement = G, w.templateOnThisElement = B, w.transclude = Q, h.hasElementTranscludeDirective = G, w
            }
            ...
            function Y(t, e, n, r, i, a, s, c) {
                ...
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                    ...
                    if (u = le(u), $.replace) {
                        ...
                        b = {$attr: {}}, ee(r, e, h);
                        var C = V(h, [], b);
                        y($.scope) && H(C), t = C.concat(t), z(n, b)
                    } else h = p, e.html(u);
                    for (t.unshift(v), l = L(t, h, n, i, e, $, a, s, c), o(r, function (t, n) {
                        t == h && (r[n] = e[0])
                    }), f = D(e[0].childNodes, i); d.length;) {
                        ...
                        if (!S.$$destroyed) {
                            ...
                            x = l.transcludeOnThisElement ? F(S, l.transclude, A) : A, l(f, S, T, r, x)
                        }
                    }
                    d = null
                }), function (t, e, n, r, i) {
                    var o = i;
                    e.$$destroyed || (d ? d.push(e, n, r, o) : (l.transcludeOnThisElement && (o = F(e, l.transclude, i)), l(f, e, n, r, o)))
                }
            }
            ...
            function te(t, e, n, i, o) {
                ...
                var s = r(n, !0, a, o);
                if (s) {
                    if ("multiple" === i && "select" === I(t))throw Xi("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", W(t));
                    e.push({
            ...
            ae.prototype = {
                $normalize: Ze, $addClass: function (t) {
                    ...
                    var s, u = this.$$element[0], c = Fe(u, t), l = Ve(u, t), f = t;
    ...
    function fn() {
        var t = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: V(Qi), put: V(Qi), patch: V(Qi)},
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, d, h) {
            ...
            function w(r, i) {
                ...
                if (p.pendingRequests.push(r), b.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(t.cache) ? t.cache : k), h && ($ = h.get(x), g($) ? M($) ? $.then(c, c) : di($) ? s($[1], $[0], V($[2]), $[3]) : s($, 200, {}, "OK") : h.put(x, b)), m($)) {
    ...
    function Rn(t, e, r, i, o, a, s) {
        ...
        var u = function (t) {
            return In(t, a)
        }, c = s || Pn(t) ? u : $, l = s || Pn(e) ? u : $, f = s || Pn(r) ? u : $, d = s || Pn(i) ? u : $, h = s || Pn(o) ? u : $;
        return function (a, s) {
    ...
    function Un(t, e, r) {
        ...
        if (e.csp)s = 6 > c ? Rn(u[0], u[1], u[2], u[3], u[4], r, i) : function (t, e) {
            ...
            o(u, function (t, e) {
                ...
                (i || Pn(t)) && (n = "eso(" + n + ", fe)", f = !0), l += "if(s == null) return undefined;\ns=" + n + ";\n"
            }), l += "return s;";
                    ...
                    do {
                        ...
                        t:do {
                            if (o = h.$$watchers)for (c = o.length; c--;)try {
                                if (t = o[c])if ((r = t.get(h)) === (i = t.last) || (t.eq ? P(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                    if (t === a) {
                                        l = !1;
                                        break t
                                    }
                                } else l = !0, a = t, t.last = t.eq ? F(r, null) : r, t.fn(r, i === b ? r : i, h), 5 > g && (p = 4 - g, x[p] || (x[p] = []), x[p].push({
    ...
    function jr(t, e, r, i, a) {
        ...
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, c.$addControl(s), s.$rollbackViewValue = function () {
            ...
            i.setClass(t, $a, va + " " + Io), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(u, function (t) {
                t.$setPristine()
            })
    ...
    function Pr(t, e, r, i, o, a) {
        if (Vr(t, e, r, i), Dr(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function (t) {
    ...
    function Rr(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), Mr(r), r.$$parserName = "url", r.$validators.url = function (t, e) {
            var n = t || e;
    ...
    function qr(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), Mr(r), r.$$parserName = "email", r.$validators.email = function (t, e) {
            var n = t || e;
    ...
    function Wr(t) {
        function e(t, e, u) {
            e === n ? r("$pending", t, u) : i("$pending", t, u), j(e) ? e ? (f(s.$error, t, u), l(s.$$success, t, u)) : (l(s.$error, t, u), f(s.$$success, t, u)) : (f(s.$error, t, u), f(s.$$success, t, u)), s.$pending ? (o(ya, !0), s.$valid = s.$invalid = n, a("", null)) : (o(ya, !1), s.$valid = Gr(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
            var c;
    ...
    var zr = /^\/(.+)\/([a-z]*)$/, Yr = "validity", Xr = function (t) {
    ...
    }, Ni = r("jqLite"), Di = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Ii = /<|&#?\w+;/, _i = /<([\w:]+)/, Fi = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Vi = {
    ...
    o({data: Ee, removeData: Se}, function (t, e) {
        ...
        be.prototype[e] = function (e, r) {
            ...
            if (t !== De && (2 == t.length && t !== Ae && t !== Me ? e : r) === n) {
                if (y(e)) {
        ...
        removeData: Se, on: function za(t, e, n, r) {
            ...
            if (me(t)) {
                ...
                for (var s = e.indexOf(" ") >= 0 ? e.split(" ") : [e], u = s.length; u--;) {
                    e = s[u];
                    var c = o[e];
                    c || (o[e] = [], "mouseenter" === e || "mouseleave" === e ? za(t, Mi[e], function (t) {
    ...
    var Li = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Hi = /,/, Bi = /^\s*(_?)(\S+?)\1\s*$/, Wi = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Gi = r("$injector");
    Be.$$annotate = He;
    var zi = r("$animate"), Yi = ["$provide", function (t) {
    ...
    mo.ZERO = f(function () {
        ...
        constructor: mo, parse: function (t) {
            ...
            return f(function (o, a) {
                ...
                return i(s)
            }, {constant: !i.$stateful && o.every(Fn), inputs: !i.$stateful && o})
        }, expression: function () {
            ...
            return this.consume("]"), f(function (e, n) {
                ...
                return r
            }, {literal: !0, constant: t.every(Fn), inputs: t})
        }, object: function () {
            var t = [], e = [];
            if ("}" !== this.peekToken().text)do {
                if (this.peek("}"))break;
            ...
            return this.consume("}"), f(function (n, r) {
                ...
                return i
            }, {literal: !0, constant: e.every(Fn), inputs: e})
        }
    };
                ...
                name: "form", restrict: t ? "EAC" : "E", controller: jr, compile: function (r, i) {
                    ...
                    return {
                        pre: function (t, r, i, a) {
                            ...
                            var u = a.$$parentForm;
                            o && (Vn(t, null, a.$name, a, a.$name), i.$observe(o, function (e) {
                                a.$name !== e && (Vn(t, null, a.$name, n, a.$name), u.$$renameControl(a, e), Vn(t, null, a.$name, a, a.$name))
                            })), r.on("$destroy", function () {
                                u.$removeControl(a), o && Vn(t, null, i[o], n, a.$name), f(a, Do)
                            })
                        }
                    }
                }
    ...
    }, Fo = _o(), Vo = _o(!0), Po = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Ro = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, qo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Uo = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Lo = /^(\d{4})-(\d{2})-(\d{2})$/, Ho = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Bo = /^(\d{4})-W(\d\d)$/, Wo = /^(\d{4})-(\d\d)$/, Go = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, zo = {
        text: Nr,
        date: Fr("date", Lo, _r(Lo, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
        "datetime-local": Fr("datetimelocal", Ho, _r(Ho, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
        time: Fr("time", Go, _r(Go, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        week: Fr("week", Bo, Ir, "yyyy-Www"),
        month: Fr("month", Wo, _r(Wo, ["yyyy", "MM"]), "yyyy-MM"),
        number: Pr,
        url: Rr,
        email: qr,
        radio: Ur,
    ...
    var ua = ["$animate", function (t) {
        ...
        var S = i.inheritedData("$formController") || Do, k = 0;
        Wr({
            ...
            compile: function (r, d) {
                ...
                return y ? x = t(y) : (S = function (t, e) {
                    ...
                    t.$watchCollection(m, function (r) {
                        var d, m, y, x, E, A, T, O, j, M, N, D, I = e[0], _ = ce();
                        if (g && (t[g] = r), i(r))j = r, O = C || S; else {
                            O = C || k, j = [];
                            for (var F in r)r.hasOwnProperty(F) && "$" != F.charAt(0) && j.push(F);
                            j.sort()
                        }
                        for (x = j.length, N = new Array(x), d = 0; x > d; d++)if (E = r === j ? d : j[d], A = r[E], T = O(E, A, d), v[T])M = v[T], delete v[T], _[T] = M, N[d] = M; else {
                            if (_[T])throw o(N, function (t) {
                                t && t.scope && (v[t.id] = t)
                            ...
                            N[d] = {id: T, scope: n, clone: n}, _[T] = !0
                        }
                        for (var V in v) {
                            if (M = v[V], D = ue(M.clone), a.leave(D), D[0].parentNode)for (d = 0, m = D.length; m > d; d++)D[d][s] = !0;
                            M.scope.$destroy()
                        }
                        for (d = 0; x > d; d++)if (E = r === j ? d : j[d], A = r[E], M = N[d], M.scope) {
                            y = I;
                            do y = y.nextSibling; while (y && y[s]);
                            l(M) != y && a.move(ue(M.clone), null, ei(I)), I = f(M), c(M.scope, d, b, A, w, E, x)
                        } else $(function (t, e) {
                            M.scope = e;
                            var n = p.cloneNode(!1);
                            t[t.length++] = n, a.enter(t, null, ei(I)), I = n, M.clone = t, _[M.id] = M, c(M.scope, d, b, A, w, E, x)
                        });
                        v = _
                    })
                }
    ...
    }], Pa = r("ngOptions"), Ra = v({restrict: "A", terminal: !0}), qa = ["$compile", "$parse", function (t, r) {
            ...
            link: function (s, u, c, l) {
                ...
                function d(t, e, n) {
                    ...
                    n.$render = function () {
                        ...
                        P(r, n.$viewValue) || (r = V(n.$viewValue), n.$render())
                    }), e.on("change", function () {
                        t.$apply(function () {
                            var t = [];
                            o(e.find("option"), function (e) {
                ...
                function h(e, s, u) {
                    ...
                    function l() {
                        e.$apply(function () {
                            ...
                            if (y)t = [], o(s.val(), function (e) {
                                e = _ ? F[e] : e, t.push(f(e, n[e]))
                            }); else {
                                var r = _ ? F[s.val()] : s.val();
                                t = f(r, n[r])
                            }
                            u.$setViewValue(t), m()
                        })
                    ...
                    function h(t) {
                        ...
                        if (y)if (_ && di(t)) {
                            e = new Ue([]);
                            for (var n = 0; n < t.length; n++)e.put(c(_, null, t[n]), !0)
                        } else e = new Ue(t); else _ && (t = c(_, null, t));
                        return function (n, r) {
                            var i;
                            return i = _ ? _ : O ? O : N, y ? g(e.remove(c(i, n, r))) : t === c(i, n, r)
                        }
                    }
                    ...
                    function m() {
                        x = !1;
                        var t, n, r, i, l, f, d, p, m, b, k, A, T, O, N, I, R, q = {"": []}, U = [""], L = u.$viewValue, H = D(e) || [], B = j ? a(H) : H, W = {}, G = h(L), z = !1;
                        for (F = {}, A = 0; b = B.length, b > A; A++)d = A, j && (d = B[A], "$" === d.charAt(0)) || (p = H[d], t = c(M, d, p) || "", (n = q[t]) || (n = q[t] = [], U.push(t)), T = G(d, p), z = z || T, I = c(E, d, p), I = g(I) ? I : "", R = _ ? _(e, P) : j ? B[A] : A, _ && (F[R] = d), n.push({
                            id: R,
                            label: I,
                            selected: T
                        }));
                        for (y || (w || null === L ? q[""].unshift({
                            ...
                            label: "",
                            selected: !z
                        }) : z || q[""].unshift({id: "?", label: "", selected: !0})), k = 0, m = U.length; m > k; k++) {
                            for (t = U[k], n = q[t], V.length <= k ? (i = {
                                element: S.clone().attr("label", t),
                                label: n.label
                            }, l = [i], V.push(l), s.append(i.element)) : (l = V[k], i = l[0], i.label != t && i.element.attr("label", i.label = t)), O = null, A = 0, b = n.length; b > A; A++)r = n[A], (f = l[A + 1]) ? (O = f.element, f.label !== r.label && (v(W, f.label, !1), v(W, r.label, !0), O.text(f.label = r.label), O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), ti && O.prop("selected", f.selected))) : ("" === r.id && w ? N = w : (N = C.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {
                                element: N,
                                label: r.label,
                                id: r.id,
                                selected: r.selected
                    ...
                    var k;
                    if (!(k = b.match(i)))throw Pa("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, W(s));
                    var E = r(k[2] || k[1]), A = k[4] || k[6], T = / as /.test(k[0]) && k[1], O = T ? r(T) : null, j = k[5], M = r(k[3] || ""), N = r(k[2] ? k[1] : A), D = r(k[7]), I = k[8], _ = I ? r(k[8]) : null, F = {}, V = [[{
                        element: s,
                        label: ""
                    }]], P = {};
                    w && (t(w)(e), w.removeClass("ng-scope"), w.remove()), s.empty(), s.on("change", l), u.$render = m, e.$watchCollection(D, p), e.$watchCollection(d, p), y && e.$watchCollection(function () {
                        return u.$modelValue
                    }, p)
                }
...
FastClick.prototype.needsClick = function (t) {
    ...
    m.template = function (t, e, n) {
        ...
        t.replace(r, function (e, n, r, a, s) {
            return o += t.slice(i, s).replace(F, V), i = s + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : a && (o += "';\n" + a + "\n__p+='"), e
    ...
    m.mixin = function (t) {
        m.each(m.functions(t), function (e) {
            ...
            m.prototype[e] = function () {
                var t = [this._wrapped];
                return u.apply(t, arguments), P(this, n.apply(m, t))
            }
        })
        ...
        m.prototype[t] = function () {
            var n = this._wrapped;
            return e.apply(n, arguments), "shift" !== t && "splice" !== t || 0 !== n.length || delete n[0], P(this, n)
        }
...
}), angular.module("Vatra.services.Data", ["Vatra.services.HardcodedTables"]).factory("grenadesConsumption", ["singleTargetGrenadeConsumption", "groupTargetGrenadeConsumption", "averageByDistance", function (t, e, n) {
    return function (r) {
        var i, o = {}, a = "single" == r.type || r.front <= 15 && r.depth <= 15;
        return a ? (i = t[r.task], o.totalGrenades = n(i, r.distance)) : (i = e[r.trajectory][r.task], o.grenadesCoeffitient = n(i, r.distance), o.totalGrenades = o.grenadesCoeffitient * r.front * r.depth / 100), o.grenadesPerDevice = o.totalGrenades / r.devicesNumber, o
    }
    ...
    return function (t, e) {
        var n = _.map(_.keys(t), function (t) {
            return 1 * t
        }), r = _.partition(n, function (t) {
            return e > t
        }), i = _.sortBy(r[0], _.identity()), o = _.sortBy(r[1], _.identity());
        if (_.isEmpty(i))return t[o[0]];
        if (_.isEmpty(o))return t[_.last(i)];
        var a = _.last(i), s = o[0], u = s - a, c = (e - a) / u, l = (s - e) / u;
        return l * t[a] + c * t[s]
    }
    ...
    t.when("/", {redirectTo: "/input"}).when("/input", {
        ...
        reloadOnSearch: !1
    }).when("/tasks", {templateUrl: "tasks.html", reloadOnSearch: !1}).when("/result", {
