...
!function (t, e, n) {
    ...
    function o(t, e, n) {
        var r, a;
        if (t)if (x(t))for (r in t)"prototype" == r || "length" == r || "name" == r || t.hasOwnProperty && !t.hasOwnProperty(r) || e.call(n, t[r], r, t); else if (di(t) || i(t)) {
    ...
    function P(t, e, n, r) {
        ...
        } else if (e = t, t)if (di(t))e = P(t, [], n, r); else if (C(t))e = new Date(t.getTime()); else if (S(t))e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]), e.lastIndex = t.lastIndex; else if (y(t)) {
    ...
    function R(t, e) {
        ...
        if (a == s && "object" == a) {
            if (!di(t)) {
                if (C(t))return C(e) ? R(t.getTime(), e.getTime()) : !1;
                if (S(t))return S(e) ? t.toString() == e.toString() : !1;
                if (E(t) || E(e) || k(t) || k(e) || di(e) || C(e) || S(e))return !1;
                o = {};
            ...
            if ((r = t.length) == e.length) {
                for (i = 0; r > i; i++)if (!R(t[i], e[i]))return !1;
                return !0
            }
        }
        return !1
    ...
    function z(t) {
        ...
        return o((t || "").split("&"), function (t) {
            if (t && (e = t.replace(/\+/g, "%20").split("="), n = W(e[0]), g(n))) {
                var i = g(e[1]) ? W(e[1]) : !0;
                Jr.call(r, n) ? di(r[n]) ? r[n].push(i) : r[n] = [r[n], i] : r[n] = i
            }
        }), r
    }
    ...
    function Q(n, r, i) {
        ...
        }, x(ci.resumeDeferredBootstrap) && ci.resumeDeferredBootstrap(), void 0)
    }
    ...
    function oe(t, e, n) {
        return n && di(t) && (t = t[t.length - 1]), ie(x(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), t
    }
    ...
    function he(e) {
        ...
        ri("ng", ["ngLocale"], ["$provide", function (t) {
            t.provider({$$sanitizeUri: Xn}), t.provider("$compile", Ze).directive({
                a: No,
                input: Yo,
                textarea: Yo,
                form: Po,
                ...
                ngValue: Jo,
                ngModelOptions: Sa
            }).directive({ngInclude: la}).directive(Io).directive(aa), t.provider({
                $anchorScroll: Ge,
                $animate: Yi,
                $browser: Ye,
                $cacheFactory: Xe,
    ...
    function ge(t, e) {
        ...
        if (ve(t))u.push(e.createTextNode(t)); else {
            for (n = n || s.appendChild(e.createElement("div")), r = (ji.exec(t) || ["", ""])[1].toLowerCase(), i = Fi[r] || Fi._default, n.innerHTML = i[1] + t.replace(Pi, "<$1></$2>") + i[2], a = i[0]; a--;)n = n.lastChild;
    ...
    function xe(t, e, n, r) {
        if (g(r))throw Ii("offargs", "jqLite#off() does not support the `selector` argument");
    ...
    function Se(t, e) {
        ...
        if (i) {
            ...
            i.handle && (i.events.$destroy && i.handle({}, "$destroy"), xe(t)), delete ki[r], t.ng339 = n
        }
    }
    ...
    function Ne(t, e) {
        return Ie(t, "$" + (e || "ngController") + "Controller")
    }

    function Ie(t, e, r) {
        t.nodeType == Ci && (t = t.documentElement);
        for (var i = di(e) ? e : [e]; t;) {
            for (var o = 0, a = i.length; a > o; o++)if ((r = ei.data(t, i[o])) !== n)return r;
            t = t.parentNode || t.nodeType === xi && t.host
        }
    }
    ...
    function Le(t) {
        var e = t.toString().replace(Gi, ""), n = e.match(Li);
    ...
    function He(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e)throw b(n) && n || (n = t.name || Le(t)), Wi("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                    i = t.toString().replace(Gi, ""), a = i.match(Li), o(a[1].split(Hi), function (t) {
    ...
    function Be(t, e) {
        ...
        function i(t, e) {
            if (ae(t, "service"), (x(e) || di(e)) && (e = E.instantiate(e)), !e.$get)throw Wi("pget", "Provider '{0}' must define $get factory method.", t);
            return k[t + w] = e
        }
        ...
        function h(t) {
            ...
            return o(t, function (t) {
                ...
                if (!S.get(t)) {
                    S.put(t, !0);
                    try {
                        b(t) ? (e = ri(t), n = n.concat(h(e.requires)).concat(e._runBlocks), r(e._invokeQueue), r(e._configBlocks)) : x(t) ? n.push(E.invoke(t)) : di(t) ? n.push(E.invoke(t)) : oe(t, "module")
                    } catch (i) {
        ...
        function $(t, n) {
            function r(e, r) {
                if (t.hasOwnProperty(e)) {
                    if (t[e] === g)throw Wi("cdep", "Circular dependency found: {0}", e + " <- " + C.join(" <- "));
                    return t[e]
                }
                try {
                    return C.unshift(e), t[e] = g, t[e] = n(e, r)
                } catch (i) {
        ...
        e = e === !0;
        var g = {}, w = "Provider", C = [], S = new _e([], !0), k = {
            $provide: {
                provider: r(i),
                factory: r(s),
                service: r(c),
            ...
            throw ci.isString(e) && C.push(e), Wi("unpr", "Unknown provider: {0}", C.join(" <- "))
    ...
    function ze(t, e, r, i) {
        ...
        function f() {
            T = l(), T = m(T) ? null : T, R(T, j) && (T = j), j = T
        }

        function d() {
            (M !== $.url() || O !== T) && (M = $.url(), O = T, o(D, function (t) {
                t($.url(), T)
            }))
        }
        ...
        var $ = this, v = e[0], g = t.location, y = t.history, w = t.setTimeout, C = t.clearTimeout, x = {};
        $.isMock = !1;
        var S = 0, k = [];
        ...
        var T, O, M = g.href, N = e.find("base"), I = null;
        f(), O = T, $.url = function (e, n, r) {
            if (m(r) && (r = null), g !== t.location && (g = t.location), y !== t.history && (y = t.history), e) {
                var o = O === r;
                if (M === e && (!i.history || o))return $;
                var a = M && Cn(M) === Cn(e);
                return M = e, O = r, !i.history || a && o ? (a || (I = e), n ? g.replace(e) : a ? g.hash = s(e) : g.href = e) : (y[n ? "replaceState" : "pushState"](r, "", e), f(), O = T), $
            }
            return I || g.href.replace(/%27/g, "'")
        }, $.state = function () {
            return T
        };
        var D = [], V = !1, j = null;
        $.onUrlChange = function (e) {
            return V || (i.history && ei(t).on("popstate", c), ei(t).on("hashchange", c), V = !0), D.push(e), e
        ...
        $.cookies = function (t, e) {
            var i, o, a, s, u;
            if (!t) {
                if (v.cookie !== F)for (F = v.cookie, o = F.split("; "), P = {}, s = 0; s < o.length; s++)a = o[s], u = a.indexOf("="), u > 0 && (t = h(a.substring(0, u)), P[t] === n && (P[t] = h(a.substring(u + 1))));
                return P
            }
            e === n ? v.cookie = encodeURIComponent(t) + "=;path=" + q + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : b(e) && (i = (v.cookie = encodeURIComponent(t) + "=" + encodeURIComponent(e) + ";path=" + q).length + 1, i > 4096 && r.warn("Cookie '" + t + "' possibly not set or overflowed because it was too large (" + i + " > 4096 bytes)!"))
        }, $.defer = function (t, e) {
            var n;
            ...
            return x[t] ? (delete x[t], C(t), a(p), !0) : !1
        }
    }
        ...
        this.directive = function S(e, n) {
            return ae(e, "directive"), b(e) ? (ie(n, "directiveFactory"), a.hasOwnProperty(e) || (a[e] = [], t.factory(e + s, ["$injector", "$exceptionHandler", function (t, n) {
                ...
                return o(a[e], function (o, a) {
                    try {
                        var s = t.invoke(o);
                        x(s) ? s = {compile: v(s)} : !s.compile && s.link && (s.compile = v(s.link)), s.priority = s.priority || 0, s.index = a, s.name = s.name || e, s.require = s.require || s.controller && s.name, s.restrict = s.restrict || "EA", y(s.scope) && (s.$$isolateBindings = i(s.scope, s.name)), r.push(s)
                    } catch (u) {
                        n(u)
                    }
                }), r
        ...
        this.debugInfoEnabled = function (t) {
            ...
            function N(t, e, n, r, i) {
                ...
                return function (e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? ei(K(s, ei("<div>").append(t).html())) : n ? Ri.clone.call(t) : t, o)for (var l in o)c.data("$" + l + "Controller", o[l].instance);
            ...
            function D(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    ...
                    for (l = 0, f = $.length; f > l;)u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), N.$$addScopeInfo(ei(u), c)) : c = t, h = a.transcludeOnThisElement ? P(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? P(t, e) : null, a(s, c, u, i, h)) : s && s(t, u.childNodes, n, o)
                }

                for (var u, c, l, f, d, h, p, $ = [], v = 0; v < t.length; v++)u = new ae, c = F(t[v], [], u, 0 === v ? i : n, o), l = c.length ? L(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && N.$$addScopeClass(u.$$element), d = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : D(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || d) && ($.push(v, l, d), h = !0, p = p || l), a = null;
                return h ? s : null
            }
                ...
                switch (s) {
                    case yi:
                        ...
                        for (var f, d, h, p, $, v, m = t.attributes, g = 0, w = m && m.length; w > g; g++) {
                            var C = !1, x = !1;
                            f = m[g], d = f.name, $ = hi(f.value), p = Ke(d), (v = fe.test(p)) && (d = d.replace(Ji, "").substr(8).replace(/_(.)/g, function (t, e) {
                                return e.toUpperCase()
                            }));
                            var S = p.replace(/(Start|End)$/, "");
                            W(S) && p === S + "Start" && (C = d, x = d.substr(0, d.length - 5) + "end", d = d.substr(0, d.length - 6)), h = Ke(d.toLowerCase()), u[h] = d, (v || !n.hasOwnProperty(h)) && (n[h] = $, Pe(t, h) && (n[h] = !0)), te(t, e, $, h, v), B(e, h, "A", r, i, C, x)
                        }
                        if (a = t.className, y(a) && (a = a.animVal), b(a) && "" !== a)for (; o = l.exec(a);)h = Ke(o[2]), B(e, h, "C", r, i) && (n[h] = hi(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case bi:
                        Z(e, t.nodeValue);
                        break;
                    case wi:
                        try {
                            o = c.exec(t.nodeValue), o && (h = Ke(o[1]), B(e, h, "M", r, i) && (n[h] = hi(o[2])))
                        } catch (k) {
                        }
                }
                return e.sort(X), e
            ...
            function L(t, a, s, u, c, l, f, d, h) {
                function p(t, e, n, r) {
                    t && (n && (t = _(t, n, r)), t.require = k.require, t.directiveName = A, (V === k || k.$$isolateScope) && (t = re(t, {isolateScope: !0})), f.push(t)), e && (n && (e = _(e, n, r)), e.require = k.require, e.directiveName = A, (V === k || k.$$isolateScope) && (e = re(e, {isolateScope: !0})), d.push(e))
                }
                ...
                function w(t, e, i, u, c) {
                    function l(t, e, r) {
                        var i;
                        return E(t) || (r = e, e = t, t = n), W && (i = w), r || (r = W ? x.parent() : x), c(t, e, i, r, O)
                    }

                    var h, p, m, y, b, w, C, x, k;
                    if (a === i ? (k = s, x = s.$$element) : (x = ei(i), k = new ae(x, s)), V && (b = e.$new(!0)), c && (C = l, C.$$boundTransclude = c), D && (S = {}, w = {}, o(D, function (t) {
                            var n, r = {
                            ...
                            y = t.controller, "@" == y && (y = k[t.name]), n = g(y, r, !0, t.controllerAs), w[t.name] = n, W || x.data("$" + t.name + "Controller", n.instance), S[t.name] = n
                        })), V) {
                        N.$$addScopeInfo(x, b, !0, !(j && (j === V || j === V.$$originalDirective))), N.$$addScopeClass(x, !0);
                        var A = S && S[V.name], T = b;
                        A && A.identifier && V.bindToController === !0 && (T = A.instance), o(b.$$isolateBindings = V.$$isolateBindings, function (t, n) {
                            ...
                            switch (l) {
                                ...
                                case"=":
                                    if (c && !k[u])return;
                                    o = v(k[u]), s = o.literal ? R : function (t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function () {
                                        throw i = T[n] = o(e), Xi("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", k[u], V.name)
                                    }, i = T[n] = o(e);
                                    var f = function (t) {
                    ...
                    for (S && (o(S, function (t) {
                        t()
                    }), S = null), h = 0, p = f.length; p > h; h++)m = f[h], oe(m, m.isolateScope ? b : e, x, k, m.require && $(m.directiveName, m.require, x, w), C);
                    var O = e;
                    for (V && (V.template || null === V.templateUrl) && (O = b), t && t(O, i.childNodes, n, c), h = d.length - 1; h >= 0; h--)m = d[h], oe(m, m.isolateScope ? b : e, x, k, m.require && $(m.directiveName, m.require, x, w), C)
                }

                h = h || {};
                for (var C, S, k, A, T, O, M, I = -Number.MAX_VALUE, D = h.controllerDirectives, V = h.newIsolateScopeDirective, j = h.templateDirective, P = h.nonTlbTranscludeDirective, L = !1, B = !1, W = h.hasElementTranscludeDirective, X = s.$$element = ei(a), Z = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                    k = t[te];
                    var ie = k.$$start, se = k.$$end;
                    if (ie && (X = q(a, ie, se)), T = n, I > k.priority)break;
                    if ((M = k.scope) && (k.templateUrl || (y(M) ? (J("new/isolated scope", V || C, k, X), V = k) : J("new/isolated scope", V, k, X)), C = C || k), A = k.name, !k.templateUrl && k.controller && (M = k.controller, D = D || {}, J("'" + A + "' controller", D[A], k, X), D[A] = k), (M = k.transclude) && (L = !0, k.$$tlb || (J("transclusion", P, k, X), P = k), "element" == M ? (W = !0, I = k.priority, T = X, X = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = X[0], ee(c, U(T), a), Q = N(T, u, I, Z && Z.name, {nonTlbTranscludeDirective: P})) : (T = ei(we(a)).contents(), X.empty(), Q = N(T, u))), k.template)if (B = !0, J("template", j, k, X), j = k, M = x(k.template) ? k.template(X, s) : k.template, M = le(M), k.replace) {
                        if (Z = k, T = ve(M) ? [] : tn(K(k.templateNamespace, hi(M))), a = T[0], 1 != T.length || a.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", A, "");
                        ee(c, X, a);
                        var ue = {$attr: {}}, ce = F(a, [], ue), fe = t.splice(te + 1, t.length - (te + 1));
                        V && H(ce), t = t.concat(ce).concat(fe), z(s, ue), ne = t.length
                    } else X.html(M);
                    if (k.templateUrl)B = !0, J("template", j, k, X), j = k, k.replace && (Z = k), w = Y(t.splice(te, t.length - te), X, s, c, L && Q, f, d, {
                        controllerDirectives: D,
                        newIsolateScopeDirective: V,
                        templateDirective: j,
                        nonTlbTranscludeDirective: P
                    }), ne = t.length; else if (k.compile)try {
                        O = k.compile(X, s, Q), x(O) ? p(null, O, ie, se) : O && p(O.pre, O.post, ie, se)
                    } catch (de) {
                        i(de, G(X))
                    }
                    k.terminal && (w.terminal = !0, I = Math.max(I, k.priority))
                }
                return w.scope = C && C.scope === !0, w.transcludeOnThisElement = L, w.elementTranscludeOnThisElement = W, w.templateOnThisElement = B, w.transclude = Q, h.hasElementTranscludeDirective = W, w
            }
            ...
            function Y(t, e, n, r, i, a, s, c) {
                var l, f, d = [], p = e[0], $ = t.shift(), v = h($, {
                    ...
                    replace: null,
                    $$originalDirective: $
                }), m = x($.templateUrl) ? $.templateUrl(e, n) : $.templateUrl, g = $.templateNamespace;
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                    var h, b, w, C;
                    if (u = le(u), $.replace) {
                        if (w = ve(u) ? [] : tn(K(g, hi(u))), h = w[0], 1 != w.length || h.nodeType !== yi)throw Xi("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, m);
                        b = {$attr: {}}, ee(r, e, h);
                        var x = F(h, [], b);
                        y($.scope) && H(x), t = x.concat(t), z(n, b)
                    } else h = p, e.html(u);
                    for (t.unshift(v), l = L(t, h, n, i, e, $, a, s, c), o(r, function (t, n) {
                        ...
                        if (!S.$$destroyed) {
                            if (k !== p) {
                                var O = k.className;
                                c.hasElementTranscludeDirective && $.replace || (T = we(h)), ee(E, ei(k), T), M(ei(T), O)
                            }
                            C = l.transcludeOnThisElement ? P(S, l.transclude, A) : A, l(f, S, T, r, C)
                        }
                    }
                    d = null
                }), function (t, e, n, r, i) {
                    var o = i;
                    e.$$destroyed || (d ? d.push(e, n, r, o) : (l.transcludeOnThisElement && (o = P(e, l.transclude, i)), l(f, e, n, r, o)))
                }
            }
            ...
            function J(t, e, n, r) {
                if (e)throw Xi("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, G(r))
            }
            ...
            function te(t, e, n, i, o) {
                ...
                var s = r(n, !0, a, o);
                if (s) {
                    if ("multiple" === i && "select" === V(t))throw Xi("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", G(t));
                    e.push({
            ...
            ae.prototype = {
                $normalize: Ke, $addClass: function (t) {
                    ...
                    var s, u = this.$$element[0], c = Pe(u, t), l = Fe(u, t), f = t;
                    if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = ne(t, "-"))), s = V(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t)this[t] = e = O(e, "src" === t); else if ("img" === s && "srcset" === t) {
            ...
            return N.$$addBindingInfo = C ? function (t, e) {
                var n = t.data("$binding") || [];
                di(e) ? n = n.concat(e) : n.push(e), t.data("$binding", n)
            } : p, N.$$addBindingClass = C ? function (t) {
                M(t, "ng-binding")
            } : p, N.$$addScopeInfo = C ? function (t, e, n, r) {
                var i = n ? r ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope";
                t.data(i, e)
            } : p, N.$$addScopeClass = C ? function (t, e) {
        ...
        this.register = function (e, n) {
            ...
            return function (r, u, c, l) {
                ...
                if (c = c === !0, l && b(l) && ($ = l), b(r)) {
                    if (h = r.match(i), !h)throw Zi("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
    ...
    function fn() {
        var t = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: F(Qi), put: F(Qi), patch: F(Qi)},
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, d, h) {
            ...
            function w(r, i) {
                function o(t, n, r, i) {
                    ...
                    h && (ln(t) ? h.put(C, [t, n, sn(r), i]) : h.remove(C)), e ? l.$applyAsync(o) : (o(), l.$$phase || l.$apply())
                }
                ...
                var h, $, v = d.defer(), b = v.promise, w = r.headers, C = S(r.url, r.params);
                if (p.pendingRequests.push(r), b.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (h = y(r.cache) ? r.cache : y(t.cache) ? t.cache : k), h && ($ = h.get(C), g($) ? N($) ? $.then(c, c) : di($) ? s($[1], $[0], F($[2]), $[3]) : s($, 200, {}, "OK") : h.put(C, b)), m($)) {
                    var x = or(r.url) ? u.cookies()[r.xsrfCookieName || t.xsrfCookieName] : n;
                    x && (w[r.xsrfHeaderName || t.xsrfHeaderName] = x), a(r.method, C, i, o, w, r.timeout, r.withCredentials, r.responseType)
                }
                return b
            }
            ...
            function S(t, e) {
                ...
                return s(e, function (t, e) {
                    null === t || m(t) || (di(t) || (t = [t]), o(t, function (t) {
                        y(t) && (t = C(t) ? t.toISOString() : H(t)), n.push(J(e) + "=" + J(t))
                    }))
    ...
    function pn(t, e, r, i, a) {
        ...
        return function (a, u, c, l, f, d, h, $) {
            ...
            if (t.$$incOutstandingRequestCount(), u = u || t.url(), "jsonp" == Xr(a)) {
                ...
                if (w.onerror = C, w.onabort = C, h && (w.withCredentials = !0), $)try {
                    w.responseType = $
                } catch (x) {
                    if ("json" !== $)throw x
                }
            ...
            if (d > 0)var S = r(v, d); else N(d) && d.then(v)
        }
    }
    ...
    function $n() {
        ...
        this.startSymbol = function (e) {
            ...
            function a(o, a, d, h) {
                ...
                h = !!h;
                for (var v, y, b, w = 0, C = [], S = [], k = o.length, E = [], A = []; k > w;) {
                    if (-1 == (v = o.indexOf(t, w)) || -1 == (y = o.indexOf(e, v + s))) {
                        w !== k && E.push(p(o.substring(w)));
                        break
                    }
                    w !== v && E.push(p(o.substring(w, v))), b = o.substring(v + s, y), C.push(b), S.push(n(b, $)), w = y + u, A.push(E.length), E.push("")
                }
                ...
                if (!a || C.length) {
                    ...
                    return f(function (t) {
                        var e = 0, n = C.length, i = new Array(n);
                        try {
                            for (; n > e; e++)i[e] = S[e](t);
                            return T(i)
                        } catch (a) {
                        ...
                        exp: o, expressions: C, $$watchDelegate: function (t, e, n) {
                            var r;
    ...
    function Sn(t) {
        return t.substr(0, Cn(t).lastIndexOf("/") + 1)
    }
    ...
    function An(t, e) {
        ...
        yn(t, this), this.$$parse = function (r) {
            ...
            return Cn(t) == Cn(e) ? (this.$$parse(e), !0) : !1
        }
    }
    ...
    function Tn(t, e) {
        ...
        this.$$parseLinkUrl = function (r, i) {
            ...
            var o, a;
            return t == Cn(r) ? o = r : (a = wn(n, r)) ? o = t + e + a : n === r + "/" && (o = n), o && this.$$parse(o), !!o
        }, this.$$compose = function () {
            var n = Y(this.$$search), r = this.$$hash ? "#" + X(this.$$hash) : "";
        ...
        this.hashPrefix = function (e) {
            ...
            o.on("click", function (t) {
                if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
                    for (var i = ei(t.target); "a" !== V(i[0]);)if (i[0] === o[0] || !(i = i.parent())[0])return;
            ...
            }), xn(c.absUrl()) != xn(h) && r.url(c.absUrl(), !0);
            var $ = !0;
            return r.onUrlChange(function (t, e) {
                ...
                var t = xn(r.url()), e = xn(c.absUrl()), o = r.state(), a = c.$$replace, l = t !== e || c.$$html5 && i.history && o !== c.$$state;
    ...
    function Fn(t, e, n, r, i) {
        ...
        return o = Dn(a.shift(), i), Vn(t[o], i), t[o] = r, r
    }
    ...
    function qn(t, e, r, i, o, a, s) {
        ...
        var u = function (t) {
            return Vn(t, a)
        }, c = s || Rn(t) ? u : $, l = s || Rn(e) ? u : $, f = s || Rn(r) ? u : $, d = s || Rn(i) ? u : $, h = s || Rn(o) ? u : $;
        return function (a, s) {
    ...
    function _n(t, e, r) {
        ...
        if (e.csp)s = 6 > c ? qn(u[0], u[1], u[2], u[3], u[4], r, i) : function (t, e) {
            ...
            o(u, function (t, e) {
                ...
                (i || Rn(t)) && (n = "eso(" + n + ", fe)", f = !0), l += "if(s == null) return undefined;\ns=" + n + ";\n"
            }), l += "return s;";
            var d = new Function("s", "l", "eso", "fe", l);
            d.toString = v(l), f && (d = Un(d, r)), s = d
        }
    ...
    function Ln(t) {
        return x(t.valueOf) ? t.valueOf() : bo.call(t)
    }
        ...
        this.$get = ["$filter", "$sniffer", function (n, r) {
            ...
            function c(t, e, n, r) {
                ...
                return i = t.$watch(function (t) {
                    ...
                    o = t, x(e) && e.apply(this, arguments), g(t) && r.$$postDigest(function () {
                        g(o) && i()
                    })
                }, n)
            }
    ...
    function Wn(t, e) {
        ...
        a.prototype = {
            ...
            resolve: function (t) {
                ...
                try {
                    (y(t) || x(t)) && (n = t && t.then), x(n) ? (this.promise.$$state.status = -1, n.call(t, r[0], r[1], this.notify)) : (this.promise.$$state.value = t, this.promise.$$state.status = 1, c(this.promise.$$state))
                } catch (o) {
                    r[1](o), e(o)
                }
            }, reject: function (t) {
        ...
        this.digestTtl = function (t) {
            ...
            h.prototype = {
                constructor: h, $new: function (e, n) {
                    ...
                    return a = null, x(e) || (s.fn = p), o || (o = i.$$watchers = []), o.unshift(s), function () {
                        j(o, s), a = null
                    }
                    ...
                    var t, r, i, o, c, l, d, h, p, m, g = e, y = this, C = [];
                    ...
                    do {
                        ...
                        t:do {
                            if (o = h.$$watchers)for (c = o.length; c--;)try {
                                if (t = o[c])if ((r = t.get(h)) === (i = t.last) || (t.eq ? R(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                    if (t === a) {
                                        l = !1;
                                        break t
                                    }
                                } else l = !0, a = t, t.last = t.eq ? P(r, null) : r, t.fn(r, i === b ? r : i, h), 5 > g && (p = 4 - g, C[p] || (C[p] = []), C[p].push({
    ...
    function ir(t) {
        var e = t;
        return ti && (xo.setAttribute("href", e), e = xo.href), xo.setAttribute("href", e), {
            href: xo.href,
    ...
    function sr(t) {
        ...
        }], e("currency", fr), e("date", Sr), e("filter", ur), e("json", kr), e("limitTo", Er), e("lowercase", Oo), e("number", dr), e("orderBy", Ar), e("uppercase", Mo)
    }
    ...
    function cr(t, e, n) {
        var r, i = y(t) && "$"in t;
        return e === !0 ? e = R : x(e) || (e = function (t, e) {
    ...
    function Sr(t) {
        ...
        return function (n, r, i) {
            var a, s, u = "", c = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, b(n) && (n = To.test(n) ? d(n) : e(n)), w(n) && (n = new Date(n)), !C(n))return n;
    ...
    function Tr(t) {
        return x(t) && (t = {link: t}), t.restrict = t.restrict || "AC", v(t)
    }
    ...
    function Mr(t, e, r, i, a) {
        ...
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, c.$addControl(s), s.$rollbackViewValue = function () {
            ...
            i.setClass(t, $a, va + " " + Vo), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(u, function (t) {
                t.$setPristine()
            })
    ...
    function Pr(t, e, r, i) {
        return function (o, a, s, u, c, l, f) {
            ...
            function h(t) {
                return g(t) ? C(t) ? t : r(t) : n
            }

            Fr(o, a, s, u), Dr(o, a, s, u, c, l);
            ...
            if (u.$$parserName = t, u.$parsers.push(function (t) {
                    ...
                    if (t && !C(t))throw ba("datefmt", "Expected `{0}` to be a date", t);
                    if (d(t)) {
                        if (p = t, p && "UTC" === $) {
    ...
    function Rr(t, e, r, i, o, a) {
        if (Fr(t, e, r, i), Dr(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function (t) {
                return i.$isEmpty(t) ? null : _o.test(t) ? parseFloat(t) : n
    ...
    function qr(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), Nr(r), r.$$parserName = "url", r.$validators.url = function (t, e) {
            var n = t || e;
    ...
    function Ur(t, e, n, r, i, o) {
        Dr(t, e, n, r, i, o), Nr(r), r.$$parserName = "email", r.$validators.email = function (t, e) {
            var n = t || e;
    ...
    }, Jr = Object.prototype.hasOwnProperty, Zr = function (t) {
    ...
    }, vi = ["ng-", "data-ng-", "ng:", "x-ng-"], mi = /[A-Z]/g, gi = !1, yi = 1, bi = 3, wi = 8, Ci = 9, xi = 11, Si = {
        full: "1.3.15",
        major: 1,
        minor: 3,
        dot: 15,
    ...
    var Oi = /([\:\-\_]+(.))/g, Mi = /^moz([A-Z])/, Ni = {
        mouseleave: "mouseout",
        mouseenter: "mouseover"
    }, Ii = r("jqLite"), Di = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Vi = /<|&#?\w+;/, ji = /<([\w:]+)/, Pi = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Fi = {
    ...
    var _i = {ngMinlength: "minlength", ngMaxlength: "maxlength", ngMin: "min", ngMax: "max", ngPattern: "pattern"};
    o({data: Ee, removeData: Se}, function (t, e) {
        be[e] = t
    }), o({
        data: Ee, inheritedData: Ie, scope: function (t) {
            return ei.data(t, "$scope") || Ie(t.parentNode || t, ["$isolateScope", "$scope"])
        }, isolateScope: function (t) {
            return ei.data(t, "$isolateScope") || ei.data(t, "$isolateScopeNoTemplate")
        }, controller: Ne, injector: function (t) {
            return Ie(t, "$injector")
            ...
            return m(e) ? t.innerHTML : (Ce(t, !0), t.innerHTML = e, void 0)
        }, empty: De
    }, function (t, e) {
        be.prototype[e] = function (e, r) {
            var i, o, a = this.length;
            if (t !== De && (2 == t.length && t !== Ae && t !== Ne ? e : r) === n) {
                if (y(e)) {
        ...
        removeData: Se, on: function za(t, e, n, r) {
            if (g(r))throw Ii("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
            if (me(t)) {
            ...
            }, e.type && (r = f(r, e)), i = F(l), a = n ? [r].concat(n) : [r], o(i, function (e) {
    ...
    var Li = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Hi = /,/, Bi = /^\s*(_?)(\S+?)\1\s*$/, Gi = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Wi = r("$injector");
    Be.$$annotate = He;
    ...
    var Ji = /^((?:x|data)[\:\-_])/i, Zi = r("$controller"), Ki = "application/json", Qi = {"Content-Type": Ki + ";charset=utf-8"}, to = /^\[|^\{(?!\{)/, eo = {
        "[": /]$/,
        "{": /}$/
    ...
    mo.ZERO = f(function () {
        ...
        constructor: mo, parse: function (t) {
            ...
            return _n(t, this.options, this.text)
        }, constant: function () {
            ...
            return this.consume("]"), f(function (i, o) {
                ...
                return Dn(u, e), s ? a = Vn(s[u], e) : n
            }, {
                assign: function (n, i, o) {
                    var a = Dn(r(n, o), e), s = Vn(t(n, o), e);
            ...
            return function (a, s) {
                ...
                if (o)for (var l = r.length; l--;)o[l] = Vn(r[l](a, s), i);
                Vn(u, i), jn(c, i);
    ...
    var go = ce(), yo = ce(), bo = Object.prototype.valueOf, wo = r("$sce"), Co = {
        HTML: "html",
        CSS: "css",
        URL: "url",
        RESOURCE_URL: "resourceUrl",
        JS: "js"
    }, Xi = r("$compile"), xo = e.createElement("a"), So = ir(t.location.href);
                    ...
                    return {
                        pre: function (t, r, i, a) {
                            ...
                            o && (Fn(t, null, a.$name, a, a.$name), i.$observe(o, function (e) {
                                ...
                                u.$removeControl(a), o && Fn(t, null, i[o], n, a.$name), f(a, Do)
                            })
                        }
                    }
                }
    ...
    }, Po = jo(), Fo = jo(!0), Ro = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, qo = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Uo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, _o = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Lo = /^(\d{4})-(\d{2})-(\d{2})$/, Ho = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Bo = /^(\d{4})-W(\d\d)$/, Go = /^(\d{4})-(\d\d)$/, Wo = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, zo = {
        text: Ir,
        date: Pr("date", Lo, jr(Lo, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
        "datetime-local": Pr("datetimelocal", Ho, jr(Ho, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
        time: Pr("time", Wo, jr(Wo, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
        week: Pr("week", Bo, Vr, "yyyy-Www"),
        month: Pr("month", Go, jr(Go, ["yyyy", "MM"]), "yyyy-MM"),
        number: Rr,
        url: qr,
        email: Ur,
        radio: _r,
    ...
    }], Ko = ["$interpolate", "$compile", function (t, e) {
        return {
            compile: function (r) {
    ...
    var ua = ["$animate", function (t) {
        ...
        var d, h = a(r.ngModel), $ = h.assign, v = h, y = $, b = null, C = this;
        this.$$setOptions = function (t) {
            if (C.$options = t, t && t.getterSetter) {
                var e = a(r.ngModel + "()"), n = a(r.ngModel + "($$$p)");
                v = function (t) {
                    var n = h(t);
                    return x(n) && (n = e(t)), n
                }, y = function (t) {
                    x(h(t)) ? n(t, {$$$p: C.$modelValue}) : $(t, C.$modelValue)
                }
            } else if (!h.assign)throw ba("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, G(i))
        ...
        Gr({
            ...
            C.$dirty = !1, C.$pristine = !0, s.removeClass(i, va), s.addClass(i, $a)
        }, this.$setDirty = function () {
            C.$dirty = !0, C.$pristine = !1, s.removeClass(i, $a), s.addClass(i, va), S.$setDirty()
        }, this.$setUntouched = function () {
            C.$touched = !1, C.$untouched = !0, s.setClass(i, ma, ga)
        }, this.$setTouched = function () {
            C.$touched = !0, C.$untouched = !1, s.setClass(i, ga, ma)
        }, this.$rollbackViewValue = function () {
            u.cancel(b), C.$viewValue = C.$$lastCommittedViewValue, C.$render()
        }, this.$validate = function () {
            if (!w(C.$modelValue) || !isNaN(C.$modelValue)) {
                var t = C.$$lastCommittedViewValue, e = C.$$rawModelValue, r = C.$valid, i = C.$modelValue, o = C.$options && C.$options.allowInvalid;
                C.$$runValidators(e, t, function (t) {
                    o || r === t || (C.$modelValue = t ? e : n, C.$modelValue !== i && C.$$writeModelToScope())
                })
            }
        }, this.$$runValidators = function (t, e, r) {
            function i() {
                var t = C.$$parserName || "parse";
                return d !== n ? (d || (o(C.$validators, function (t, e) {
                    u(e, null)
            ...
            function a() {
                ...
                return o(C.$validators, function (r, i) {
                    var o = r(t, e);
                    n = n && o, u(i, o)
                }), n ? !0 : (o(C.$asyncValidators, function (t, e) {
                    u(e, null)
                }), !1)
            }
            ...
            function s() {
                var r = [], i = !0;
                o(C.$asyncValidators, function (o, a) {
                    var s = o(t, e);
                    if (!N(s))throw ba("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
            ...
            var t = C.$viewValue;
            u.cancel(b), (C.$$lastCommittedViewValue !== t || "" === t && C.$$hasNativeValidators) && (C.$$lastCommittedViewValue = t, C.$pristine && this.$setDirty(), this.$$parseAndValidate())
        }, this.$$parseAndValidate = function () {
            function e() {
                C.$modelValue !== a && C.$$writeModelToScope()
            }

            var r = C.$$lastCommittedViewValue, i = r;
            if (d = m(i) ? n : !0)for (var o = 0; o < C.$parsers.length; o++)if (i = C.$parsers[o](i), m(i)) {
                d = !1;
                break
            }
            w(C.$modelValue) && isNaN(C.$modelValue) && (C.$modelValue = v(t));
            var a = C.$modelValue, s = C.$options && C.$options.allowInvalid;
            C.$$rawModelValue = i, s && (C.$modelValue = i, e()), C.$$runValidators(i, C.$$lastCommittedViewValue, function (t) {
                s || (C.$modelValue = t ? i : n, e())
            })
        }, this.$$writeModelToScope = function () {
            y(t, C.$modelValue), o(C.$viewChangeListeners, function (t) {
                try {
                    t()
                } catch (n) {
                    e(n)
            ...
            C.$viewValue = t, (!C.$options || C.$options.updateOnDefault) && C.$$debounceViewValueCommit(e)
        }, this.$$debounceViewValueCommit = function (e) {
            var n, r = 0, i = C.$options;
            i && g(i.debounce) && (n = i.debounce, w(n) ? r = n : w(n[e]) ? r = n[e] : w(n["default"]) && (r = n["default"])), u.cancel(b), r ? b = u(function () {
                C.$commitViewValue()
            }, r) : c.$$phase ? C.$commitViewValue() : t.$apply(function () {
                C.$commitViewValue()
            })
        }, t.$watch(function () {
            var e = v(t);
            if (e !== C.$modelValue) {
                C.$modelValue = C.$$rawModelValue = e, d = n;
                for (var r = C.$formatters, i = r.length, o = e; i--;)o = r[i](o);
                C.$viewValue !== o && (C.$viewValue = C.$$lastCommittedViewValue = o, C.$render(), C.$$runValidators(e, o, p))
            }
            return e
        })
        ...
        return {
            restrict: "A", controller: ["$scope", "$attrs", function (t, e) {
                var r = this;
                this.$options = t.$eval(e.ngModelOptions), this.$options.updateOn !== n ? (this.$options.updateOnDefault = !1, this.$options.updateOn = hi(this.$options.updateOn.replace(xa, function () {
        ...
        return {
            ...
            compile: function (r, d) {
                ...
                var C, x, S, k, E = {$id: Ue};
                return y ? C = t(y) : (S = function (t, e) {
                    return Ue(e)
                }, k = function (t) {
                    return t
                }), function (t, e, r, d, $) {
                    C && (x = function (e, n, r) {
                        return w && (E[w] = e), E[b] = n, E.$index = r, C(t, E)
                    });
                    var v = ce();
                    t.$watchCollection(m, function (r) {
                        var d, m, y, C, E, A, T, O, M, N, I, D, V = e[0], j = ce();
                        if (g && (t[g] = r), i(r))M = r, O = x || S; else {
                            O = x || k, M = [];
                            for (var P in r)r.hasOwnProperty(P) && "$" != P.charAt(0) && M.push(P);
                            M.sort()
                        }
                        for (C = M.length, I = new Array(C), d = 0; C > d; d++)if (E = r === M ? d : M[d], A = r[E], T = O(E, A, d), v[T])N = v[T], delete v[T], j[T] = N, I[d] = N; else {
                            if (j[T])throw o(I, function (t) {
                                t && t.scope && (v[t.id] = t)
                            ...
                            I[d] = {id: T, scope: n, clone: n}, j[T] = !0
                        }
                        for (var F in v) {
                            if (N = v[F], D = ue(N.clone), a.leave(D), D[0].parentNode)for (d = 0, m = D.length; m > d; d++)D[d][s] = !0;
                            N.scope.$destroy()
                        }
                        for (d = 0; C > d; d++)if (E = r === M ? d : M[d], A = r[E], N = I[d], N.scope) {
                            y = V;
                            do y = y.nextSibling; while (y && y[s]);
                            l(N) != y && a.move(ue(N.clone), null, ei(V)), V = f(N), c(N.scope, d, b, A, w, E, C)
                        } else $(function (t, e) {
                            N.scope = e;
                            var n = p.cloneNode(!1);
                            t[t.length++] = n, a.enter(t, null, ei(V)), V = n, N.clone = t, j[N.id] = N, c(N.scope, d, b, A, w, E, C)
                        });
                        v = j
                    })
                }
    ...
    }], Ra = r("ngOptions"), qa = v({restrict: "A", terminal: !0}), Ua = ["$compile", "$parse", function (t, r) {
            ...
            link: function (s, u, c, l) {
                ...
                function d(t, e, n) {
                    ...
                    n.$render = function () {
                        ...
                        R(r, n.$viewValue) || (r = F(n.$viewValue), n.$render())
                    }), e.on("change", function () {
                        t.$apply(function () {
                            var t = [];
                            o(e.find("option"), function (e) {
                ...
                function h(e, s, u) {
                    ...
                    function h(t) {
                        ...
                        if (y)if (j && di(t)) {
                            e = new _e([]);
                            for (var n = 0; n < t.length; n++)e.put(c(j, null, t[n]), !0)
                        } else e = new _e(t); else j && (t = c(j, null, t));
                        return function (n, r) {
                            var i;
                            return i = j ? j : O ? O : I, y ? g(e.remove(c(i, n, r))) : t === c(i, n, r)
                        }
                    }

                    function p() {
                        C || (e.$$postDigest(m), C = !0)
                    }
                    ...
                    function m() {
                        C = !1;
                        var t, n, r, i, l, f, d, p, m, b, k, A, T, O, I, V, q, U = {"": []}, _ = [""], L = u.$viewValue, H = D(e) || [], B = M ? a(H) : H, G = {}, W = h(L), z = !1;
                        for (P = {}, A = 0; b = B.length, b > A; A++)d = A, M && (d = B[A], "$" === d.charAt(0)) || (p = H[d], t = c(N, d, p) || "", (n = U[t]) || (n = U[t] = [], _.push(t)), T = W(d, p), z = z || T, V = c(E, d, p), V = g(V) ? V : "", q = j ? j(e, R) : M ? B[A] : A, j && (P[q] = d), n.push({
                            id: q,
                            label: V,
                            selected: T
                        }));
                        for (y || (w || null === L ? U[""].unshift({
                            id: "",
                            label: "",
                            selected: !z
                        }) : z || U[""].unshift({id: "?", label: "", selected: !0})), k = 0, m = _.length; m > k; k++) {
                            for (t = _[k], n = U[t], F.length <= k ? (i = {
                                element: S.clone().attr("label", t),
                                label: n.label
                            }, l = [i], F.push(l), s.append(i.element)) : (l = F[k], i = l[0], i.label != t && i.element.attr("label", i.label = t)), O = null, A = 0, b = n.length; b > A; A++)r = n[A], (f = l[A + 1]) ? (O = f.element, f.label !== r.label && (v(G, f.label, !1), v(G, r.label, !0), O.text(f.label = r.label), O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), ti && O.prop("selected", f.selected))) : ("" === r.id && w ? I = w : (I = x.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {
                                element: I,
                                label: r.label,
                                id: r.id,
                                selected: r.selected
                            }), v(G, r.label, !0), O ? O.after(I) : i.element.append(I), O = I);
                            for (A++; l.length > A;)r = l.pop(), v(G, r.label, !1), r.element.remove()
                        }
                        for (; F.length > k;) {
                            for (n = F.pop(), A = 1; A < n.length; ++A)v(G, n[A].label, !1);
                            n[0].element.remove()
                        }
                        o(G, function (t, e) {
                    ...
                    var k;
                    if (!(k = b.match(i)))throw Ra("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", b, G(s));
                    var E = r(k[2] || k[1]), A = k[4] || k[6], T = / as /.test(k[0]) && k[1], O = T ? r(T) : null, M = k[5], N = r(k[3] || ""), I = r(k[2] ? k[1] : A), D = r(k[7]), V = k[8], j = V ? r(k[8]) : null, P = {}, F = [[{
                        element: s,
                        label: ""
                    }]], R = {};
                ...
                if (l[1]) {
                    for (var p, $ = l[0], v = l[1], y = c.multiple, b = c.ngOptions, w = !1, C = !1, x = ei(e.createElement("option")), S = ei(e.createElement("optgroup")), k = x.clone(), E = 0, A = u.children(), T = A.length; T > E; E++)if ("" === A[E].value) {
                        p = w = A.eq(E);
                        break
                    }
            ...
            restrict: "A", require: "?ngModel", link: function (t, e, i, o) {
                if (o) {
                    ...
                    i.$observe("pattern", function (t) {
                        if (b(t) && t.length > 0 && (t = new RegExp("^" + t + "$")), t && !t.test)throw r("ngPattern")("noregexp", "Expected {0} to be a RegExp but was {1}. Element: {2}", s, t, G(e));
                        a = t || n, o.$validate()
...
FastClick.prototype.needsClick = function (t) {
                    ...
                    if (e.intercept && e.intercept(), v(), m(), c = e.closest(t.target), c && c !== i && !(t.touches.length > 1)) {
                        ...
                        var n = t, r = c.scrollTop, o = c.scrollLeft, a = c.offsetHeight, s = c.offsetWidth, u = t.touches[0].pageY, l = t.touches[0].pageX, h = c.scrollHeight, b = c.scrollWidth, w = function (t) {
                            ...
                            g("auto"), setTimeout(function () {
                                g("none")
                            }, 450), c.removeEventListener("touchmove", w, !1), c.removeEventListener("touchend", C, !1)
                        };
                        c.addEventListener("touchmove", w, !1), c.addEventListener("touchend", C, !1)
                    }
                };
    ...
    return {
        destroy: {400: 4, 600: 6, 800: 8, 1e3: 10, 1200: 12, 1400: 13, 1600: 15},
        supress: {400: 6, 600: 9, 800: 12, 1e3: 16, 1200: 19, 1400: 21, 1600: 24}
    }
...
}), angular.module("Vatra.services.Data", ["Vatra.services.HardcodedTables"]).factory("grenadesConsumptionCoefficient", ["lookupByDistance", "singleTargetGrenadeConsumption", "groupTargetGrenadeConsumption", function (t, e, n) {
    return function (r) {
        var i;
        return i = "single" == r.type ? e[r.task] : n[r.trajectory][r.task], t(i, r.distance)
    }
}]).factory("sightsValues", ["sightsTable", "derivationAdjustments", "clockToRadian", "sideWindAdjustment", "lookupByDistance", function (t, e, n, r, i) {
    return function (o) {
        var a = n(o.windDirection), s = Math.cos(a) * o.windSpeed, u = Math.sin(a) * o.windSpeed;
        return {
            originalSights: i(t[o.trajectory], o.distance),
            derivationAdjustment: i(e[o.trajectory], o.distance),
            sideWindAdjustment: i(r[o.trajectory], o.distance) * u / 10,
            windInRadians: a,
            forwardWind: s,
            sideWind: u
        }
    ...
    return function (t, e) {
        error = 1 / 0;
        for (var n in t)currentError = Math.abs(n - e), error > currentError && (error = currentError, key = n);
        return t[key]
    }
...
}), angular.module("Vatra.controllers.Main", ["Vatra.services.Data"]).controller("MainController", ["$scope", "grenadesConsumptionCoefficient", "sightsValues", function (t, e, n) {
    t.data = {
        devicesNumber: 2,
        type: "single",
        trajectory: "flat",
        ...
        var i = {};
        i.grenadesCoeffitient = e(r), i.totalGrenades = i.grenadesCoeffitient * r.front * r.depth / 100, i.grenadesPerDevice = i.totalGrenades / r.devicesNumber, i.sights = n(r), t.result = i
    }
